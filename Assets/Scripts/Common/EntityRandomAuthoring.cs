...
namespace DotsShooter.Common
{
    ...
    public partial struct InitializeEntityRandomSystem : ISystem
    {
        public void OnUpdate(ref SystemState state)
        {
            ...
            var index = 0u;
            foreach (var (random, initializationType, shouldInitialize) 
                     in SystemAPI.Query<RefRW<EntityRandom>, InitializeEntityRandom, EnabledRefRW<InitializeEntityRandom>>()
