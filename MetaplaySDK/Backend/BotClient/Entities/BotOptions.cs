...
namespace Metaplay.BotClient
{
    ...
    public class BotOptions : RuntimeOptionsBase
    {
        ...
        [MetaDescription("Probability, per bot update tick, for a bot to produce a dummy incident report.")]
        public float        DummyIncidentReportProbabilityPerTick { get; private set; } = 0f;
