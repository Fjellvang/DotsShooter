...
namespace Cloud.Tests
{
    ...
    class RefreshKeyCounterTests
    {
        ...
        {
            RefreshKeyCounter<int> counter = new RefreshKeyCounter<int>(TimeSpan.FromMilliseconds(1));
        ...
        {
            RefreshKeyCounter<int> counter = new RefreshKeyCounter<int>(TimeSpan.FromMilliseconds(5));
            Assert.AreEqual(0, counter.GetNumAlive());
        ...
        {
            RefreshKeyCounter<int> counter = new RefreshKeyCounter<int>(TimeSpan.FromMilliseconds(2));
            Assert.AreEqual(0, counter.GetNumAlive());
