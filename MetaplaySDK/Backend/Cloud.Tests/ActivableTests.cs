...
namespace Cloud.Tests
{
    ...
    public class ActivableTests
    {
        ...
        {
            public MetaDictionary<PlayerSegmentId, TestPlayerSegmentInfo> Segments { get; private set; }
            public MetaDictionary<TestOfferId, TestOfferInfo> TestOffers { get; private set; }
            ...
            public ActivableTestGameConfig()
            {
                Segments = new List<TestPlayerSegmentInfo>
                {
                    ...
                    new TestPlayerSegmentInfo(
                        ...
                        new PlayerSegmentBasicCondition(
                            ...
                            requireAnySegment: null,
                            requireAllSegments: null))
                }.ToMetaDictionary(info => info.SegmentId);
                ...
                }.ToMetaDictionary(info => info.OfferId);
