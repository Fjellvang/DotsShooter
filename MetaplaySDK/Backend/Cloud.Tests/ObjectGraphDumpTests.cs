...
namespace Cloud.Tests
{
    public class ObjectGraphDumpTests
    {
        public class TopLevel
        {
            ...
            public MetaDictionary<string, MyClass> Dict0;
            public MetaDictionary<MyClass, string> Dict1;
        ...
        TopLevel NewMiscTestObject()
        {
            return new TopLevel
            {
                ...
                Dict0 = new MetaDictionary<string, MyClass>
                {
                    { "d0key0", new MyClass { Str = "d0c0" } },
                    { "d0key1", new MyClass { Str = null } },
                    { "d0key2", new MyClass { Str = "d0c2" } },
                },
                Dict1 = new MetaDictionary<MyClass, string>
                {
                    { new MyClass { Str = "d1c0" }, "d1value0" },
                    { new MyClass { Str = null }, "value1" },
                    { new MyClass { Str = "d1c2" }, "d1value2" },
                },
                Library = GameConfigLibrary<string, DummyConfigInfo>.CreateSolo(new MetaDictionary<string, DummyConfigInfo>
                {
...
<#6>:
    type Metaplay.Core.MetaDictionary<System.String,Cloud.Tests.ObjectGraphDumpTests.MyClass>
    key at index 0: <#15>
    value at index 0: <#16>
    key at index 1: <#17>
    value at index 1: <#18>
    ...
    value at index 2: <#20>
<#7>:
    type Metaplay.Core.MetaDictionary<Cloud.Tests.ObjectGraphDumpTests.MyClass,System.String>
    key at index 0: <#21>
    value at index 0: <#22>
    key at index 1: <#23>
    value at index 1: <#24>
