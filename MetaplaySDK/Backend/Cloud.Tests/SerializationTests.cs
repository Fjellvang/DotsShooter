...
namespace Cloud.Tests
{
    ...
    [MetaSerializable]
    public abstract class TestVersionedClassBase
    {
    ...
    public class TestAddedDerivedClass : TestVersionedClassBase { }
    ...
    public class TestObjectTypes
    {
        ...
        public class TestNullableValueTypes
        {
            ...
            public void AssertEqual(TestNullableValueTypes expected)
            {
                ...
                Assert.True(
                    (!expected.DateTimeOffset.HasValue && !DateTimeOffset.HasValue)
                    || (expected.DateTimeOffset.HasValue && DateTimeOffset.HasValue && expected.DateTimeOffset.Value.EqualsExact(DateTimeOffset.Value)));
        ...
        {
            public static readonly TestDynamicEnum TestValue0 = new TestDynamicEnum(0, "TestValue0");
            public static readonly TestDynamicEnum TestValue1 = new TestDynamicEnum(1, "TestValue1");

            protected TestDynamicEnum(int id, string name)
        ...
        [MetaMember(1002)] public MetaDictionary<int,int>            OrderedIntDict      { get; set; }
        [MetaMember(1003)] public MetaDictionary<string,string>      OrderedStringDict   { get; set; }
        ...
        [MetaMember(1112)] public  TestDynamicEnum                               DynamicEnum0                          { get; set; }
        [MetaMember(1113)] public  TestDynamicEnum                               DynamicEnum1                          { get; set; }
        [MetaMember(1114)] public  TestDynamicEnum                               NullDynamicEnum                       { get; set; }
        ...
        public TestObjectTypes(bool init)
        {
            ...
            OrderedIntDict      = new MetaDictionary<int, int>(123) { [0] = 1, [1] = 2, [-3] = -4, [8] = 8, [10] = 0 };
            OrderedStringDict   = new MetaDictionary<string, string>(123) { ["0"] = "1", ["1"] = null, [null] = "2", [""] = "f", ["foo"] = "bar" };
            ...
            ReadOnlyDictionary            = new ReadOnlyDictionary<int, string>(new MetaDictionary<int, string>() { { 5, "foo" }, { -13, "Bar" } });
            ReadOnlyDictionaryWithMetaRef = new ReadOnlyDictionary<int, TestClassWithMetaRef>(new MetaDictionary<int, TestClassWithMetaRef>() { { 5, new TestClassWithMetaRef() { metaRef = MetaRef<SerializationTests.TestGameConfigIntInfo>.FromKey(5) } }});
            DynamicEnum0                  = TestDynamicEnum.TestValue0;
            DynamicEnum1                  = TestDynamicEnum.TestValue1;
            NullDynamicEnum               = null;
        }
        ...
        public void AssertEqual(TestObjectTypes expected)
        {
            ...
            Assert.AreEqual(expected.SystemGuid, SystemGuid);
            Assert.AreEqual(expected.TimeSpan, TimeSpan);
            Assert.True(expected.DateTimeOffset.EqualsExact(DateTimeOffset));
            ...
            Assert.AreEqual(expected.DynamicEnum0, DynamicEnum0);
            Assert.AreEqual(expected.DynamicEnum1, DynamicEnum1);
            Assert.AreEqual(expected.NullDynamicEnum, NullDynamicEnum);
        }
    }
    ...
    public class ConstructorSerializationWithUnderscores
    {
        [MetaMember(1)] public int  _a { get; set; }
        [MetaMember(2)] public bool _b { get; set; }

        public bool ConstructorInvoked { get; init; }

        public ConstructorSerializationWithUnderscores(int a, bool b)
        {
            _a = a;
            _b = b;
    ...
    [MetaSerializable(MetaSerializableFlags.AutomaticConstructorDetection)]
    public class PartialConstructorSerialization
    {
        [MetaMember(1)] public int  A { get; }
        [MetaMember(2)] public bool B { get; set; }

        public bool ConstructorInvoked { get; init; }

        public PartialConstructorSerialization(int a)
        {
            A = a;
    ...
    [MetaSerializable(MetaSerializableFlags.AutomaticConstructorDetection)]
    public class PartialPickBestMatchingConstructorSerialization
    {
        [MetaMember(1)] public int  A { get; }
        [MetaMember(2)] public bool B { get; set; }
        ...
        public PartialPickBestMatchingConstructorSerialization(int a)
        {
            A = a;
        }

        public PartialPickBestMatchingConstructorSerialization(int a, bool b)
        {
            A                  = a;
            B                  = b;
            ConstructorInvoked = true;
    ...
    [MetaSerializable]
    public abstract class PartialConstructorDeserializationBase
    {
        [MetaMember(1)] public int A { get; set; }
    }

    [MetaSerializableDerived(1)]
    public class PartialConstructorDeserializationDerived : PartialConstructorDeserializationBase
    {
        [MetaMember(2)] public int B { get; }

        public bool ConstructorInvoked { get; init; }

        [MetaDeserializationConstructor]
        public PartialConstructorDeserializationDerived(int b)
        {
            B                  = b;
            ConstructorInvoked = true;
        }

        public PartialConstructorDeserializationDerived(int a, int b)
        {
            A                  = a;
            B                  = b;
        }
    ...
    [MetaSerializable]
    public class PartialExplicitConstructorSerialization
    {
        [MetaMember(1)] public int  A { get; }
        [MetaMember(2)] public bool B { get; set; }
        ...
        [MetaDeserializationConstructor]
        public PartialExplicitConstructorSerialization(int a)
        {
            A = a;
        ...
        public PartialExplicitConstructorSerialization(int a, bool b)
        {
            A = a;
            B = b;
        }
    ...
    [MetaSerializable]
    public class PartialConstructorWithInitializerForNonConstructorMember
    {
        [MetaMember(1)] public int  A { get; }
        [MetaMember(2)] public bool B { get; set; } = true;

        [MetaDeserializationConstructor]
        public PartialConstructorWithInitializerForNonConstructorMember(int a)
        {
            A = a;
        }
    }
    ...
    [MetaSerializable(MetaSerializableFlags.AutomaticConstructorDetection)]
    public class PickBestMatchingConstructorSerialization
    {
        [MetaMember(1)] public int  A { get; set; }
        [MetaMember(2)] public bool B { get; set; }
        ...
        // Should not produce error due to the first two constructors being conflicting,
        // because there is an unambiguous better-matching constructor available.

        public PickBestMatchingConstructorSerialization(int a)
        {
            A = a;
        }

        public PickBestMatchingConstructorSerialization(bool b)
        {
            B = b;
        }

        public PickBestMatchingConstructorSerialization(int a, bool b)
        {
            A = a;
            B = b;
    ...
    [MetaSerializable]
    public class MultipleConstructorSerializationForceWorseMatching
    {
        [MetaMember(1)] public int  A { get; set; }
        [MetaMember(2)] public bool B { get; set; }
        ...
        // First two constructors should get ignored due to not having [MetaDeserializationConstructor],
        // despite being better matching than the [MetaDeserializationConstructor] constructor.

        public MultipleConstructorSerializationForceWorseMatching(bool b, int a)
        {
            B = b;
            A = a;
        }

        public MultipleConstructorSerializationForceWorseMatching(int a, bool b)
        {
            A = a;
            B = b;
        }
        ...
        [MetaDeserializationConstructor]
        public MultipleConstructorSerializationForceWorseMatching(int a)
        {
            A = a;
    ...
    public class ConstructorExplicitConstructorSerialization
    {
        ...
        public ConstructorExplicitConstructorSerialization(int a)
        {
            A = a;
        }

        public ConstructorExplicitConstructorSerialization(bool b)
        {
            B = b;
        }
    ...
    [MetaSerializable]
    public class ConstructorOptionalParameterSerializationBefore
    {
        [MetaMember(1)] public int A { get; set; }
    }

    [MetaSerializable]
    public class ConstructorOptionalParameterSerializationAfter
    {
        [MetaMember(1)] public int A { get; }
        [MetaMember(2)] public string B { get; } = "due to the constructor, this value is never used";

        [MetaDeserializationConstructor]
        public ConstructorOptionalParameterSerializationAfter(int a, string b = "defaultB")
        {
            A = a;
            B = b;
        }
    ...
    [MetaSerializable]
    public class ConstructorEscapedParametersSerializationAfter
    {
        [MetaMember(1)] public int    A { get; set; }
        [MetaMember(2)] public string B { get; }

        public ConstructorEscapedParametersSerializationAfter() {}

        [MetaDeserializationConstructor]
        public ConstructorEscapedParametersSerializationAfter(int a, string b = """"
                                                                                some text
                                                                           Less text
                                                                           "Quoted text"
                                                                           """Multiple Quotes"""
    ...
    [MetaSerializable]
    public class ConstructorOptionalPrimitiveParameterSerializationAfter
    {
        [MetaMember(1)] public int    A { get; }
        [MetaMember(2)] public int B { get; } = 10;

        [MetaDeserializationConstructor]
        public ConstructorOptionalPrimitiveParameterSerializationAfter(int a, int b = 100)
        {
            A = a;
            B = b;
        }
    ...
    [MetaSerializable]
    public class ConstructorOptionalNullParameterSerializationAfter
    {
        [MetaMember(1)] public int    A { get; }
        [MetaMember(2)] public string B { get; } = "due to the constructor, this value is never used";

        [MetaDeserializationConstructor]
        public ConstructorOptionalNullParameterSerializationAfter(int a, string b = null)
        {
            A = a;
            B = b;
        }
    ...
    [MetaSerializable]
    public struct ConstructorOptionalDefaultStruct
    {
        [MetaMember(1)]
        public int C;

        public ConstructorOptionalDefaultStruct(int c)
        {
            C = c;
        }
    }
    ...
    [MetaSerializable]
    public class ConstructorOptionalDefaultStructParameterSerializationAfter
    {
        [MetaMember(1)] public int                              A { get; }
        [MetaMember(2)] public ConstructorOptionalDefaultStruct B { get; }

        [MetaDeserializationConstructor]
        public ConstructorOptionalDefaultStructParameterSerializationAfter(int a, ConstructorOptionalDefaultStruct b = new ConstructorOptionalDefaultStruct())
        {
            A = a;
            B = b;
        }
    ...
    /// <summary>
    /// Helper for when we want to deserialize from the byte[] produced by a serializing an empty class
    /// </summary>
    [MetaSerializable]
    public class EmptyClass
    {
        public static byte[] CreateSerializedPayload()
            => MetaSerialization.SerializeTagged(new EmptyClass(), MetaSerializationFlags.IncludeAll, logicVersion: null);
    }

    [MetaSerializable]
    public class TestObjectWithInitializedProperty
    {
        [MetaMember(1)]
    ...
    [MetaSerializable]
    public enum OptionalParameterTestEnum
    {
        Five = 5,
        Zero = 0,
    }
    ...
    [MetaSerializable]
    public class ConstructorOptionalEnumParameter
    {
        [MetaMember(1)] public OptionalParameterTestEnum A { get; }
        [MetaMember(2)] public OptionalParameterTestEnum B { get; }
        [MetaMember(3)] public OptionalParameterTestEnum C { get; }

        [MetaDeserializationConstructor]
        public ConstructorOptionalEnumParameter(
            OptionalParameterTestEnum a = OptionalParameterTestEnum.Five,
            OptionalParameterTestEnum b = OptionalParameterTestEnum.Zero,
            OptionalParameterTestEnum c = (OptionalParameterTestEnum)123)
        {
            A = a;
            B = b;
            C = c;
    ...
    [MetaSerializable]
    public class ConstructorOptionalNullableValueTypeParameter
    {
        [MetaMember(1)] public int? A { get; }
        [MetaMember(2)] public ConstructorOptionalDefaultStruct? B { get; }

        [MetaDeserializationConstructor]
        public ConstructorOptionalNullableValueTypeParameter(
            int? a = null,
            ConstructorOptionalDefaultStruct? b = null)
        {
            A = a;
            B = b;
        }
    ...
    [MetaSerializable]
    public class ConstructorOptionalFloatParameter
    {
        [MetaMember(1)] public float A { get; }

        [MetaDeserializationConstructor]
        public ConstructorOptionalFloatParameter(float a = 1.23f) { A = a; }
    }

    [MetaSerializable]
    public class ConstructorOptionalDoubleParameter
    {
        [MetaMember(1)] public double A { get; }

        [MetaDeserializationConstructor]
        public ConstructorOptionalDoubleParameter(double a = 1.23) { A = a; }
    }

    [MetaSerializable]
    public class ConstructorOptionalCharParameter
    {
        [MetaMember(1)] public char A { get; }
        [MetaMember(2)] public char B { get; }
        [MetaMember(3)] public char C { get; }
        [MetaMember(4)] public char D { get; }

        [MetaDeserializationConstructor]
        public ConstructorOptionalCharParameter(
            char a = 'A',
            char b = (char)0,
    ...
    [MetaSerializable]
    public class ConstructorOptionalTupleParameter
    {
        [MetaMember(1)] public bool        A { get; }
        [MetaMember(2)] public (bool, int) B { get; } = (true, 100);

        [MetaDeserializationConstructor]
        public ConstructorOptionalTupleParameter(
            bool a = true,
            (bool, int) b = default)
        {
            A = a;
    ...
    [MetaSerializable]
    public class ConstructorOptionalBoolParameter
    {
        [MetaMember(1)] public bool A { get; }
        [MetaMember(2)] public bool B { get; }

        [MetaDeserializationConstructor]
        public ConstructorOptionalBoolParameter(
            bool a = true,
            bool b = false)
        {
            A = a;
    ...
    [MetaSerializable]
    public class ConstructorDeserializedWithMetaRefs
    {
        [MetaMember(1)] public MetaRef<SerializationTests.TestGameConfigInfo> A { get; }
        [MetaMember(2)] public MetaRef<SerializationTests.TestGameConfigInfo> B { get; }
        [MetaMember(3)] public MetaRef<SerializationTests.TestGameConfigInfo> C { get; }
        [MetaMember(4)] public MetaRef<SerializationTests.TestGameConfigInfo> D { get; }

        [MetaDeserializationConstructor]
        public ConstructorDeserializedWithMetaRefs(
            MetaRef<SerializationTests.TestGameConfigInfo> a,
            MetaRef<SerializationTests.TestGameConfigInfo> b,
            MetaRef<SerializationTests.TestGameConfigInfo> c = null,
            MetaRef<SerializationTests.TestGameConfigInfo> d = null)
        {
            A = a;
            B = b;
            C = c;
    ...
    public enum ScanTypeMode
    {
        Reflection,
        GeneratedCache
    }

    [TestFixture(arguments: new object[]{ScanTypeMode.Reflection})]
    [TestFixture(arguments: new object[]{ScanTypeMode.GeneratedCache})]
    [NonParallelizable]
    public class SerializationTests
    {
        readonly ScanTypeMode    _useGeneratedTypeInfo;
        IMetaplayServiceProvider _defaultServiceProvider = null;

        public SerializationTests(ScanTypeMode useGeneratedTypeInfo)
        {
            _useGeneratedTypeInfo = useGeneratedTypeInfo;
        }

        [OneTimeSetUp]
        public void SetUp()
        {
            if (_useGeneratedTypeInfo == ScanTypeMode.GeneratedCache)
            {
                TaggedSerializerRoslyn serializer = MetaplayServices.Get<TaggedSerializerRoslyn>();
                _defaultServiceProvider = MetaplayCore.Reinitialize(
                    services =>
                    {
                        // Add serializer from top-level container
                        services.Add(_ => serializer);

                        // Get MetaSerializerTypeInfo from already compiled assembly
                        services.Add(provider => new RuntimeTypeInfoProvider(provider.Get<TaggedSerializerRoslyn>()).GetTypeInfo());
                    });
            }
        }
        ...
        public void Teardown()
        {
            if (_defaultServiceProvider != null)
                MetaplayServices.SetServiceProvider(_defaultServiceProvider);
        }
        ...
        [Test]
        public void TestDerivedConstructorDeserialization()
        {
            PartialConstructorDeserializationDerived input = new PartialConstructorDeserializationDerived(100, 123);

            byte[]                                   persisted = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            PartialConstructorDeserializationDerived clone     = MetaSerialization.DeserializeTagged<PartialConstructorDeserializationDerived>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(true, clone.ConstructorInvoked);
            Assert.AreEqual(100, clone.A);
            Assert.AreEqual(123, clone.B);
        }

        [Test]
        public void TestPartialConstructorDeserialization()
        {
            PartialConstructorSerialization input = new PartialConstructorSerialization(100);
            input.B = true;

            byte[]                          persisted = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            PartialConstructorSerialization clone     = MetaSerialization.DeserializeTagged<PartialConstructorSerialization>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);
        ...
        [Test]
        public void TestPartialConstructorPicking()
        {
            PartialPickBestMatchingConstructorSerialization input = new PartialPickBestMatchingConstructorSerialization(100, true);

            byte[]                                          persisted = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            PartialPickBestMatchingConstructorSerialization clone     = MetaSerialization.DeserializeTagged<PartialPickBestMatchingConstructorSerialization>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);
        ...
        [Test]
        public void TestPartialExplicitConstructorDeserialization()
        {
            PartialExplicitConstructorSerialization input = new PartialExplicitConstructorSerialization(100);
            input.B = true;

            byte[]                                  persisted = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            PartialExplicitConstructorSerialization clone     = MetaSerialization.DeserializeTagged<PartialExplicitConstructorSerialization>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);
        ...
        [Test]
        public void TestPartialConstructorWithInitializerForNonConstructorMember()
        {
            // Specifically testing initializers, so deserializing a payload with no members in it.
            byte[]                                                      payload         = EmptyClass.CreateSerializedPayload();
            PartialConstructorWithInitializerForNonConstructorMember    deserialized    = MetaSerialization.DeserializeTagged<PartialConstructorWithInitializerForNonConstructorMember>(payload, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(0, deserialized.A);
            Assert.AreEqual(true, deserialized.B);
        }

        [Test]
        public void TestConstructorDeserializationWithUnderscores()
        {
            ConstructorSerializationWithUnderscores input = new ConstructorSerializationWithUnderscores(100, true);

            byte[]                                  persisted = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            ConstructorSerializationWithUnderscores clone     = MetaSerialization.DeserializeTagged<ConstructorSerializationWithUnderscores>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(true, clone.ConstructorInvoked);
            Assert.AreEqual(100, clone._a);
            Assert.AreEqual(true, clone._b);
        }
        ...
        [Test]
        public void TestPickBestMatchingConstructorDeserialization()
        {
            PickBestMatchingConstructorSerialization input = new PickBestMatchingConstructorSerialization(100, true);

            byte[]                            persisted = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            PickBestMatchingConstructorSerialization clone     = MetaSerialization.DeserializeTagged<PickBestMatchingConstructorSerialization>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);
        ...
        [Test]
        public void TestMultipleValidConstructorForceWorseMatching()
        {
            MultipleConstructorSerializationForceWorseMatching input = new MultipleConstructorSerializationForceWorseMatching(100);

            byte[]                            persisted = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            MultipleConstructorSerializationForceWorseMatching clone     = MetaSerialization.DeserializeTagged<MultipleConstructorSerializationForceWorseMatching>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(true, clone.ConstructorInvoked);
            Assert.AreEqual(100, clone.A);
            Assert.AreEqual(false, clone.B);
        }
        ...
        {
            // Deserialized type is different from serialized type. This test is meant to mimic a case where a new member is added to an existing type.
            ConstructorOptionalParameterSerializationBefore input           = new ConstructorOptionalParameterSerializationBefore { A = 100 };
            byte[]                                          persisted       = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            ConstructorOptionalParameterSerializationAfter  deserialized    = MetaSerialization.DeserializeTagged<ConstructorOptionalParameterSerializationAfter>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(100, deserialized.A);
            Assert.AreEqual("defaultB", deserialized.B);
        }

        [Test]
        public void TestConstructorWithOptionalParametersWithExplicitNull()
        {
            ConstructorOptionalParameterSerializationAfter  input           = new ConstructorOptionalParameterSerializationAfter(a: 123, b: null);
            byte[]                                          persisted       = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            ConstructorOptionalParameterSerializationAfter  deserialized    = MetaSerialization.DeserializeTagged<ConstructorOptionalParameterSerializationAfter>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(123, deserialized.A);
            Assert.AreEqual(null, deserialized.B);
        }

        [Test]
        public void TestConstructorWithEscapedStringParameters()
        {
            // Deserialized type is different from serialized type. This test is meant to mimic a case where a new member is added to an existing type.
            ConstructorOptionalParameterSerializationBefore input        = new ConstructorOptionalParameterSerializationBefore() { A = 100};
            byte[]                                          persisted    = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            ConstructorEscapedParametersSerializationAfter       deserialized = MetaSerialization.DeserializeTagged<ConstructorEscapedParametersSerializationAfter>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);
        ...
        [Test]
        public void TestConstructorWithOptionalPrimitiveParameters()
        {
            // Deserialized type is different from serialized type. This test is meant to mimic a case where a new member is added to an existing type.
            ConstructorOptionalParameterSerializationBefore         input        = new ConstructorOptionalParameterSerializationBefore { A = 100 };
            byte[]                                                  persisted    = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            ConstructorOptionalPrimitiveParameterSerializationAfter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalPrimitiveParameterSerializationAfter>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(100, deserialized.A);
            Assert.AreEqual(100, deserialized.B);
        }

        [Test]
        public void TestConstructorWithOptionalNullParameters()
        {
            // Deserialized type is different from serialized type. This test is meant to mimic a case where a new member is added to an existing type.
            ConstructorOptionalParameterSerializationBefore    input        = new ConstructorOptionalParameterSerializationBefore {A = 100};
            byte[]                                             persisted    = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            ConstructorOptionalNullParameterSerializationAfter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalNullParameterSerializationAfter>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);
        ...
        [Test]
        public void TestConstructorWithOptionalDefaultStructParameters()
        {
            // Deserialized type is different from serialized type. This test is meant to mimic a case where a new member is added to an existing type.
            ConstructorOptionalParameterSerializationBefore    input        = new ConstructorOptionalParameterSerializationBefore {A = 100};
            byte[]                                             persisted    = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.Persisted, logicVersion: null);
            ConstructorOptionalDefaultStructParameterSerializationAfter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalDefaultStructParameterSerializationAfter>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(100, deserialized.A);
            Assert.AreEqual(default(ConstructorOptionalDefaultStruct), deserialized.B);
        }

        [Test]
        public void TestConstructorWithOptionalEnumParameter()
        {
            ConstructorOptionalEnumParameter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalEnumParameter>(EmptyClass.CreateSerializedPayload(), MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null);

            Assert.AreEqual(OptionalParameterTestEnum.Five, deserialized.A);
            Assert.AreEqual(OptionalParameterTestEnum.Zero, deserialized.B);
            Assert.AreEqual((OptionalParameterTestEnum)123, deserialized.C);
        }

        [Test]
        public void TestConstructorOptionalNullableValueTypeParameter()
        {
            ConstructorOptionalNullableValueTypeParameter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalNullableValueTypeParameter>(EmptyClass.CreateSerializedPayload(), MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(null, deserialized.A);
            Assert.AreEqual(null, deserialized.B);
        }

        [Test]
        public void TestConstructorOptionalFloatParameter()
        {
            ConstructorOptionalFloatParameter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalFloatParameter>(EmptyClass.CreateSerializedPayload(), MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(1.23f, deserialized.A);
        }

        [Test]
        public void TestConstructorOptionalDoubleParameter()
        {
            ConstructorOptionalDoubleParameter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalDoubleParameter>(EmptyClass.CreateSerializedPayload(), MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(1.23, deserialized.A);
        }

        [Test]
        public void TestConstructorOptionalCharParameter()
        {
            ConstructorOptionalCharParameter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalCharParameter>(EmptyClass.CreateSerializedPayload(), MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual('A', deserialized.A);
            Assert.AreEqual((char)0, deserialized.B);
            Assert.AreEqual(char.MaxValue, deserialized.C);
            Assert.AreEqual((char)1, deserialized.D);
        }

        [Test]
        public void TestConstructorOptionalBoolParameter()
        {
            ConstructorOptionalBoolParameter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalBoolParameter>(EmptyClass.CreateSerializedPayload(), MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(true, deserialized.A);
            Assert.AreEqual(false, deserialized.B);
        }

        [Test]
        public void TestConstructorOptionalTupleParameter()
        {
            ConstructorOptionalTupleParameter deserialized = MetaSerialization.DeserializeTagged<ConstructorOptionalTupleParameter>(EmptyClass.CreateSerializedPayload(), MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);

            Assert.AreEqual(true, deserialized.A);
            Assert.AreEqual((false, 0), deserialized.B);
        }

        [Test]
        public void TestConstructorDeserializedWithMetaRefs()
        {
            TestGameConfigInfo infoX = new TestGameConfigInfo { Id = TestGameConfigId.FromString("X"), Value = "abc" };
            TestGameConfigInfo infoY = new TestGameConfigInfo { Id = TestGameConfigId.FromString("Y"), Value = "def" };

            TestGameConfigDataResolver resolver = new TestGameConfigDataResolver();
            resolver.TypeAndKeyToInfo.Add((infoX.GetType(), infoX.Id), infoX);
            resolver.TypeAndKeyToInfo.Add((infoY.GetType(), infoY.Id), infoY);

            ConstructorDeserializedWithMetaRefs original = new ConstructorDeserializedWithMetaRefs(null, MetaRef<TestGameConfigInfo>.FromItem(infoX), null, MetaRef<TestGameConfigInfo>.FromItem(infoY));
            byte[] serialized = MetaSerialization.SerializeTagged(original, MetaSerializationFlags.IncludeAll, logicVersion: null);

            // Deserialize without resolver, check, then resolve, and check again
            {
                ConstructorDeserializedWithMetaRefs deserialized = MetaSerialization.DeserializeTagged<ConstructorDeserializedWithMetaRefs>(serialized, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null);
                Assert.Null(deserialized.A);
                Assert.AreEqual(infoX.Id, deserialized.B.KeyObject);
                Assert.False(deserialized.B.IsResolved);
                Assert.Null(deserialized.C);
                Assert.AreEqual(infoY.Id, deserialized.D.KeyObject);
                Assert.False(deserialized.D.IsResolved);

                MetaSerialization.ResolveMetaRefs(deserialized, resolver);
                Assert.Null(deserialized.A);
                Assert.AreEqual(infoX.Id, deserialized.B.KeyObject);
                Assert.AreSame(infoX, deserialized.B.Ref);
                Assert.Null(deserialized.C);
                Assert.AreEqual(infoY.Id, deserialized.D.KeyObject);
                Assert.AreSame(infoY, deserialized.D.Ref);
            }

            // Deserialize with resolver
            {
                ConstructorDeserializedWithMetaRefs deserialized = MetaSerialization.DeserializeTagged<ConstructorDeserializedWithMetaRefs>(serialized, MetaSerializationFlags.IncludeAll, resolver, logicVersion: null);
                Assert.Null(deserialized.A);
                Assert.AreEqual(infoX.Id, deserialized.B.KeyObject);
                Assert.AreSame(infoX, deserialized.B.Ref);
                Assert.Null(deserialized.C);
        ...
        public void TestCollectionSize()
        {
            Assert.That(
                () =>
                {
                    ...
                    for (int i = 0; i < MetaSerializationContext.DefaultMaxCollectionSize + 1; i++)
                ...
                }, Throws.TypeOf<InvalidOperationException>().With.Message.EqualTo(Invariant($"Invalid value collection size {MetaSerializationContext.DefaultMaxCollectionSize + 1} (maximum allowed is {MetaSerializationContext.DefaultMaxCollectionSize})")));
        ...
        [Test]
        public void TestRetainInitialValueIfNotSerialized()
        {
            byte[]                            persisted = EmptyClass.CreateSerializedPayload();
            TestObjectWithInitializedProperty clone     = MetaSerialization.DeserializeTagged<TestObjectWithInitializedProperty>(persisted, MetaSerializationFlags.Persisted, resolver: null, logicVersion: null);
            Assert.AreEqual(123, clone.Test);
        }

        [Test]
        public void TestNewlyAddedClass()
        {
            NewlyAddedClass input = new NewlyAddedClass
            {
            };

            // If serializing with logicVersion==0, serialization should throw
            Assert.That(
                () =>
                {
                    MetaSerialization.SerializeTagged(input, MetaSerializationFlags.IncludeAll, logicVersion: 0);
                },
                Throws.TypeOf<MetaTypeMissingInLogicVersionSerializationException>().With.Message.EqualTo($"Type '{typeof(NewlyAddedClass).ToGenericTypeString()}' cannot be serialized as it is not available in logic version 0, at minimum version 1 is required"));

            // If serializing with logicVersion==1, type should deserialize as expected
            byte[]          serializedV1 = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.IncludeAll, logicVersion: 1);
            NewlyAddedClass cloneV1      = MetaSerialization.DeserializeTagged<NewlyAddedClass>(serializedV1, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null);

            Assert.NotNull(cloneV1);
        }

        [Test]
        public void TestAddedDerivedClassSerialization()
        {
            TestVersionedClassBase input = new TestAddedDerivedClass
            {
            };
            ...
            Assert.That(
                ...
                Throws.TypeOf<MetaTypeMissingInLogicVersionSerializationException>().With.Message.EqualTo($"Type '{typeof(TestAddedDerivedClass).ToGenericTypeString()}' cannot be serialized as it is not available in logic version 0, at minimum version 1 is required"));

            // If serializing with logicVersion==1, type should deserialize as expected
            byte[]                 serializedV1 = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.IncludeAll, logicVersion: 1);
            TestVersionedClassBase cloneV1      = MetaSerialization.DeserializeTagged<TestVersionedClassBase>(serializedV1, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null);
        ...
        public void TestAddedMemberSerialization()
        {
            ...
            TestVersionedState cloneV0 = MetaSerialization.DeserializeTagged<TestVersionedState>(serializedV0, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: 0);
            Assert.AreEqual(0, cloneV0.AddedMember);

            // If serializing with logicVersion==1, AddedMember should be retained
            byte[] serializedV1 = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.IncludeAll, logicVersion: 1);
            TestVersionedState cloneV1 = MetaSerialization.DeserializeTagged<TestVersionedState>(serializedV1, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: 1);
            Assert.AreEqual(100, cloneV1.AddedMember);
        }

        [Test]
        public void TestAddedAndRemovedRemovedMemberSerialization()
        {
            TestVersionedState input = new TestVersionedState
            {
                AddedAndRemoved = 100,
        ...
        public void TestRemovedMemberSerialization()
        {
            ...
            // If serializing with logicVersion==1, RemovedMember should be retained
            byte[] serializedV1 = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.IncludeAll, logicVersion: 1);
            TestVersionedState cloneV1 = MetaSerialization.DeserializeTagged<TestVersionedState>(serializedV1, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null);
            Assert.AreEqual(100, cloneV1.RemovedMember);

            // If serializing with logicVersion==2, RemovedMember should be discarded
            byte[] serializedV0 = MetaSerialization.SerializeTagged(input, MetaSerializationFlags.IncludeAll, logicVersion: 2);
            TestVersionedState cloneV0 = MetaSerialization.DeserializeTagged<TestVersionedState>(serializedV0, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null);
            Assert.AreEqual(0, cloneV0.RemovedMember);
        }
        ...
        public void TestEqualToAssumedGoodReference()
        {
            ...
            byte[] reference = new byte[]
            {
                ...
                66, 97, 114, 19, 174, 17, 2, 2, 15, 10, 2, 2, 2, 10, 17, 2, 176, 17, 0, 2, 178, 17, 2, 2, 180, 17, 1, 17,
            };
        ...
        // Test that integer types are compatible with each other (as long as value can be represented in each type).
        // This only applies up to and including long/ulong; MetaUInt128 is not compatible with others.

        [MetaSerializable] public class IntegerContainerSByte   { [MetaMember(1)] public sbyte Value; }
        [MetaSerializable] public class IntegerContainerShort   { [MetaMember(1)] public short Value; }
        [MetaSerializable] public class IntegerContainerInt     { [MetaMember(1)] public int Value; }
        [MetaSerializable] public class IntegerContainerLong    { [MetaMember(1)] public long Value; }

        [MetaSerializable] public class IntegerContainerByte    { [MetaMember(1)] public byte Value; }
        [MetaSerializable] public class IntegerContainerUShort  { [MetaMember(1)] public ushort Value; }
        [MetaSerializable] public class IntegerContainerUInt    { [MetaMember(1)] public uint Value; }
        [MetaSerializable] public class IntegerContainerULong   { [MetaMember(1)] public ulong Value; }

        [Test]
        public void TestIntegerCompatibility()
        {
            void TestSerializationEquals(object a, object b)
            {
                byte[] serializedA = MetaSerialization.SerializeTagged(a.GetType(), a, MetaSerializationFlags.IncludeAll, logicVersion: null);
                byte[] serializedB = MetaSerialization.SerializeTagged(b.GetType(), b, MetaSerializationFlags.IncludeAll, logicVersion: null);
                Assert.AreEqual(serializedA, serializedB);
            }

            // \note The specific (near-)power-of-two test values below are the points where the serializer's var(u)int encoding byte count changes.

            // Signed types

            // Check sbyte against larger signed types.
            foreach (sbyte value in new sbyte[] { sbyte.MinValue, sbyte.MaxValue, -65, 65, -64, 64, -63, 63, -1, 1, 0 })
            {
                TestSerializationEquals(new IntegerContainerSByte { Value = value }, new IntegerContainerShort  { Value = value });
                TestSerializationEquals(new IntegerContainerSByte { Value = value }, new IntegerContainerInt    { Value = value });
                TestSerializationEquals(new IntegerContainerSByte { Value = value }, new IntegerContainerLong   { Value = value });
            }

            // Check short against larger signed types.
            foreach (short value in new short[] { short.MinValue, short.MaxValue, -8193, 8193, -8192, 8192, -8191, 8191, sbyte.MinValue-1, sbyte.MaxValue+1 })
            {
                TestSerializationEquals(new IntegerContainerShort { Value = value }, new IntegerContainerInt    { Value = value });
                TestSerializationEquals(new IntegerContainerShort { Value = value }, new IntegerContainerLong   { Value = value });
            }

            // Check int against larger signed types.
            foreach (int value in new int[] { int.MinValue, int.MaxValue, -1048577, 1048577, -1048576, 1048576, -1048575, 1048575, short.MinValue-1, short.MaxValue+1})
            {
                TestSerializationEquals(new IntegerContainerInt { Value = value }, new IntegerContainerLong { Value = value });
            }

            // Unsigned types

            // Check byte against larger usigned types.
            foreach (byte value in new byte[] { byte.MaxValue, 0, 1, 127, 128 })
            {
                TestSerializationEquals(new IntegerContainerByte { Value = value }, new IntegerContainerUShort  { Value = value });
                TestSerializationEquals(new IntegerContainerByte { Value = value }, new IntegerContainerUInt    { Value = value });
                TestSerializationEquals(new IntegerContainerByte { Value = value }, new IntegerContainerULong   { Value = value });
            }

            // Check ushort against larger unsigned types.
            foreach (ushort value in new ushort[] { ushort.MaxValue, 16383, 16384, byte.MaxValue+1 })
            {
                TestSerializationEquals(new IntegerContainerUShort { Value = value }, new IntegerContainerUInt  { Value = value });
                TestSerializationEquals(new IntegerContainerUShort { Value = value }, new IntegerContainerULong { Value = value });
            }

            // Check uint against larger unsigned types.
            foreach (uint value in new uint[] { uint.MaxValue, 2097151, 2097152, ushort.MaxValue+1 })
            {
                TestSerializationEquals(new IntegerContainerUInt { Value = value }, new IntegerContainerULong { Value = value });
            }
        }
            ...
            // Test with "unknown derived type" failure
            {
                ...
                // Failed items. Check that the payload and the exception stored in the substitute are as expected.
                {
                    ...
                    Assert.AreEqual(
                        ...
                        Util.ConcatBytes(new byte[]{ (byte)TaggedWireSerializer.GetWireType(typeof(FailureTestOriginalItemBase), MetaSerializerTypeRegistry.Instance) }, substitute.Payload));
            ...
            // Test with "wire data type mismatch" failure
            {
                ...
                // Failed items. Check that the payload and the exception stored in the substitute are as expected.
                {
                    ...
                    byte[] payloadPrefixedWithWireType = Util.ConcatBytes(
                        new byte[]{ (byte)TaggedWireSerializer.GetWireType(typeof(FailureTestOriginalItemBase), MetaSerializerTypeRegistry.Instance) },
                        substitute.Payload);
...
#region Struct to class
        ...
        public class ConvertStructToClass_StructContainer
        {
            ...
            [MetaMember(3)] public MetaDictionary<string, ConvertStructToClass_Struct>                       StructValuedDict;
            [MetaMember(4)] public MetaDictionary<ConvertStructToClass_Struct, string>                       StructKeyedDict;
            [MetaMember(5)] public MetaDictionary<ConvertStructToClass_Struct, ConvertStructToClass_Struct>  StructKeyedAndValuedDict;
        }
        ...
        public class ConvertStructToClass_ClassContainer
        {
            ...
            [MetaMember(3)] public MetaDictionary<string, ConvertStructToClass_Class>                        ClassValuedDict;
            [MetaMember(4)] public MetaDictionary<ConvertStructToClass_Class, string>                        ClassKeyedDict;
            [MetaMember(5)] public MetaDictionary<ConvertStructToClass_Class, ConvertStructToClass_Class>    ClassKeyedAndValuedDict;
        ...
        public void DeserializationConversionStructToClass()
        {
            ConvertStructToClass_StructContainer structContainer = new ConvertStructToClass_StructContainer
            {
                ...
                StructValuedDict = new MetaDictionary<string, ConvertStructToClass_Struct>
                {
                    { "Key0", new ConvertStructToClass_Struct { X = "Value0X" } },
                    { "Key1", new ConvertStructToClass_Struct { X = "Value1X" } },
                },

                StructKeyedDict = new MetaDictionary<ConvertStructToClass_Struct, string>
                {
                    { new ConvertStructToClass_Struct { X = "Key0X" }, "Value0" },
                    { new ConvertStructToClass_Struct { X = "Key1X" }, "Value1" },
                },

                StructKeyedAndValuedDict = new MetaDictionary<ConvertStructToClass_Struct, ConvertStructToClass_Struct>
                {
...
#region Concrete to abstract using IMetaIntegration
        ...
        {
            if (_useGeneratedTypeInfo == ScanTypeMode.GeneratedCache)
                Assert.Ignore("Generating the serializer is not supported when using generated type info.");

            string dir = Path.Join(TestContext.CurrentContext.WorkDirectory, nameof(CompileSerializerWithTrampolines));

            Assert.DoesNotThrow(() => RoslynSerializerCompileCache.EnsureDllUpToDate(
                outputDir:                  dir,
                ...
                types:                      MetaplayServices.Get<MetaSerializerTypeInfo>()));
        }

#region Depth tracking

        [MetaSerializable]
        public class DepthTestChain
        {
            [MetaMember(1)] public DepthTestChain X;

            public static DepthTestChain CreateChain(int length)
            {
                DepthTestChain root = null;
                for (int i = 0; i < length; i++)
                    root = new DepthTestChain { X = root };
                return root;
            }

            public static int ResolveChainLength(DepthTestChain root)
            {
                HashSet<DepthTestChain> seen = new HashSet<DepthTestChain>();

                int length = 0;
                for (DepthTestChain node = root; node != null; node = node.X)
                {
                    if (!seen.Add(node))
                        throw new MetaAssertException($"{nameof(ResolveChainLength)} doesn't support cycles");
                    length++;
                }
        ...
        static MetaSerializationSettings? CreateSerializationSettingsMaybe(int? maxDepth)
        {
            if (maxDepth.HasValue)
                return new MetaSerializationSettings(maxDepth: maxDepth.Value);
            else
                return null;
        }
        ...
        [TestCase(10)]
        [TestCase(2 * MetaSerializationSettings.DefaultMaxDepth)]
        public void DepthTestChainJustWithinLimit(int? maxDepth)
        {
            DepthTestChain root = DepthTestChain.CreateChain((maxDepth ?? MetaSerializationSettings.DefaultMaxDepth) - 1);

            MetaSerializationSettings? settings = CreateSerializationSettingsMaybe(maxDepth);
            byte[] serialized = MetaSerialization.SerializeTagged(root, MetaSerializationFlags.IncludeAll, logicVersion: null, settings: settings);

            DepthTestChain deserialized = MetaSerialization.DeserializeTagged<DepthTestChain>(serialized, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null, settings: settings);

            Assert.AreEqual(DepthTestChain.ResolveChainLength(root), DepthTestChain.ResolveChainLength(deserialized));
        }

        [TestCase(null)] // default
        [TestCase(10)]
        [TestCase(2 * MetaSerializationSettings.DefaultMaxDepth)]
        public void DepthTestChainDeserializeJustOverLimit(int? maxDepth)
        {
            DepthTestChain root = DepthTestChain.CreateChain((maxDepth ?? MetaSerializationSettings.DefaultMaxDepth) - 1);

            MetaSerializationSettings? serializationSettings = CreateSerializationSettingsMaybe(maxDepth);
            byte[] serialized = MetaSerialization.SerializeTagged(root, MetaSerializationFlags.IncludeAll, logicVersion: null, settings: serializationSettings);

            MetaSerializationSettings? deserializationSettings = CreateSerializationSettingsMaybe((maxDepth ?? MetaSerializationSettings.DefaultMaxDepth) - 1);
            Assert.Catch<MetaSerializationDepthExceededException>(() => _ = MetaSerialization.DeserializeTagged<DepthTestChain>(serialized, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null, settings: deserializationSettings));
        }

        [TestCase(null)] // default
        [TestCase(10)]
        [TestCase(2 * MetaSerializationSettings.DefaultMaxDepth)]
        public void DepthTestChainSerializeJustOverLimit(int? maxDepth)
        {
            DepthTestChain root = DepthTestChain.CreateChain(maxDepth ?? MetaSerializationSettings.DefaultMaxDepth);

            MetaSerializationSettings? settings = CreateSerializationSettingsMaybe(maxDepth);
            Assert.Catch<MetaSerializationDepthExceededException>(() => _ = MetaSerialization.SerializeTagged(root, MetaSerializationFlags.IncludeAll, logicVersion: null, settings: settings));
        }

        [TestCase(null)] // default
        [TestCase(10)]
        [TestCase(2 * MetaSerializationSettings.DefaultMaxDepth)]
        public void DepthTestChainSerializeInfiniteCycle(int? maxDepth)
        {
            DepthTestChain root = new DepthTestChain();
            root.X = root;
        ...
        [MetaSerializable]
        public class DepthTestTree
        {
            [MetaMember(1)] public DepthTestTree X;
            [MetaMember(2)] public DepthTestTree Y;

            public static DepthTestTree CreateTree(int depth)
            {
                if (depth == 0)
                    return null;
                else
                {
                    return new DepthTestTree
                    {
                        X = CreateTree(depth-1),
                        Y = CreateTree(depth-1),
                    };
                }
            }

            public static int ResolveDepth(DepthTestTree root)
            {
                if (root == null)
                    return 0;
                else
                {
                    int x = ResolveDepth(root.X);
                    int y = ResolveDepth(root.Y);
                    // Tree shape assumption just for test simplicity
                    if (x != y)
                        throw new MetaAssertException("Expected sibling subtrees to have same depth");
        ...
        [TestCase(null)] // default
        [TestCase(5)]
        public void DepthTestTreeJustWithinLimit(int? maxDepth)
        {
            DepthTestTree root = DepthTestTree.CreateTree((maxDepth ?? 10) - 1);

            MetaSerializationSettings? settings = CreateSerializationSettingsMaybe(maxDepth);
            byte[] serialized = MetaSerialization.SerializeTagged(root, MetaSerializationFlags.IncludeAll, logicVersion: null, settings: settings);

            DepthTestTree deserialized = MetaSerialization.DeserializeTagged<DepthTestTree>(serialized, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null, settings: settings);

            Assert.AreEqual(DepthTestTree.ResolveDepth(root), DepthTestTree.ResolveDepth(deserialized));
        }

        [MetaSerializable]
        public class DepthTestChainWithMetaRef
        {
            [MetaMember(1)] public DepthTestChainWithMetaRef X;
            [MetaMember(2)] public MetaRef<TestGameConfigInfo> MetaRef;

            public static DepthTestChainWithMetaRef CreateChain(int length)
            {
                DepthTestChainWithMetaRef root = null;
                for (int i = 0; i < length; i++)
                    root = new DepthTestChainWithMetaRef { X = root };
                return root;
            }
        }
        ...
        [TestCase(10)]
        [TestCase(2 * MetaSerializationSettings.DefaultMaxDepth)]
        public void DepthTestChainResolveMetaRefsJustWithinLimit(int? maxDepth)
        {
            DepthTestChainWithMetaRef root = DepthTestChainWithMetaRef.CreateChain((maxDepth ?? MetaSerializationSettings.DefaultMaxDepth) - 1);

            MetaSerializationSettings? settings = CreateSerializationSettingsMaybe(maxDepth);
            MetaSerialization.ResolveMetaRefs(root, resolver: null, settings: settings);
        }

        [TestCase(null)] // default
        [TestCase(10)]
        [TestCase(2 * MetaSerializationSettings.DefaultMaxDepth)]
        public void DepthTestChainResolveMetaRefsJustOverLimit(int? maxDepth)
        {
            DepthTestChainWithMetaRef root = DepthTestChainWithMetaRef.CreateChain((maxDepth ?? MetaSerializationSettings.DefaultMaxDepth) - 1);

            MetaSerializationSettings? settings = CreateSerializationSettingsMaybe((maxDepth ?? MetaSerializationSettings.DefaultMaxDepth) - 1);
            Assert.Catch<MetaSerializationDepthExceededException>(() => MetaSerialization.ResolveMetaRefs(root, resolver: null, settings: settings));
        }

        // Three associated types for DepthTestDeserializationFailureHandler test:
        //   DepthTestFailureHandler_Node
        //   DepthTestFailureHandler_FailureHandlingJunction
        //   DepthTestFailureHandler_FailureTrigger
        // For testing the interaction of the depth limit with MetaOnMemberDeserializationFailure.
        // With MetaOnMemberDeserializationFailure, the deserializer needs to take care to
        // reset the depth counter correctly in the `catch` block. Otherwise, deserialization
        // that happens after the catch will think the depth is larger than it actually is,
        // which would lead to exceeding the depth limit erroneously.
        //
        // We use these three types to create object trees with a convenient shape for testing this,
        // with the failure trigger and the failure handler at convenient places.
        // See the DepthTestDeserializationFailureHandler test code for illustrative ascii art.

        [MetaSerializable]
        public class DepthTestFailureHandler_Node
        {
            [MetaMember(1)] public DepthTestFailureHandler_Node Next;
            [MetaMember(2)] public DepthTestFailureHandler_FailureHandlingJunction Junction;
            [MetaMember(3)] public DepthTestFailureHandler_FailureTrigger FailureTrigger;

            public string FailureInfo;

            public static DepthTestFailureHandler_Node CreateChain(int length, DepthTestFailureHandler_Node tail)
            {
                DepthTestFailureHandler_Node root = tail;
                for (int i = 0; i < length; i++)
                    root = new DepthTestFailureHandler_Node { Next = root };
                return root;
            }

            /// <summary>
            /// Produces an ascii art representation of the object tree, used for convenient test assertions.
            /// See <see cref="DepthTestDeserializationFailureHandler"/> for examples.
            /// </summary>
            public override string ToString()
            {
                return ToStringImpl("");
            ...
            public string ToStringImpl(string indentation)
            {
                string s = "X";
                ...
                if (FailureInfo != null)
                    s += $" ({FailureInfo})";
                if (Next != null)
                    s += $" -> {Next.ToStringImpl("     " + indentation)}";
                if (Junction != null)
                    s += $"\n{indentation}{Junction.ToStringImpl(indentation)}";
                return s;
            }
        }

        [MetaSerializable]
        public class DepthTestFailureHandler_FailureHandlingJunction
        {
            [MetaMember(1), MetaOnMemberDeserializationFailure(nameof(HandleNodeFailure))] public DepthTestFailureHandler_Node A;
            [MetaMember(2), MetaOnMemberDeserializationFailure(nameof(HandleNodeFailure))] public DepthTestFailureHandler_Node B;
            [MetaMember(3), MetaOnMemberDeserializationFailure(nameof(HandleNodeFailure))] public DepthTestFailureHandler_Node C;
            [MetaMember(4), MetaOnMemberDeserializationFailure(nameof(HandleNodeFailure))] public DepthTestFailureHandler_Node D;

            public static DepthTestFailureHandler_Node HandleNodeFailure(MetaMemberDeserializationFailureParams failureParams)
            {
                if (failureParams.Exception is DepthTestFailureHandler_FailureTrigger.TestException)
                    return new DepthTestFailureHandler_Node { FailureInfo = "Got test exception" };
                else if (failureParams.Exception is MetaSerializationDepthExceededException)
                    return new DepthTestFailureHandler_Node { FailureInfo = "Depth exceeded" };

                throw new InvalidOperationException("Unexpected exception", failureParams.Exception);
            }

            /// <inheritdoc cref="DepthTestFailureHandler_Node.ToStringImpl"/>
            public string ToStringImpl(string indentation)
            {
                return           $"A: {A?.ToStringImpl("   " + indentation) ?? "<null>"}\n" +
                    $"{indentation}B: {B?.ToStringImpl("   " + indentation) ?? "<null>"}\n" +
                    $"{indentation}C: {C?.ToStringImpl("   " + indentation) ?? "<null>"}\n" +
                    $"{indentation}D: {D?.ToStringImpl("   " + indentation) ?? "<null>"}";
            }
        }

        [MetaSerializable]
        public class DepthTestFailureHandler_FailureTrigger
        {
        ...
        [Test]
        public void DepthTestDeserializationFailureHandler()
        {
            // For the serialization input, we construct an object tree as illustrated by this first reference ascii art.
            // Starting from the left, we start with a chain of nodes (X). At one point there is a junction point,
            // from which four node chains start (A, B, C, D).
            // The first of those chains (A) ends with a marker object which will throw an exception *when deserialized*
            // (this exception is *not* the "depth exceeded" exception, but just a test exception to trigger the failure handler).
            // The second chain (B) does not throw any test exceptions, and is just within the depth limit.
            // The third chain (C) just exceeds the depth limit at deserialization time.
            // The fourth chain (D) is identical to the second chain (B).
            //
            // The second reference ascii art here shows how the object graph should look after deserialization.
            // (Deserialization in this test uses a lower depth limit than serialization. Serialization depth limit will not be exceeded.)
            // The first chain at the junction has been replaced with a substitute, marking the failure due to the test exception.
            // The second chain is intact.
            // The third chain has just exceeded the maximum depth and has been replaced with a substitute marking this.
            //
            // The point of this is to test that the depth counter is correctly reset when the exception is caught at the
            // junction point. If it was not reset (and remained at its value from the end of the throwing chain), or was
            // reset too high, then the subsequent chains would end up exceeding the depth limit, because the depth limit
            // is set such that it is just beyond the true depth of the valid chain. If it was reset too low, then the
            // third chain would not exceed the limit as expected.

            const string originalTreeStringReference =
                """
                X -> X -> X -> X -> X
                                    A: X -> X -> X (FailureTrigger)
                                    B: X -> X -> X
                                    C: X -> X -> X -> X
                                    D: X -> X -> X
                """;

            const string deserializedTreeStringReference =
                """
                X -> X -> X -> X -> X
                                    A: X (Got test exception)
                                    B: X -> X -> X
                                    C: X (Depth exceeded)
                                    D: X -> X -> X
                """;

            DepthTestFailureHandler_Node originalTree = DepthTestFailureHandler_Node.CreateChain(
                4,
                new DepthTestFailureHandler_Node
                {
                    Junction = new DepthTestFailureHandler_FailureHandlingJunction
                    {
                        A = DepthTestFailureHandler_Node.CreateChain(2, new DepthTestFailureHandler_Node { FailureTrigger = new DepthTestFailureHandler_FailureTrigger() }),
                        B = DepthTestFailureHandler_Node.CreateChain(2, new DepthTestFailureHandler_Node { }),
                        C = DepthTestFailureHandler_Node.CreateChain(3, new DepthTestFailureHandler_Node { }),
                        D = DepthTestFailureHandler_Node.CreateChain(2, new DepthTestFailureHandler_Node { }),
                    },
                });

            string originalTreeString = originalTree.ToString();
            Assert.AreEqual(originalTreeStringReference, originalTreeString);

            MetaSerializationSettings serializationSettings = new MetaSerializationSettings(maxDepth: 1000);
            byte[] serialized = MetaSerialization.SerializeTagged(originalTree, MetaSerializationFlags.IncludeAll, logicVersion: null, settings: serializationSettings);

            MetaSerializationSettings deserializationSettings = new MetaSerializationSettings(maxDepth: 10);
            DepthTestFailureHandler_Node deserializedTree = MetaSerialization.DeserializeTagged<DepthTestFailureHandler_Node>(serialized, MetaSerializationFlags.IncludeAll, resolver: null, logicVersion: null, settings: deserializationSettings);
            string deserializedTreeString = deserializedTree.ToString();
            Assert.AreEqual(deserializedTreeStringReference, deserializedTreeString);
        }
