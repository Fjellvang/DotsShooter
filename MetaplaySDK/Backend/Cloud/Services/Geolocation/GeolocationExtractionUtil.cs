...
namespace Metaplay.Cloud.Services.Geolocation
{
    ...
    {
        public static byte[] ExtractMaxMindDatabase(byte[] sourceArchiveTarGz, GeolocationOptions options)
        {
            ...
            return ExtractFileByNameFromTarGz(sourceArchiveTarGz, $"{databaseId}.mmdb", maxSize: GeolocationDatabase.PayloadMaxSize);
        }
