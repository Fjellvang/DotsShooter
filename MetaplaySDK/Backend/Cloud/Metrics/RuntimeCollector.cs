...
namespace Metaplay.Cloud.Metrics
{
    ...
    {
        public static string DotnetVersion = RuntimeInformation.FrameworkDescription.Replace(".NET ", ""); // starts with '.NET ' which we don't care about
        ...
        // Static metadata
        readonly Prometheus.Gauge       c_runtimeInfoGauge  = Prometheus.Metrics.CreateGauge    ("dotnet_runtime_info", "Describes the runtime where the Metaplay server is being run on.", "dotnet_version", "dotnet_runtime");
        ...
        public RuntimeCollector()
        {
            ...
            // Push .NET runtime information into metrics.
            c_runtimeInfoGauge.WithLabels(DotnetVersion, RuntimeInformation.RuntimeIdentifier).Set(1.0);
        }
