...
namespace Metaplay.Cloud.Entity
{
    ...
    public struct AutoShutdownPolicy
    {
        ...
        /// <para>
        /// Use this for always-running service entities.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Use this for on-demand entities.
        /// </para>
        /// </summary>
    ...
    public partial class EntityActor
    {
        ...
        {
            // Abort if the timer was canceled but the message had already been sent.
        ...
        void CancelAutoShutdownTimerForEntityShutdown()
        {
            _autoShutdown.activeTimer?.Cancel();
            _autoShutdown.activeTimer = null;
        }
