...
namespace Metaplay.Cloud.RuntimeOptions
{
    ...
    public class CommandLineRuntimeOptions
    {
        ...
        CommandLineRuntimeOptions(MetaDictionary<string, string> fields)
        {
            _fields = fields;
        }
        ...
        public static CommandLineRuntimeOptions Parse(string[] commandLine, Dictionary<string, string> shortToLongFormMappings)
        {
            ...
            MetaDictionary<string, string>   resultFields        = new MetaDictionary<string, string>();
            MetaDictionary<string, string>   fieldSourceTokens   = new MetaDictionary<string, string>();
            MetaDictionary<string, string>   sectionSourceTokens = new MetaDictionary<string, string>();
            int                                 cursor              = 0;
