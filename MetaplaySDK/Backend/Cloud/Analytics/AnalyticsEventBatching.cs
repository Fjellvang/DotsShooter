...
namespace Metaplay.Cloud.Analytics
{
    ...
    public abstract class PlayerAnalyticsContext : AnalyticsContextBase
    {
        ...
        /// </summary>
        [BigQueryAnalyticsFormat(BigQueryAnalyticsFormatMode.Ignore)] // special handling, ignore generic
        ...
        /// </summary>
        [BigQueryAnalyticsFormat(BigQueryAnalyticsFormatMode.Ignore)] // special handling, ignore generic
        [MetaMember(2)] public MetaDictionary<string, string>    Experiments     { get; private set; }

        protected PlayerAnalyticsContext() { }
        public PlayerAnalyticsContext(int? sessionNumber, MetaDictionary<string, string> experiments)
        {
    ...
    public sealed class DefaultPlayerAnalyticsContext : PlayerAnalyticsContext
    {
        ...
        public DefaultPlayerAnalyticsContext(int? sessionNumber, MetaDictionary<string, string> experiments)
    ...
    public struct AnalyticsEventEnvelope
    {
        ...
        [MetaMember(9)] public MetaDictionary<AnalyticsLabel, string>    Labels          { get; private set; }   // Set of custom labels. This may be null to signify empty set.


        public AnalyticsEventEnvelope(EntityId source, MetaTime collectedAt, MetaTime modelTime, MetaUInt128 uniqueId, string eventType, int schemaVersion, AnalyticsEventBase payload, AnalyticsContextBase context, MetaDictionary<AnalyticsLabel, string> labels)
        {
            Source          = source;
        ...
        where TContext : AnalyticsContextBase
    {
        ...
        public void Enqueue(EntityId source, MetaTime collectedAt, MetaTime modelTime, MetaUInt128 uniqueId, string eventType, int schemaVersion, TPayload payload, TContext context, MetaDictionary<AnalyticsLabel, string> labels, IGameConfigDataResolver resolver, int? logicVersion)
        {
