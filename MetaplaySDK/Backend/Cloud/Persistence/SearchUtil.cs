...
namespace Metaplay.Cloud.Persistence
{
    public static class SearchUtil
    {
        ...
        /// <summary>
        /// Gets the first word ending with a word boundary.
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static string GetFirstWord(string str)
        {
            ...
            // Use a regex to match the first sequence of word characters
            Match match = Regex.Match(str, @"\b\w+\b");

            // Return the matched word or an empty string if no match is found
