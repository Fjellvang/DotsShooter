...
namespace Metaplay.Server.MultiplayerEntity.InternalMessages
{
    ...
    public class InternalEntityStateRequest : EntityAskRequest<InternalEntityStateResponse>
    {
    ...
    public class InternalEntityStateResponse : EntityAskResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// The logic version of the model was different from the expected logic version, it was serialized with a newer version for the purpose of this request
        /// </summary>
        public bool                             LogicVersionMismatched      { get; private set; }

        InternalEntityStateResponse() { }
        public InternalEntityStateResponse(MetaSerialized<IModel> model, int logicVersion, MetaGuid staticGameConfigId, MetaGuid dynamicGameConfigId, GameConfigSpecializationKey? specializationKey, bool logicVersionMismatched)
        {
            Model                       = model;
    ...
    /// <see cref="MultiplayerEntityActorBase{TModel, TAction}.OnAssociatedEntityRefusalAsync(EntityId, AssociatedEntityRefBase, InternalEntitySubscribeRefusedBase)"/> handler
    ...
    public abstract class InternalEntitySubscribeRefusedBase : EntityAskRefusal
    {
        ...
        public static class Builtins
        {
            ...
            public class ResourceCorrection : InternalEntitySubscribeRefusedBase
            {
                ...
                public override string Message => "ResourceCorrection: Client resources are not up to date. Client must fetch new resources and try again.";
            }
            ...
            {
                DryRunSuccess() { }
                public DryRunSuccess(SessionProtocol.SessionResourceCorrection resourceCorrection, List<AssociatedEntityRefBase> associatedEntities) : base(resourceCorrection, associatedEntities)
                {
                }

                public override string Message => "DryRunSuccess: Association would have succeeded had it not been a dry run.";
            }
            ...
            public class TryAgain : InternalEntitySubscribeRefusedBase
            {
                ...
                public override string Message => "TryAgain: Association failed due to temporary issue. Caller should check the association is still valid and try again.";
            }
            ...
            public class NotAParticipant : InternalEntitySubscribeRefusedBase
            {
                ...
                public override string Message => $"NotAParticipant: The entity is not a participant of target entity.";
            }

            /// <summary>
            /// Refused due to the associated entity not being set up yet. This means that either entity state
            /// has been lost (DB rollback or ephemeral entity), or there was a race such that association was
            /// attempted before entity setup was complete.
            /// <para>
            /// Source entity should forget the associated entity and the session should try immediately again.
            /// </para>
            /// </summary>
            [MetaSerializableDerived(MessageCodesCore.InternalEntitySubscribeRefusedEntityNotSetUp)]
            public class EntityNotSetUp : InternalEntitySubscribeRefusedBase
            {
                public EntityNotSetUp() : base(resourceCorrection: default, associatedEntities: new List<AssociatedEntityRefBase>())
                {
                }

                public override string Message => $"EntityNotSetUp: The target entity has not been Set Up and is in empty state.";
            }
        }
    ...
    public class InternalEntitySetupRequest : EntityAskRequest<InternalEntitySetupResponse>
    {
    ...
    public class InternalEntitySetupResponse : EntityAskResponse
    {
    ...
    public class InternalEntityAssociatedEntityRefusedRequest : EntityAskRequest<EntityAskOk>
    {
        /// <summary>
