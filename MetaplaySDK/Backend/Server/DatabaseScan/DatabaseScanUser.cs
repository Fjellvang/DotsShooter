...
namespace Metaplay.Server.DatabaseScan.User
{
    ...
    public abstract class DatabaseScanJobSpec
    {
        ...
        /// </summary>
        public abstract MetaDictionary<string, object> CreateSummary(DatabaseScanProcessingStatistics workerStats);
    }
    ...
    public abstract class DatabaseScanProcessor
    {
        ...
        public interface IContext
        {
            ...
            Task<TResult>   ActorEntityAskAsync<TResult>                (EntityId targetEntityId, EntityAskRequest<TResult> message) where TResult : EntityAskResponse;
            ...
            Task<TResult>   ActorEntityAskAsync<TResult>                (EntityId targetEntityId, EntityAskRequest message) where TResult : MetaMessage;
        }
