...
namespace Metaplay.Server.DatabaseScan
{
    ...
    public class DatabaseScanJobCoordinationState
    {
        ...
        [MetaMember(6)] public MetaDictionary<EntityId, DatabaseScanJobWorkerCoordinationState>  Workers     { get; private set; } // \note Orderedness might not be entirely necessary but let's be safe
        ...
        public DatabaseScanJobCoordinationState(DatabaseScanJobId id, DatabaseScanJobManagerKind managerKind, DatabaseScanJobSpec spec, MetaTime startTime, List<EntityId> workerIds)
        {
            ...
            Workers = new MetaDictionary<EntityId, DatabaseScanJobWorkerCoordinationState>();
        ...
        public DatabaseScanJobCoordinationState(DatabaseScanJobId id, DatabaseScanJobManagerKind managerKind, DatabaseScanJobSpec spec, MetaTime startTime, DatabaseScanCoordinationPhase phase, MetaDictionary<EntityId, DatabaseScanJobWorkerCoordinationState> workers)
        {
            Id = id;
            ManagerKind = managerKind;
            Spec = spec;
    ...
    public class ListDatabaseScanJobsRequest : EntityAskRequest<ListDatabaseScanJobsResponse>
    {
    ...
    public class ListDatabaseScanJobsResponse : EntityAskResponse
    {
    ...
    public class BeginCancelDatabaseScanJobRequest : EntityAskRequest<BeginCancelDatabaseScanJobResponse>
    {
    ...
    public class BeginCancelDatabaseScanJobResponse : EntityAskResponse
    {
    ...
    public class SetGlobalDatabaseScanPauseRequest : EntityAskRequest<SetGlobalDatabaseScanPauseResponse>
    {
    ...
    public class SetGlobalDatabaseScanPauseResponse : EntityAskResponse
    {
    }
    ...
    public class DatabaseScanCoordinatorActor : PersistedEntityActor<PersistedDatabaseScanCoordinator, DatabaseScanCoordinatorState>, DatabaseScanJobManager.IContext
    {
        ...
        async Task UpdateInitializingJob(DatabaseScanJobCoordinationState activeJob)
        {
            ...
            foreach ((EntityId workerId, DatabaseScanJobWorkerCoordinationState workerState) in activeJob.Workers)
            {
                ...
                DatabaseScanWorkerInitializedOk initializedOk   = await EntityAskAsync(workerId, new DatabaseScanWorkerEnsureInitialized(activeJob.Id, activeJob.Spec, workShard));
        ...
        async Task UpdateResumingJob(DatabaseScanJobCoordinationState activeJob)
        {
            ...
            foreach ((EntityId workerId, DatabaseScanJobWorkerCoordinationState workerState) in activeJob.Workers)
            {
                DatabaseScanWorkerResumedOk resumedOk = await EntityAskAsync(workerId, new DatabaseScanWorkerEnsureResumed());
        ...
        async Task UpdatePausingJob(DatabaseScanJobCoordinationState activeJob)
        {
            ...
            foreach ((EntityId workerId, DatabaseScanJobWorkerCoordinationState workerState) in activeJob.Workers)
            {
                DatabaseScanWorkerPausedOk pausedOk = await EntityAskAsync(workerId, new DatabaseScanWorkerEnsurePaused());
        ...
        async Task UpdateStoppingJob(DatabaseScanJobCoordinationState activeJob)
        {
            ...
            foreach ((EntityId workerId, DatabaseScanJobWorkerCoordinationState workerState) in activeJob.Workers)
            {
                DatabaseScanWorkerStoppedOk stoppedOk = await EntityAskAsync(workerId, new DatabaseScanWorkerEnsureStopped(DatabaseScanWorkerStopFlavor.Finished));
        ...
        async Task UpdateCancellingJob(DatabaseScanJobCoordinationState activeJob)
        {
            ...
            foreach ((EntityId workerId, DatabaseScanJobWorkerCoordinationState workerState) in activeJob.Workers)
            {
                DatabaseScanWorkerStoppedOk stoppedOk = await EntityAskAsync(workerId, new DatabaseScanWorkerEnsureStopped(DatabaseScanWorkerStopFlavor.Cancel));
        ...
        [EntityAskHandler]
        void HandleListDatabaseScanJobsRequest(EntityAsk<ListDatabaseScanJobsResponse> ask, ListDatabaseScanJobsRequest request)
        {
        ...
        IEnumerable<DatabaseScanJobHistoryEntry> ConstructLatestFinishedJobsFromMaintenanceLatestJobsDeprecated()
        {
            return _state.MaintenanceJobManager.LatestJobsDeprecated
                ...
                {
                    MetaDictionary<EntityId, DatabaseScanJobWorkerCoordinationState> workerInfos = new();
        ...
        [EntityAskHandler]
        async Task HandleBeginCancelDatabaseScanJobRequest(EntityAsk<BeginCancelDatabaseScanJobResponse> ask, BeginCancelDatabaseScanJobRequest request)
        {
