...
namespace Metaplay.Server.Database
{
    public class DatabaseEntityUtil
    {
        ...
        public static Task PersistEmptyPlayerAsync(EntityId entityId, bool replace = false)
        {
            ...
            persistedPlayer.PersistedAt      = entityConfig.GetCurrentTimeForPersistedAt();
        ...
        public static Task PersistEmptyGuildAsync(EntityId entityId)
        {
            ...
            persistedGuild.PersistedAt      = entityConfig.GetCurrentTimeForPersistedAt();
        ...
        /// <summary>
        /// Creates a new entity and returns the EntityId. This method inserts the initial persisted state into the database.
        /// </summary>
        ...
        public static async Task<bool> CreateNewEntityAsync<TPersisted>(EntityId entityId, TPersisted defaultValues = null)
            where TPersisted : class, IPersistedEntity, new()
        {
            PersistedEntityConfig entityConfig = EntityConfigRegistry.Instance.GetPersistedConfig(entityId.Kind);
            ...
            persisted.PersistedAt = entityConfig.GetCurrentTimeForPersistedAt();
