...
namespace Metaplay.Server
{
    ...
    /// a <see cref="EntityAskOk"/>.
    /// </summary>
    [MetaMessage(MessageCodesCore.ScheduledMaintenanceModeRequest, MessageDirection.ServerInternal)]
    public class UpdateScheduledMaintenanceModeRequest : EntityAskRequest<EntityAskOk>
    {
    ...
    {
        [MetaMember(1)] public ScheduledMaintenanceMode ScheduledMaintenanceMode    { get; init; }
        [MetaMember(2)] public bool                     IsInMaintenance             { get; init; }
    ...
    public abstract partial class GlobalStateManagerBase<TGlobalState>
    {
        ...
        /// </summary>
        /// <remarks>
        /// Be careful about client compatibility: this is the type that gets JSON serialized,
        /// and clients rely on the JSON format to detect the hint.
        /// </remarks>
        ...
        [EntityAskHandler]
        async Task<EntityAskOk> HandleUpdateScheduledMaintenanceModeRequest(UpdateScheduledMaintenanceModeRequest mode)
        {
