...
namespace Metaplay.Server
{
    ...
    public class PlayerExperimentGlobalState : IPlayerFilter
    {
        ...
        /// </summary>
        [MetaMember(9)] public MetaDictionary<ExperimentVariantId, VariantState> Variants { get; internal set; } = new MetaDictionary<ExperimentVariantId, VariantState>();
        ...
        public PlayerExperimentGlobalState(bool hasCapacityLimit, int maxCapacity, int rolloutRatioPermille, uint experimentNonce, int controlWeight, MetaDictionary<ExperimentVariantId, VariantState> variants)
        {
    ...
    public class PlayerExperimentGlobalStatistics
    {
        ...
        public class WhyInvalidInfo
        {
            ...
            {
                if (IsConfigDataMissing)
                    return "missing config";
                else if (HasNoNonControlVariants)
                    return "there are no valid or enabled non-control variants";
                return "unknown";
            }
        }
        ...
        /// </summary>
        [MetaMember(2)] public MetaDictionary<ExperimentVariantId, VariantStats> Variants { get; private set; }
        ...
        public static PlayerExperimentGlobalStatistics CreateNew()
        {
            ...
            {
                Variants = new MetaDictionary<ExperimentVariantId, VariantStats>(),
                DisplayName = null,
                Description = null,
                WhyInvalid = null,
                CreatedAt = now,
    ...
    public class GlobalStateExperimentCombinationsRequest : EntityAskRequest<GlobalStateExperimentCombinationsResponse>
    {
    ...
    public class GlobalStateExperimentCombinationsResponse : EntityAskResponse
    {
    ...
    public class GlobalStateExperimentStateRequest : EntityAskRequest<GlobalStateExperimentStateResponse>
    {
    ...
    public class GlobalStateExperimentStateResponse : EntityAskResponse
    {
        /// <summary>
        /// null on failure.
        /// </summary>
    ...
    {
        public MetaDictionary<ExperimentVariantPair, int> SizeDeltas { get; private set; }

        GlobalStatePlayerExperimentAssignmentInfoUpdate() { }
        public GlobalStatePlayerExperimentAssignmentInfoUpdate(MetaDictionary<ExperimentVariantPair, int> sizeDeltas)
        {
    ...
    public class GlobalStateModifyExperimentRequest : EntityAskRequest<GlobalStateModifyExperimentResponse>
    {
        public PlayerExperimentId                               PlayerExperimentId      { get; private set; }
        public bool?                                            HasCapacityLimit        { get; private set; }
        public int?                                             MaxCapacity             { get; private set; }
        public int?                                             RolloutRatioPermille    { get; private set; }
        public MetaDictionary<ExperimentVariantId, int>      VariantWeights          { get; private set; }
        public MetaDictionary<ExperimentVariantId, bool>     VariantIsDisabled       { get; private set; }
        ...
        public GlobalStateModifyExperimentRequest(
            ...
            MetaDictionary<ExperimentVariantId, int> variantWeights,
            MetaDictionary<ExperimentVariantId, bool> variantIsDisabled,
    ...
    public class GlobalStateModifyExperimentResponse : EntityAskResponse
    {
    ...
    public class GlobalStateSetExperimentPhaseRequest : EntityAskRequest<GlobalStateSetExperimentPhaseResponse>
    {
        public PlayerExperimentId       PlayerExperimentId      { get; private set; }
    ...
    public class GlobalStateSetExperimentPhaseResponse : EntityAskResponse
    {
    ...
    public class GlobalStateGetAllExperimentsRequest : EntityAskRequest<GlobalStateGetAllExperimentsResponse>
    {
    ...
    public class GlobalStateGetAllExperimentsResponse : EntityAskResponse
    {
        [MetaSerializable]
    ...
    public class GlobalStateDeleteExperimentRequest : EntityAskRequest<GlobalStateDeleteExperimentResponse>
    {
        public PlayerExperimentId       PlayerExperimentId      { get; private set; }
    ...
    public class GlobalStateDeleteExperimentResponse : EntityAskResponse
    {
        public string                   ErrorStringOrNull   { get; private set; }
    ...
    public class GlobalStateEditExperimentTestersRequest : EntityAskRequest<GlobalStateEditExperimentTestersResponse>
    {
        public PlayerExperimentId       PlayerExperimentId      { get; private set; }
    ...
    public class GlobalStateEditExperimentTestersResponse : EntityAskResponse
    {
        /// <summary>
    ...
    public abstract partial class GlobalStateManagerBase<TGlobalState>
    {
        ...
        {
            public MetaDictionary<PlayerExperimentId, PlayerExperimentGlobalState> PlayerExperiments;
            public MetaDictionary<PlayerExperimentId, PlayerExperimentGlobalStatistics> PlayerExperimentsStats;
            ...
            public SyncExperimentsPlan(
                MetaDictionary<PlayerExperimentId, PlayerExperimentGlobalState> playerExperiments,
                MetaDictionary<PlayerExperimentId, PlayerExperimentGlobalStatistics>  playerExperimentsStats,
        ...
        SyncExperimentsPlan PrepareSyncExperimentsWithConfig(FullGameConfig fullGameConfig)
        {
            ...
            MetaDictionary<PlayerExperimentId, PlayerExperimentGlobalState> playerExperiments = MetaSerialization.CloneTagged(_state.PlayerExperiments, MetaSerializationFlags.IncludeAll, logicVersion: null, resolver: null);
            MetaDictionary<PlayerExperimentId, PlayerExperimentGlobalStatistics> playerExperimentsStats = MetaSerialization.CloneTagged(_state.PlayerExperimentsStats, MetaSerializationFlags.IncludeAll, logicVersion: null, resolver: null);
            ...
            void CreateNewExperimentStates()
            {
                foreach (PlayerExperimentInfo experimentInfo in fullGameConfig.ServerConfig.PlayerExperiments.Values)
                {
                    ...
                    PlayerExperimentGlobalState experimentState = new PlayerExperimentGlobalState(
                        ...
                        variants:                       new MetaDictionary<ExperimentVariantId, PlayerExperimentGlobalState.VariantState>());
            ...
            void UpdateWhyInvalid()
            {
                foreach ((PlayerExperimentId experimentId, PlayerExperimentGlobalState experimentState) in playerExperiments)
                {
                    ...
                    if (isConfigMissing || hasNoNonControlVariants)
                    {
                        ...
                        _log.Warning("Player Experiment {PlayerExperimentId} is not in a valid state: {Reason}.",  experimentId, experimentStats.WhyInvalid.GetReasonString());
                    }
                    else if (experimentStats.WhyInvalid != null)
                    {
                        _log.Info("Player Experiment {PlayerExperimentId} config conflict was resolved. (Conflict was: {Error})", experimentId, experimentStats.WhyInvalid.GetReasonString());
    ...
    {
        public static List<PlayerExperimentId> GetVisibleExperimentsInGameConfigOrder(MetaDictionary<PlayerExperimentId, PlayerExperimentGlobalState> experimentStates, FullGameConfig baselineFullGameConfig, PlayerExperimentSubject subject)
        {
