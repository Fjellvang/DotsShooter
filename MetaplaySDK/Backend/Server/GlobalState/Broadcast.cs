...
namespace Metaplay.Server
{
    ...
    /// </summary>
    [MetaSerializable]
    [MetaBlockedMembers(6, 7, 8, 9)] // LegacyLocalizations, NumGems, NumGold, LegacyAttachments
    ...
    {
        [MetaMember(1)] public MetaDictionary<LanguageId, BroadcastLocalization> Localizations { get; private set; }   // Localizations of message to target languages
        ...
        public GenericBroadcastMessageContents(MetaDictionary<LanguageId, BroadcastLocalization> localizations, List<MetaPlayerRewardBase> attachments)
        {
        ...
        public override MetaInGameMail ConvertToPlayerMail(IPlayerModelBase player)
        {
            ...
            return new SimplePlayerMail(language, translation.Title, translation.Body, Attachments, MetaGuid.NewWithTime(MetaTime.Now.ToDateTime()));
        }
    }
    ...
    public class AddBroadcastMessage : EntityAskRequest<AddBroadcastMessageResponse>
    {
    ...
    public class AddBroadcastMessageResponse : EntityAskResponse
    {
