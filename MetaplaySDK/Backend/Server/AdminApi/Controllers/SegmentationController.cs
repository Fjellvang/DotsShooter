...
namespace Metaplay.Server.AdminApi.Controllers
{
    public class SegmentationController : GameAdminApiController
    {
        ...
        public async Task<IActionResult> GetSegmentation()
        {
            ...
            List<LiveOpsEventOccurrence> liveOpsEventOccurrences = (await EntityAskAsync(LiveOpsTimelineManager.EntityId, new GetLiveOpsEventsRequest())).Occurrences;
        ...
        {
            // UsedBy: Broadcasts
            GlobalStateSnapshot snapshot = await EntityAskAsync(GlobalStateManager.EntityId, GlobalStateRequest.Instance);
            ...
            {
                GlobalStateExperimentStateResponse experimentResponse = await EntityAskAsync(GlobalStateManager.EntityId, new GlobalStateExperimentStateRequest(experimentKey));
