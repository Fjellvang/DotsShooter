...
namespace Metaplay.Server.AdminApi.Controllers
{
    ...
    public class ActivablesControllerBase : GameAdminApiController
    {
        ...
        {
            public MetaDictionary<object, GeneralActivableData>  Activables;
            public List<string>                                     IncompleteIntegrationErrors;

            public GeneralActivableKindData(MetaDictionary<object, GeneralActivableData> activables, List<string> incompleteIntegrationErrors)
            {
        ...
        protected async Task<GeneralActivablesQueryContext> GetGeneralActivablesQueryContextAsync(string time)
        {
            ...
            StatsCollectorStateResponse statsCollectorStateResponse = await EntityAskAsync(StatsCollectorManager.EntityId, StatsCollectorStateRequest.Instance);
        ...
        {
            public MetaDictionary<object, PlayerActivableData>   Activables;
            public List<string>                                     IncompleteIntegrationErrors;

            public PlayerActivableKindData(MetaDictionary<object, PlayerActivableData> activables, List<string> incompleteIntegrationErrors)
            {
                Activables = activables ?? throw new ArgumentNullException(nameof(activables));
                IncompleteIntegrationErrors = incompleteIntegrationErrors ?? throw new ArgumentNullException(nameof(incompleteIntegrationErrors));
            }
