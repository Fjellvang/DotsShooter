...
namespace Metaplay.Server.AdminApi.Controllers
{
    public class MetaplayAuditLogEventCodes
    {
        ...
        public const int GameServerGameTimeOffsetChanged              = 1035;
        ...
        public const int PlayerToggleSessionDebugMode                           = 2035;
        public const int PlayerLogicVersionUpdated                              = 2036;
        ...
        public const int LiveOpsEventCreated                                    = 9600;
        public const int LiveOpsEventUpdated                                    = 9601;
        public const int LiveOpsEventExplicitlyConcluded                        = 9602;
        public const int LiveOpsEventExported                                   = 9603;
        public const int LiveOpsEventImported                                   = 9604;

        public const int LiveOpsTimelineNodeCreated                             = 9620;
        public const int LiveOpsTimelineNodeChildAdded                          = 9621;
        public const int LiveOpsTimelineNodeChildDeleted                        = 9622;
        public const int TimelineNodeChildRemoved                               = 9623;
        public const int TimelineNodeMoved                                      = 9624;
        public const int TimelineNodeChildMoved                                 = 9625;
        public const int TimelineNodeElementRemoved                             = 9626;
        public const int TimelineNodeElementAdded                               = 9627;
        public const int TimelineElementMoved                                   = 9628;
        public const int TimelineNodeMetadataChanged                            = 9629;
        public const int TimelineElementMetadataChanged                         = 9630;
    }
}
