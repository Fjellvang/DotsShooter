...
namespace Metaplay.Server.AdminApi.Controllers
{
    ...
    public class EntityArchiveController : GameAdminApiController
    {
        ...
        public class ExportRequest
        {
            ...
            [MetaMember(1)] public MetaDictionary<string, List<string>> Entities = new MetaDictionary<string, List<string>>();
        ...
        public class ExportResponse
        {
            ...
            public MetaDictionary<string, MetaDictionary<string, ExportedEntity>> Entities = new MetaDictionary<string, MetaDictionary<string, ExportedEntity>>();

            public ExportResponse(MetaDictionary<string, MetaDictionary<string, ExportedEntity>> entities)
            {
                Entities = entities;
            }
        }
        ...
        public class ImportRequest
        {
            ...
            // {"player":[{"player:0000000003":"{DATA}"},{"player:0000000009":"{DATA}"}]}
            // DATA elements contain the actual payload as base64-encoded string and the schema version of the data.
            [MetaMember(3)] public MetaDictionary<string, MetaDictionary<string, ExportedEntity>> Entities = new MetaDictionary<string, MetaDictionary<string, ExportedEntity>>();
            // Legacy format, retained for audit log
            [MetaMember(1)] public MetaDictionary<string, MetaDictionary<string, string>> EntitiesV1;
            ...
            [MetaMember(2)] public MetaDictionary<string, MetaDictionary<string, string>> Remaps = new MetaDictionary<string, MetaDictionary<string, string>>();
        }
        ...
        public async Task<ActionResult> Export()
        {
            ...
            // Do the export
            EntityArchive.ExportResponse exportResponse = await EntityArchiveUtils.Export(bodyRequest.Entities, bodyRequest.AllowExportOnFailure, ApiBridge);
        ...
        async Task<ActionResult> ImportOrValidate(OverwritePolicy overwritePolicy, bool validateOnly)
        {
            ...
            try
            {
                EntityArchive.ImportResponse importResponse = await EntityArchiveUtils.Import(bodyRequest.FormatVersion, bodyRequest.Entities, bodyRequest.Remaps, overwritePolicy, validateOnly, asker: ApiBridge);
                if (!validateOnly)
