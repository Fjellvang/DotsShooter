...
namespace Metaplay.Server.AdminApi.Controllers
{
    public class NotificationsController : GameAdminApiController
    {
        ...
        public async Task<ActionResult> ListNotifications()
        {
            ...
            ListNotificationCampaignsResponse response = await EntityAskAsync(DatabaseScan.DatabaseScanCoordinatorActor.EntityId, request);
        ...
        public async Task<ActionResult> CreateNotification()
        {
            ...
            AddNotificationCampaignResponse response = await EntityAskAsync(DatabaseScan.DatabaseScanCoordinatorActor.EntityId, request);
            if (!response.Success)
        ...
        public async Task<ActionResult<CampaignDetails>> GetNotification(string notificationIdStr)
        {
            ...
            GetNotificationCampaignResponse response = await EntityAskAsync(DatabaseScan.DatabaseScanCoordinatorActor.EntityId, request);

            // Get totalPlayerCount from StatsCollector
            int totalPlayerCount = (await EntityAskAsync(StatsCollectorManager.EntityId, new StatsCollectorDatabaseEntityCountRequest(EntityKindCore.Player))).EntityCount;

            // Size estimate
            SegmentSizeEstimateResponse segmentSizeResponse = await EntityAskAsync(PlayerSegmentSizeEstimatorActor.EntityId, SegmentSizeEstimateRequest.Instance);
        ...
        public async Task<ActionResult> UpdateNotification(string notificationIdStr)
        {
            ...
            UpdateNotificationCampaignResponse response = await EntityAskAsync(DatabaseScan.DatabaseScanCoordinatorActor.EntityId, request);
            if (!response.Success)
        ...
        public async Task<ActionResult> CancelNotification(string notificationIdStr)
        {
            ...
            BeginCancelNotificationCampaignResponse response = await EntityAskAsync(DatabaseScan.DatabaseScanCoordinatorActor.EntityId, request);
            if (!response.Success)
        ...
        public async Task<ActionResult> DeleteNotification(string notificationIdStr)
        {
            ...
            DeleteNotificationCampaignResponse response = await EntityAskAsync(DatabaseScan.DatabaseScanCoordinatorActor.EntityId, request);
            if (!response.Success)
