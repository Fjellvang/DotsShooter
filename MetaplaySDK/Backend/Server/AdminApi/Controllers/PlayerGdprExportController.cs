...
namespace Metaplay.Server.AdminApi.Controllers
{
    ...
    public class PlayerGdprExportController : GameAdminApiController
    {
        ...
        public async Task<ActionResult<PlayerGdprExportItem>> GetGdprExport(string playerIdStr)
        {
            ...
            {
                InternalGuildMemberGdprExportResponse guildResponse = await EntityAskAsync(details.Model.GuildState.GuildId, new InternalGuildMemberGdprExportRequest(details.PlayerId));
