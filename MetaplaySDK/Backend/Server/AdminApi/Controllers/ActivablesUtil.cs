    ...
    public static class ActivablesUtil
    {
        public static ActivablesMetadata GetMetadata()
        {
            ...
            return new ActivablesMetadata(
                categories.Values.ToMetaDictionary(
        ...
        {
            public MetaDictionary<MetaActivableCategoryId, ActivableCategoryMetadata>    Categories;
            public MetaDictionary<MetaActivableKindId, ActivableKindMetadata>            Kinds;

            public ActivablesMetadata(MetaDictionary<MetaActivableCategoryId, ActivableCategoryMetadata> categories, MetaDictionary<MetaActivableKindId, ActivableKindMetadata> kinds)
            {
