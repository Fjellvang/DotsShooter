...
namespace Metaplay.Server.AdminApi.Controllers
{
    public class PlayerDeleteController : GameAdminApiController
    {
        ...
        public async Task<ActionResult> PutScheduledDeletion(string playerIdStr)
        {
            ...
            if (details.Model.DeletionStatus.IsDeleted())
            {
            ...
            else
            {
                ...
                await EntityAskAsync(details.PlayerId, new InternalPlayerScheduleDeletionRequest(request.ScheduledForDeleteAt, PlayerDeletionSource.Admin, GetUserId()));
        ...
        public async Task<ActionResult> DeleteScheduledDeletion(string playerIdStr)
        {
            ...
            else
            {
                ...
                await EntityAskAsync(details.PlayerId, new InternalPlayerScheduleDeletionRequest(null, PlayerDeletionSource.Admin));
