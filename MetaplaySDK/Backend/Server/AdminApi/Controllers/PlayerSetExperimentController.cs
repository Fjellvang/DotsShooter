...
namespace Metaplay.Server.AdminApi.Controllers
{
    ...
    public class PlayerSetExperimentController : GameAdminApiController
    {
        ...
        public async Task<IActionResult> ChangeExperimentAssignment(string playerIdStr)
        {
            ...
            GlobalStateEditExperimentTestersResponse    gsmResponse     = await EntityAskAsync(GlobalStateManager.EntityId, gsmRequest);
            ...
            InternalPlayerSetExperimentGroupResponse    playerResponse  = await EntityAskAsync(playerId, playerRequest);
            ...
            while (isWaiting)
            {
                ...
                InternalPlayerSetExperimentGroupWaitResponse    waitResponse  = await EntityAskAsync(playerId, waitRequest);
