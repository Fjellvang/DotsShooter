...
namespace Metaplay.Server.AdminApi.Controllers
{
    public class FormSchemaController : MetaplayAdminApiController
    {
        ...
        public FormSchemaController(IMetaFormSchemaProvider schemaProvider, IMetaFormValidationEngine validationEngine)
        {
        ...
        /// </summary>
        [HttpPost("forms/schema/{typeName}/validate/{playerLogicVersion?}")]
        [RequirePermission(MetaplayPermissions.ApiSchemaValidate)]
        public async Task<ActionResult> Validate(string typeName, int playerLogicVersion = -1)
        {
            ...
            try
            {
                ...
                ICollection<FormValidationResult> results = _validationEngine.ValidateObject(body, typeSpec.Type, playerLogicVersion);
