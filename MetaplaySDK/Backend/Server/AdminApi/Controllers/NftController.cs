...
namespace Metaplay.Server.AdminApi.Controllers
{
    ...
    public class NftController : GameAdminApiController
    {
        ...
        public async Task<ActionResult> SetNftOwnershipDebug([FromQuery] string collection, [FromQuery] string token, [FromQuery] string newOwnerEntity)
        {
            ...
            _ = await EntityAskAsync(NftManager.EntityId, new SetNftOwnershipDebugRequest(nftKey, newOwnerEntityId, newOwnerAddress: NftOwnerAddress.None));
        ...
        public async Task<ActionResult<GeneralNftInfo>> GetGeneralNftInfoAsync()
        {
            ...
            foreach (Web3Options.NftCollectionSpec collection in web3Options.NftCollections.Values)
            {
                ...
                NftManagerState.Collection collectionInfo = (await EntityAskAsync(NftManager.EntityId, new GetNftCollectionInfoRequest(collection.CollectionId))).Collection;
        ...
        public async Task<ActionResult<NftCollectionInfo>> GetNftCollectionAsync(string collectionIdStr)
        {
            ...
            GetNftCollectionInfoResponse collectionInfoResponse = await EntityAskAsync(NftManager.EntityId, new GetNftCollectionInfoRequest(collectionId));
            NftManagerState.Collection collectionInfo = collectionInfoResponse.Collection;

            // Query the NFTs in this collection.

            List<NftQueryItem> queryItems = (await EntityAskAsync(NftManager.EntityId, new QueryNftsRequest(collection: collectionId))).Items;
            ...
            foreach (NftQueryItem item in queryItems.Where(it => it.IsSuccess))
                MetaSerialization.ResolveMetaRefs(item.Nft, resolver);
            ...
            {
                BackgroundTaskStatusResponse response = await EntityAskAsync<BackgroundTaskStatusResponse>(BackgroundTaskActor.EntityId, new BackgroundTaskStatusByClassNameRequest(nameof(DownloadNftMetadatasTask)));
        ...
        public async Task<ActionResult<NftCollectionInfo>> GetNftAsync(string collectionIdStr, string tokenIdStr)
        {
            ...
            GetNftResponse nftResponse = await EntityAskAsync(NftManager.EntityId, new GetNftRequest(nftKey));
            ...
            if (queryItem.IsSuccess)
            {
                ...
                MetaSerialization.ResolveMetaRefs(nft, resolver);
        ...
        public async Task<ActionResult> InitializeNftAsync(string collectionIdStr, string tokenIdStr)
        {
            ...
            try
            {
                response = await EntityAskAsync(NftManager.EntityId, new BatchInitializeNftsRequest(
        ...
        public async Task<ActionResult<NftBatchInitializationResponse>> BatchInitializeNftsAsync(string collectionIdStr)
        {
            ...
            try
            {
                response = await EntityAskAsync(NftManager.EntityId,
            ...
            foreach (BatchInitializeNftsResponse.NftResponse nftResponse in response.Nfts)
                MetaSerialization.ResolveMetaRefs(nftResponse.Nft, resolver);
        ...
        public async Task<ActionResult<NftBatchInitializationFromMetadataResponse>> BatchInitializeNftsFromMetadataAsync(string collectionIdStr)
        {
            ...
            {
                TryGetExistingNftIdInRangeResponse response = await EntityAskAsync(NftManager.EntityId, new TryGetExistingNftIdInRangeRequest(collectionId, firstTokenId, numTokens));
            ...
            _ = await EntityAskAsync(BackgroundTaskActor.EntityId, new StartBackgroundTaskRequest(downloadTaskId, new DownloadNftMetadatasTask(collectionId, firstTokenId, numTokens)));
            ...
            while (true)
            {
                ...
                {
                    _ = await EntityAskAsync(BackgroundTaskActor.EntityId, new ForgetBackgroundTaskRequest(downloadTaskId));
                    break;
                }
            ...
            MetaDictionary<NftId, byte[]> metadatas = taskOutput.Metadatas;
            ...
            try
            {
                ...
                batchInitResponse = await EntityAskAsync(NftManager.EntityId,
                    new BatchInitializeNftsRequest(
                        nftInitSpecs.ToList(),
                        collectionId,
        ...
        public async Task<ActionResult> RefreshOwnedNfts(string ownerIdStr)
        {
            ...
            try
            {
                _ = await EntityAskAsync(ownerId, new RefreshOwnedNftsRequest());
            }
            catch (EntityAskRefusal refusal)
            {
        ...
        public async Task<ActionResult> RefreshSingleNft(string collectionIdStr, string tokenIdStr)
        {
            ...
            try
            {
                _ = await EntityAskAsync(NftManager.EntityId, new RefreshNftRequest(nftKey));
            }
            catch (EntityAskRefusal refusal)
            {
        ...
        public async Task<ActionResult> RefreshCollection(string collectionIdStr)
        {
            ...
            try
            {
                _ = await EntityAskAsync(NftManager.EntityId, new RefreshCollectionLedgerInfoRequest(collectionId));
            }
            catch (EntityAskRefusal refusal)
            {
        ...
        public async Task<ActionResult> RepublishNftMetadata(string collectionIdStr, string tokenIdStr)
        {
            ...
            _ = await EntityAskAsync(NftManager.EntityId, new RepublishNftMetadataRequest(nftKey));
        ...
        public async Task<ActionResult> EditNftAsync(string collectionIdStr, string tokenIdStr)
        {
            ...
            {
                TryGetExistingNftIdInRangeResponse response = await EntityAskAsync(NftManager.EntityId, new TryGetExistingNftIdInRangeRequest(collectionId, tokenId, 1));
                if (!response.Id.HasValue)
