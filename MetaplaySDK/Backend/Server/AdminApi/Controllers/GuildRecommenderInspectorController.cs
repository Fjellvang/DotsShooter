...
namespace Metaplay.Server.AdminApi.Controllers
{
    ...
    public class GuildRecommenderInspectorController : GameAdminApiController
    {
        ...
        {
            InternalGuildRecommenderInspectPoolsResponse response = await EntityAskAsync(GuildRecommenderActorBase.EntityId, new InternalGuildRecommenderInspectPoolsRequest());
        ...
        {
            InternalGuildRecommenderInspectPoolResponse response = await EntityAskAsync(GuildRecommenderActorBase.EntityId, new InternalGuildRecommenderInspectPoolRequest(poolIdStr, maxCount: count));
        ...
        public async Task<ActionResult<GuildStatus>> InspectGuild(string guildIdStr)
        {
            ...
            InternalGuildDiscoveryGuildDataResponse guildInfo = await EntityAskAsync(guildModel.GuildId, InternalGuildDiscoveryGuildDataRequest.Instance);
            ...
            InternalGuildRecommenderTestGuildResponse recommenderStatus = await EntityAskAsync(GuildRecommenderActorBase.EntityId, new InternalGuildRecommenderTestGuildRequest(guildInfo.PublicDiscoveryInfo, guildInfo.ServerOnlyDiscoveryInfo));
            MetaDictionary<string, GuildStatus.PoolStatus> pools = new MetaDictionary<string, GuildStatus.PoolStatus>();
