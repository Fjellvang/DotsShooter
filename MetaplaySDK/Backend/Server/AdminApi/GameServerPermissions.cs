...
namespace Metaplay.Server.AdminApi
{
    ...
    {
        // Special
        [MetaDescription("Access is allowed to anyone who was able to authenticate to the dashboard")]
        [Permission(defaultRoles: [])]
        public const string Anyone = RequirePermissionAttribute.SpecialPermissionAnyone;
        ...
        [MetaDescription("Delete existing game configs.")]
        [Permission(DefaultRole.GameAdmin)]
        public const string ApiGameConfigDelete = "api.game_config.delete";
        ...
        [MetaDescription("Delete existing localizations.")]
        [Permission(DefaultRole.GameAdmin)]
        [LocalizationsEnabledCondition]
        public const string ApiLocalizationDelete = "api.localization.delete";
        ...
        [MetaDescription("View telemetry messages.")]
        [Permission(DefaultRole.GameAdmin, DefaultRole.GameViewer)]
        public const string ApiSystemViewTelemetryMessages = "api.system.view_telemetry_messages";

        [MetaDescription("View cluster nodes.")]
        [Permission(DefaultRole.GameAdmin, DefaultRole.GameViewer)]
        public const string ApiSystemViewClusterNodes = "api.system.view_cluster_nodes";
        ...
        [MetaDescription("Change the logic version of an individual player.")]
        [Permission(DefaultRole.GameAdmin, DefaultRole.CustomerSupportSenior, DefaultRole.CustomerSupportAgent)]
        public const string ApiPlayersUpdateLogicVersion = "api.players.update_logic_version";
        ...
        [MetaDescription("View list of developer players.")]
        [Permission(DefaultRole.GameAdmin, DefaultRole.GameViewer, DefaultRole.CustomerSupportSenior)]
        public const string ApiPlayersViewDevelopers = "api.players.view_developers";

        [MetaDescription("Toggle player session debug mode.")]
        [Permission(DefaultRole.GameAdmin)]
        public const string ApiPlayersToggleDebugMode = "api.players.toggle_debug_mode";
        ...
        [MetaDescription("Export LiveOps Events.")]
        [LiveOpsEventsEnabledCondition]
        [Permission(DefaultRole.GameAdmin, DefaultRole.CustomerSupportSenior, DefaultRole.CustomerSupportAgent)]
        public const string ApiLiveOpsEventsExport = "api.liveops_events.export";

        [MetaDescription("Import LiveOps Events.")]
        [LiveOpsEventsEnabledCondition]
        [Permission(DefaultRole.GameAdmin)]
        public const string ApiLiveOpsEventsImport = "api.liveops_events.import";

        // Game time skipping
        [MetaDescription("Set the offset added to current date-time in game operations. This is for testing game events and other occurrences scheduled in the future.")]
        [Permission(DefaultRole.GameAdmin)]
        public const string ApiGameTimeOffsetEdit = "api.game_time_offset.edit";

        // Metrics
        [MetaDescription("View metrics.")]
        [Permission(DefaultRole.GameAdmin)]
        public const string ApiMetricsView = "api.metrics.view";
