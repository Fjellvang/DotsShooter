...
namespace Metaplay.Server.League.InternalMessages
{
    ...
    public class DivisionSetupParams : IMultiplayerEntitySetupParams
    {
        ...
        public int      DesiredParticipantCount  { get; private set; }

        DivisionSetupParams() { }

        public DivisionSetupParams(EntityId creatorId, int league, int season, int rank, int division, MetaTime startTime, MetaTime endTime, MetaTime endingSoonTime, int desiredParticipantCount)
        {
            CreatorId               = creatorId;
            Season                  = season;
            Rank                    = rank;
    ...
    public class InternalDivisionForceSetupDebugRequest : EntityAskRequest<InternalDivisionForceSetupDebugResponse>
    {
    ...
    public class InternalDivisionForceSetupDebugResponse : EntityAskResponse
    {
    ...
    public class InternalDivisionParticipantHistoryRequest : EntityAskRequest<InternalDivisionParticipantHistoryResponse>
    {
    ...
    public class InternalDivisionParticipantHistoryResponse : EntityAskResponse
    {
