...
namespace Metaplay.Server.League.Player.InternalMessages
{
    ...
    public class InternalPlayerDivisionJoinOrUpdateAvatarRequest : EntityAskRequest<InternalPlayerDivisionJoinOrUpdateAvatarResponse>
    {
    ...
    public class InternalPlayerDivisionJoinOrUpdateAvatarResponse : EntityAskResponse
    {
        /// <summary>
    ...
    public class InternalDivisionParticipantResultRequest : EntityAskRequest<InternalDivisionParticipantResultResponse>
    {
        /// <summary>
    ...
    public class InternalDivisionParticipantResultResponse : EntityAskResponse
    {
    ...
    public class InternalPlayerDivisionAvatarBatchUpdate : EntityAskRequest<EntityAskOk>
    {
    ...
    public class InternalDivisionParticipantIdRequest : EntityAskRequest<InternalDivisionParticipantIdResponse>
    {
    ...
    public class InternalDivisionParticipantIdResponse : EntityAskResponse
    {
