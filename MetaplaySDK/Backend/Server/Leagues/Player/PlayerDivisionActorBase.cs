...
namespace Metaplay.Server.League.Player
{
    ...
    /// </summary>
    public abstract class PlayerDivisionActorBase<TModel, TServerModel, TPersisted, TOptions>
        : DivisionActorBase<TModel, TServerModel, TPersisted, TOptions>,
    ...
    public abstract class PlayerDivisionActorBase<TModel, TPersisted, TOptions> : PlayerDivisionActorBase<TModel, DefaultDivisionServerModel, TPersisted, TOptions>
        where TModel : class, IPlayerDivisionModel<TModel>, new()
        where TPersisted : PersistedDivisionBase, new()
        where TOptions : LeagueManagerOptionsBase
    {
