...
namespace Metaplay.Server.League
{
    ...
    public class InternalLeagueJoinRequest : EntityAskRequest<InternalLeagueJoinResponse>
    {
    ...
    public class InternalLeagueDebugJoinRankRequest : EntityAskRequest<InternalLeagueJoinResponse>
    {
        public EntityId ParticipantId { get; private set; }
    ...
    public class InternalLeagueJoinResponse : EntityAskResponse
    {
    ...
    /// </summary>
    [LeaguesEnabledCondition]
    [MetaMessage(MessageCodesCore.InternalLeagueReassignRequest, MessageDirection.ServerInternal)]
    public class InternalLeagueReassignRequest : EntityAskRequest<InternalLeagueJoinResponse>
    {
        public EntityId                     ParticipantId    { get; private set; }
        public LeagueJoinRequestPayloadBase Payload          { get; private set; }
        public bool                         LeaveOldDivision { get; private set; }

        public InternalLeagueReassignRequest(EntityId participantId, LeagueJoinRequestPayloadBase payload, bool leaveOld)
        {
            ParticipantId    = participantId;
            Payload          = payload;
            LeaveOldDivision = leaveOld;
        }

        InternalLeagueReassignRequest() { }
    }
    ...
    public class InternalLeagueLeaveRequest : EntityAskRequest<EntityAskOk>
    {
        public EntityId ParticipantId { get; private set; }
        /// <summary>
    ...
    public class InternalLeagueDebugAddRequest : EntityAskRequest<InternalLeagueDebugAddResponse>
    {
        public EntityId ParticipantId { get; private set; }
    ...
    public class InternalLeagueDebugAddResponse : EntityAskResponse
    {
    ...
    public class InternalLeagueStateRequest : EntityAskRequest<InternalLeagueStateResponse>
    {
    ...
    public class InternalLeagueStateResponse : EntityAskResponse
    {
    ...
    public class InternalLeagueDebugAdvanceSeasonRequest : EntityAskRequest<EntityAskOk>
    {
        /// <summary>
