...
namespace Metaplay.Server
{
    ...
    public class StartBackgroundTaskRequest : EntityAskRequest<StartBackgroundTaskResponse>
    {
    ...
    public class StartBackgroundTaskResponse : EntityAskResponse
    {
        public MetaGuid Id { get; private set; }
    ...
    public class ForgetBackgroundTaskRequest : EntityAskRequest<StartBackgroundTaskResponse> // TODO: return value type is a bit silly here
    {
        public MetaGuid Id { get; private set; }
    ...
    [MetaMessage(MessageCodesCore.BackgroundTaskStatusByClassNameRequest, MessageDirection.ServerInternal)]
    public class BackgroundTaskStatusByClassNameRequest : MetaMessage
    {
        public string ClassName { get; private set; }

        public BackgroundTaskStatusByClassNameRequest() { }
        public BackgroundTaskStatusByClassNameRequest(string className)
        {
            ClassName = className;
        }
    }

    [MetaMessage(MessageCodesCore.BackgroundTaskStatusByIdRequest, MessageDirection.ServerInternal)]
    public class BackgroundTaskStatusByIdRequest : MetaMessage
    {
        public MetaGuid TaskId { get; private set; }

        public BackgroundTaskStatusByIdRequest() { }
        public BackgroundTaskStatusByIdRequest(MetaGuid taskId)
        {
            TaskId = taskId;
        }
    }
    ...
    public class BackgroundTaskStatusResponse : EntityAskResponse
    {
    ...
    public struct BackgroundTaskContext
    {
        ...
        {
            return SharedApiBridge.ForwardAskToEntity.ExecuteAsync<TResult>(_actor, entityId, message);
        }

        public Task<TResult> EntityAskAsync<TResult>(EntityId entityId, EntityAskRequest<TResult> message) where TResult : EntityAskResponse
        {
            return SharedApiBridge.ForwardAskToEntity.ExecuteAsync<TResult>(_actor, entityId, message);
        }
        ...
        public Task<TResult> EntityAskAsync<TResult>(EntityId entityId, EntityAskRequest message) where TResult : MetaMessage
        {
            return SharedApiBridge.ForwardAskToEntity.ExecuteAsync<TResult>(_actor, entityId, message);
        }
    }
    ...
    public class BackgroundTaskActor : EphemeralEntityActor
    {
        ...
        [EntityAskHandler]
        public BackgroundTaskStatusResponse HandleBackgroundTaskStatusByClassNameRequest(BackgroundTaskStatusByClassNameRequest statusRequest)
        {
        ...
        [EntityAskHandler]
        public BackgroundTaskStatusResponse HandleBackgroundTaskStatusByIdRequest(BackgroundTaskStatusByIdRequest statusRequest)
        {
            if (_taskStates.TryGetValue(statusRequest.TaskId, out TaskState state))
                return new BackgroundTaskStatusResponse(new List<BackgroundTaskStatus>(){
                    new BackgroundTaskStatus()
                    {
                        Id        = statusRequest.TaskId,
                        Task      = state.Task,
                        Completed = state.Completed,
                        Failure   = TryGetExceptionStringForTaskStatus(state.Exception),
                        Output    = state.Output
                    }});
