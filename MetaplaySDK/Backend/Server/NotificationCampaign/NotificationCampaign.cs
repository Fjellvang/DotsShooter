...
namespace Metaplay.Server.NotificationCampaign
{
    ...
    public class NotificationCampaignParams : IPlayerFilter
    {
        ...
        [MetaMember(3)]   public MetaDictionary<LanguageId, NotificationLocalizationOld> LocalizationsOld            { get; private set; }
    ...
    public class ListNotificationCampaignsRequest : EntityAskRequest<ListNotificationCampaignsResponse>
    {
    ...
    public class ListNotificationCampaignsResponse : EntityAskResponse
    {
    ...
    public class AddNotificationCampaignRequest : EntityAskRequest<AddNotificationCampaignResponse>
    {
    ...
    public class AddNotificationCampaignResponse : EntityAskResponse
    {
    ...
    public class GetNotificationCampaignRequest : EntityAskRequest<GetNotificationCampaignResponse>
    {
    ...
    public class GetNotificationCampaignResponse : EntityAskResponse
    {
        public bool                     Success         { get; private set; }
    ...
    public class UpdateNotificationCampaignRequest : EntityAskRequest<UpdateNotificationCampaignResponse>
    {
        public int                          Id              { get; private set; }
        public NotificationCampaignParams   CampaignParams  { get; private set; }
    ...
    public class UpdateNotificationCampaignResponse : EntityAskResponse
    {
        public bool     Success { get; private set; }
        public string   Error   { get; private set; }
    ...
    public class BeginCancelNotificationCampaignRequest : EntityAskRequest<BeginCancelNotificationCampaignResponse>
    {
        public int Id { get; private set; }
    ...
    public class BeginCancelNotificationCampaignResponse : EntityAskResponse
    {
        public bool Success { get; private set; }
        public string Error { get; private set; }
    ...
    public class DeleteNotificationCampaignRequest : EntityAskRequest<DeleteNotificationCampaignResponse>
    {
        public int Id { get; private set; }
    ...
    public class DeleteNotificationCampaignResponse : EntityAskResponse
    {
        public bool Success { get; private set; }
        public string Error { get; private set; }
