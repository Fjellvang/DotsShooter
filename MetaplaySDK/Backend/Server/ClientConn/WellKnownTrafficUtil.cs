...
namespace Metaplay.Server
{
    ...
    public static class WellKnownTrafficUtil
    {
        ...
        static readonly WellKnownPrefixSpec[] s_wellKnownPrefixes = new WellKnownPrefixSpec[]
        {
            ...
            // Generic HELPs. Used by SMTP, FTP, perhaps many others.
            new WellKnownPrefixSpec(prefixUtf8: "HELP",        kindLabel: "GenericHELP"),
            new WellKnownPrefixSpec(prefixUtf8: "help",        kindLabel: "GenericHelp"),

            // SMTP (Simple Mail Transfer Protocol)
            new WellKnownPrefixSpec(prefixUtf8: "HELO ",        kindLabel: "SmtpHELO"),
            new WellKnownPrefixSpec(prefixUtf8: "EHLO ",        kindLabel: "SmtpEHLO"),
            // \note: already handled in generic path
            //new WellKnownPrefixSpec(prefixUtf8: "HELP",        kindLabel: "SmtpHELP"),

            // SSTP (Secure Socket Tunneling Protocol)
            new WellKnownPrefixSpec(prefixUtf8: "SSTP_DUPLEX_POST", kindLabel: "SstpDuplexPost"),
        };
    }
}
