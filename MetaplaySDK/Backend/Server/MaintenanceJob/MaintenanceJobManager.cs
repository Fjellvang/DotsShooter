...
namespace Metaplay.Server.MaintenanceJob
{
    ...
    public class AddMaintenanceJobRequest : EntityAskRequest<AddMaintenanceJobResponse>
    {
    ...
    public class AddMaintenanceJobResponse : EntityAskResponse
    {
    ...
    public class RemoveMaintenanceJobRequest : EntityAskRequest<RemoveMaintenanceJobResponse>
    {
        public int MaintenanceJobId { get; private set; }
    ...
    public class RemoveMaintenanceJobResponse : EntityAskResponse
    {
        public bool                 IsSuccess   { get; private set; }
