...
namespace Metaplay.Server.EntityArchive
{
    ...
    public abstract class ExportEntityHandler
    {
        ...
        public async Task<ExportedEntity> Export(IEntityMessagingApi asker)
        {
        ...
        protected abstract Task<ExportedEntity> DoExport(string id, IEntityMessagingApi asker);
    }
...
#pragma warning restore CS0618 // Type or member is obsolete
    {
        ...
        protected override sealed async Task<ExportedEntity> DoExport(string id, IEntityMessagingApi asker)
        {
            ...
            try
            {
                ...
                MetaMessage _ = await asker.EntityAskAsync(entityId, PersistStateRequestRequest.Instance);
            }
            catch (Exception)
            {
