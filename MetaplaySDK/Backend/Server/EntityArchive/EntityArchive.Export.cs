...
namespace Metaplay.Server.EntityArchive
{
    ...
    public class ExportResponse
    {
        ...
        [MetaMember(2)] public MetaDictionary<string, MetaDictionary<string, ExportedEntity>> Results;
        ...
        public ExportResponse(MetaDictionary<string, MetaDictionary<string, ExportedEntity>> results)
        {
            Success = true;
            Results = results;
        }
    ...
    public partial class EntityArchiveUtils
    {
        ...
        /// <returns></returns>
        public static async Task<ExportResponse> Export(MetaDictionary<string, List<string>> exportEntities, bool allowExportOnLoadFailure, IEntityMessagingApi asker)
        {
            // We'll store the export results in here
            MetaDictionary<string, MetaDictionary<string, ExportedEntity>> results = new MetaDictionary<string, MetaDictionary<string, ExportedEntity>>();
            ...
            foreach ((string entityType, ArchivingSpec archivingSpec) in s_archiveHandlers)
            {
                ...
                if (entityRequests != null)
                {
                    ...
                    MetaDictionary<string, ExportedEntity> entities = new MetaDictionary<string, ExportedEntity>();
