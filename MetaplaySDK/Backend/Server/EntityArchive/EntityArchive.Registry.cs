...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        MetaDictionary<string, ArchivingSpec> _archiveHandlers;
        static MetaDictionary<string, ArchivingSpec> s_archiveHandlers => MetaplayServices.Get<EntityArchiveUtils>()._archiveHandlers;

        public EntityArchiveUtils(EntityConfigRegistry entityConfigRegistry)
        {
            MetaDictionary<string, ArchivingSpec> handlers = new();
