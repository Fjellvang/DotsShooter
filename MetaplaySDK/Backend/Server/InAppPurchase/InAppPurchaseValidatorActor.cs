...
namespace Metaplay.Server.InAppPurchase
{
    ...
    public class InAppPurchaseSubscriptionStateRequest : EntityAskRequest<InAppPurchaseSubscriptionStateResponse>
    {
    ...
    public class InAppPurchaseSubscriptionStateResponse : EntityAskResponse
    {
        [MetaSerializable]
    ...
    public class InAppPurchaseValidatorActor : EphemeralEntityActor
    {
        ...
        /// </summary>
        [EntityAskHandler]
        public void HandleInAppPurchaseSubscriptionStateRequestAsk(EntityAsk<InAppPurchaseSubscriptionStateResponse> ask, InAppPurchaseSubscriptionStateRequest request)
        {
