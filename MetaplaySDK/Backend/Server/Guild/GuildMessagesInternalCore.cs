...
namespace Metaplay.Server.Guild.InternalMessages
{
    ...
    public class InternalOwnedGuildAssociationRef : AssociatedEntityRefBase
    {
        ...
        public MetaDictionary<int, GuildMemberGuildOpLogEntry>   CommittedPendingGuildOps        { get; private set; }
        ...
        public InternalOwnedGuildAssociationRef(EntityId playerId, EntityId guildId, int memberInstanceId, int lastPlayerOpEpoch, int committedPlayerOpEpoch, int committedGuildOpEpoch, MetaDictionary<int, GuildMemberGuildOpLogEntry> committedPendingGuildOps, GuildMemberPlayerDataBase playerLoginData) : base(playerId, guildId)
        {
    ...
    public class InternalGuildMemberSubscribeRefused : InternalEntitySubscribeRefusedBase
    {
        ...
        [MetaMember(2)] public MetaDictionary<int, GuildMemberPlayerOpLogEntry>  PendingPlayerOps    { get; private set; }
        ...
        public static InternalGuildMemberSubscribeRefused CreatePendingPlayerOps(MetaDictionary<int, GuildMemberPlayerOpLogEntry> pendingPlayerOps)
        {
    ...
    public class InternalGuildLeaveRequest : EntityAskRequest<InternalGuildLeaveResponse>
    {
        public EntityId                                             PlayerId                { get; private set; }
        public int                                                  MemberInstanceId        { get; private set; }
        public int                                                  CommittedPlayerOpEpoch  { get; private set; }
        public MetaDictionary<int, GuildMemberGuildOpLogEntry>   PendingGuildOps         { get; private set; }
        public bool                                                 ForceLeave              { get; private set; }

        InternalGuildLeaveRequest() { }
        public InternalGuildLeaveRequest(EntityId playerId, int memberInstanceId, int committedPlayerOpEpoch, MetaDictionary<int, GuildMemberGuildOpLogEntry> pendingGuildOps, bool forceLeave)
        {
            PlayerId = playerId;
            MemberInstanceId = memberInstanceId;
            CommittedPlayerOpEpoch = committedPlayerOpEpoch;
    ...
    public class InternalGuildLeaveResponse : EntityAskResponse
    {
        [MetaSerializable]
        public enum ResultCode
        {
        ...
        public MetaDictionary<int, GuildMemberPlayerOpLogEntry>  PendingPlayerOps        { get; private set; }

        public InternalGuildLeaveResponse() { }
        InternalGuildLeaveResponse(ResultCode result, MetaDictionary<int, GuildMemberPlayerOpLogEntry> pendingPlayerOps)
        {
            Result = result;
        ...
        public static InternalGuildLeaveResponse CreatePendingPlayerOps(MetaDictionary<int, GuildMemberPlayerOpLogEntry> pendingPlayerOps) => new InternalGuildLeaveResponse(ResultCode.PendingPlayerOps, pendingPlayerOps);
    ...
    public class InternalGuildPlayerDashboardInfoRequest : EntityAskRequest<InternalGuildPlayerDashboardInfoResponse>
    {
        public EntityId                     PlayerId                { get; private set; }
    ...
    public class InternalGuildPlayerDashboardInfoResponse : EntityAskResponse
    {
    ...
    public class InternalGuildDiscoveryGuildDataRequest : EntityAskRequest<InternalGuildDiscoveryGuildDataResponse>
    {
    ...
    public class InternalGuildDiscoveryGuildDataResponse : EntityAskResponse
    {
    ...
    public static class InternalGuildTransactionPlayerSync
    {
        ...
        public class Commit : MetaMessage
        {
            ...
            public MetaDictionary<int, GuildMemberPlayerOpLogEntry>  PreceedingPlayerOps         { get; private set; }
            public int                                                  ExpectedPlayerOpEpoch       { get; private set; }

            public Commit() {}
            Commit(bool isCancel, ITransactionPlan guildPlan, ITransactionPlan serverPlan, MetaDictionary<int, GuildMemberPlayerOpLogEntry> preceedingPlayerOps, int expectedPlayerOpEpoch)
            {
                IsCancel = isCancel;
                GuildPlan = guildPlan;
            ...
            public static Commit CreateOk(ITransactionPlan guildPlan, ITransactionPlan serverPlan, MetaDictionary<int, GuildMemberPlayerOpLogEntry> preceedingPlayerOps, int expectedPlayerOpEpoch) => new Commit(false, guildPlan, serverPlan, preceedingPlayerOps, expectedPlayerOpEpoch);
            public static Commit CreateCancel(MetaDictionary<int, GuildMemberPlayerOpLogEntry> preceedingPlayerOps) => new Commit(true, null, null, preceedingPlayerOps, 0);
        }
    ...
    public static class InternalGuildTransactionGuildSync
    {
        ...
        public class PlannedAndCommitted : MetaMessage
        {
            ...
            PlannedAndCommitted(ResultCode result, ITransactionPlan guildPlan, MetaSerialized<GuildActionBase> guildFinalizingAction, MetaDictionary<int, GuildMemberPlayerOpLogEntry> preceedingPlayerOps, int expectedPlayerOpEpoch, string errorString)
            {
                Result = result;
                GuildPlan = guildPlan;
            ...
            public static PlannedAndCommitted CreateOk(ITransactionPlan guildPlan, MetaSerialized<GuildActionBase> guildFinalizingAction, MetaDictionary<int, GuildMemberPlayerOpLogEntry> preceedingPlayerOps, int expectedPlayerOpEpoch) => new PlannedAndCommitted(ResultCode.Ok, guildPlan, guildFinalizingAction, preceedingPlayerOps, expectedPlayerOpEpoch, null);
            public static PlannedAndCommitted CreateCancel(MetaDictionary<int, GuildMemberPlayerOpLogEntry> preceedingPlayerOps) => new PlannedAndCommitted(ResultCode.Cancel, null, default, preceedingPlayerOps, 0, null);
    ...
    public class InternalGuildRunPendingGuildOpsRequest : MetaMessage
    {
        public EntityId                                                 PlayerId            { get; private set; }
        public int                                                      MemberInstanceId    { get; private set; }
        public MetaDictionary<int, GuildMemberGuildOpLogEntry>       Ops                 { get; private set; }

        public InternalGuildRunPendingGuildOpsRequest() { }
        public InternalGuildRunPendingGuildOpsRequest(EntityId playerId, int memberInstanceId, MetaDictionary<int, GuildMemberGuildOpLogEntry> ops)
        {
            PlayerId = playerId;
            MemberInstanceId = memberInstanceId;
            Ops = ops;
    ...
    public class InternalGuildPeekKickedStateRequest : EntityAskRequest<InternalGuildPeekKickedStateResponse>
    {
        public EntityId PlayerId                { get; private set; }
        public int      MemberInstanceId        { get; private set; }
        public int      CommittedPlayerOpEpoch  { get; private set; }
    ...
    public class InternalGuildPeekKickedStateResponse : EntityAskResponse
    {
        [MetaSerializable]
        public enum ResultCode
        {
        ...
        InternalGuildPeekKickedStateResponse(ResultCode result, MetaDictionary<int, GuildMemberPlayerOpLogEntry> pendingPlayerOps, IGuildMemberKickReason kickReasonOrNull)
        {
            Result = result;
            PendingPlayerOps = pendingPlayerOps;
        ...
        public static InternalGuildPeekKickedStateResponse CreatePendingPlayerOps(MetaDictionary<int, GuildMemberPlayerOpLogEntry> pendingPlayerOps) => new InternalGuildPeekKickedStateResponse(ResultCode.PendingPlayerOps, pendingPlayerOps, null);
    ...
    public class InternalGuildChangeDisplayNameAndDescriptionRequest : EntityAskRequest<InternalGuildChangeDisplayNameAndDescriptionResponse>
    {
    ...
    public class InternalGuildChangeDisplayNameAndDescriptionResponse : EntityAskResponse
    {
    ...
    public class InternalSessionGuildTimelineUpdate : MetaMessage
    {
        ...
        public long                                                         StartTick       { get; private set; } // Tick of the first Operation
        ...
        public InternalSessionGuildTimelineUpdate(MetaSerialized<List<GuildTimelineUpdateMessage.Operation>> operations, long startTick, int startOperation, uint finalChecksum)
        {
    ...
    public class InternalGuildMemberGdprExportRequest : EntityAskRequest<InternalGuildMemberGdprExportResponse>
    {
        public EntityId PlayerId    { get; private set; }
    ...
    public class InternalGuildMemberGdprExportResponse : EntityAskResponse
    {
        public bool     IsSuccess           { get; private set; }
    ...
    public class InternalGuildImportModelDataRequest : EntityAskRequest<InternalGuildImportModelDataResponse>
    {
    ...
    public class InternalGuildImportModelDataResponse : EntityAskResponse
    {
    ...
    public class InternalGuildAdminEditRolesRequest : EntityAskRequest<InternalGuildAdminEditRolesResponse>
    {
        public EntityId                                     TargetPlayerId  { get; private set; }
        public GuildMemberRole                              TargetNewRole   { get; private set; }
        public MetaDictionary<EntityId, GuildMemberRole> ExpectedChanges { get; private set; }

        public InternalGuildAdminEditRolesRequest() { }
        public InternalGuildAdminEditRolesRequest(EntityId targetPlayerId, GuildMemberRole targetNewRole, MetaDictionary<EntityId, GuildMemberRole> expectedChanges)
        {
    ...
    public class InternalGuildAdminEditRolesResponse : EntityAskResponse
    {
        public bool Success { get; private set; }
    ...
    public class InternalGuildInspectInviteCodeRequest : EntityAskRequest<InternalGuildInspectInviteCodeResponse>
    {
    ...
    public class InternalGuildInspectInviteCodeResponse : EntityAskResponse
    {
        public bool                                     Success         { get; private set; }
