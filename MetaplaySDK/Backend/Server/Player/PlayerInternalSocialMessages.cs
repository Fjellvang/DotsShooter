...
namespace Metaplay.Server
{
    ...
    public class PlayerCopyAuthFromRequest : EntityAskRequest<EntityAskOk>
    {
        public MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> AttachedAuthMethods { get; private set; }

        PlayerCopyAuthFromRequest() { }
        public PlayerCopyAuthFromRequest(MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> attachedAuthMethods)
        {
    ...
    public class PlayerDetachAllAuthRequest : EntityAskRequest<EntityAskOk>
    {
    ...
    public class PlayerRemoveSingleAuthRequest : EntityAskRequest<PlayerRemoveSingleAuthResponse>
    {
    ...
    public class PlayerRemoveSingleAuthResponse : EntityAskResponse
    {
    ...
    public class InternalPlayerFacebookAuthenticationRevokedRequest : EntityAskRequest<InternalPlayerFacebookAuthenticationRevokedResponse>
    {
        [MetaSerializable]
    ...
    public class InternalPlayerFacebookAuthenticationRevokedResponse : EntityAskResponse
    {
    ...
    public class InternalPlayerResolveSocialAuthConflictRequest : EntityAskRequest<InternalPlayerResolveSocialAuthConflictResponse>
    {
        [MetaSerializable]
        ...
        /// </summary>
        public MetaDictionary<AuthenticationKey, PlayerAuthEntryBase>    AddedSocialKeys     { get; private set; }
        ...
        InternalPlayerResolveSocialAuthConflictRequest(ResolveOperation operation, MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> addedKeys, AuthenticationKey[] removedKeys, EntityId otherPlayerId)
        {
        ...
        public static InternalPlayerResolveSocialAuthConflictRequest ForSocialAuthMigrationDestination(MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> addedSocialKeys, EntityId otherPlayerId)
        {
        ...
        public static InternalPlayerResolveSocialAuthConflictRequest ForSocialAuthAddNewMigrationKey(MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> addedSocialKeys)
        {
    ...
    public class InternalPlayerResolveSocialAuthConflictResponse : EntityAskResponse
    {
        /// <summary>
        ...
        /// </summary>
        public MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> RemovedSocialKeys { get; private set; }

        InternalPlayerResolveSocialAuthConflictResponse() { }
        public InternalPlayerResolveSocialAuthConflictResponse(MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> removedSocialKeys)
        {
    ...
    public class InternalPlayerResolveDeviceIdAuthConflictRequest : EntityAskRequest<InternalPlayerResolveDeviceIdAuthConflictResponse>
    {
        [MetaSerializable]
        public enum ResolveOperation
        {
    ...
    public class InternalPlayerResolveDeviceIdAuthConflictResponse : EntityAskResponse
    {
    ...
    public class InternalPlayerAddNewSocialAccountRequest : EntityAskRequest<EntityAskOk>
    {
    ...
    public class InternalPlayerLoginWithNewSocialAccountRequest : EntityAskRequest<InternalPlayerLoginWithNewSocialAccountResponse>
    {
        public AuthenticatedSocialClaimKeys SocialKeys { get; private set; }
    ...
    public class InternalPlayerLoginWithNewSocialAccountResponse : EntityAskResponse
    {
        [MetaSerializable]
