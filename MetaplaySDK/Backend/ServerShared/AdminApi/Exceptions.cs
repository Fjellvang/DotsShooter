...
namespace Metaplay.Server.AdminApi.Controllers
{
    public static class Exceptions
    {
        ...
        public class MetaplayHttpException : Exception
        {
            ...
            public MetaplayHttpException(HttpStatusCode statusCode, string message, string details) : base(message)
            {
                ExStatusCode = (int)statusCode;
                ExMessage = message;
                ExDetails = details;
            }
        ...
        public class MetaplayHttpExceptionFilter : ExceptionFilterAttribute
        {
            ...
            public override void OnException(ExceptionContext context)
            {
                ...
                // If this the original handler has already started to respond, there's nothing we can do.
                // Let the original response through. This only affects Endpoints that perform cancellable
                // streaming output, such as SSE.
