...
namespace Metaplay.Server.AdminApi.AuditLog
{
    ...
    public class EventTarget
    {
        ...
        public static EventTarget FromLiveOpsEventOccurrenceId(MetaGuid occurrenceId)
        {
            return new EventTarget("$LiveOpsEventOccurrence", occurrenceId.ToString());
        }
        public static EventTarget FromLiveOpsTimelineNode(MetaGuid nodeId)
        {
            return new EventTarget("$LiveOpsTimelineNode", nodeId.ToString());
        }
    }
