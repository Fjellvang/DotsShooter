...
namespace Metaplay.Server.Tests
{
    ...
    class FormValidatorTests
    {
        ...
        MetaFormTypeRegistry     _registry;
        ...
        public void Init()
        {
            _registry         = new MetaFormTypeRegistry(MetaplayServices.Get<MetaSerializerTypeRegistry>());
            _validationEngine = new MetaFormValidationEngine(_registry);
        ...
        {
            MetaFormContentType contentType = _registry.GetTypeSpec(typeof(TestValidationClass));
            ...
            contentType = _registry.GetTypeSpec(typeof(TestValidationNestedClass));
            ...
            contentType = _registry.GetTypeSpec(typeof(TestValidationStruct));
            classType   = (MetaFormClassContentType)contentType;
