 ...
 */
export function addGeneratedUiViewComponent(rule: IGeneratedUiComponentRule): void {
 ...
 */
export function addGeneratedUiFormComponent(rule: IGeneratedUiComponentRule): void {
  const coreStore = useCoreStore()
 ...
 */
export function addStringIdDecorator(stringId: string, decorator: (stringId: string) => string): void {
  const coreStore = useCoreStore()
