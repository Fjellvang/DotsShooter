...
import {
  ...
  type IGeneratedUiComponentRule,
  type IGeneratedUiFieldType,
  type IGeneratedUiFilterProps,
...
const numberTypes = [
  ...
  'System.Int16',
  'System.UInt16',
  'Metaplay.Core.Math.MetaUInt128',
  'Metaplay.Core.Math.F32',
  'Metaplay.Core.Math.F64',
]

function filterTypeName(typeName: string, vueComponent: any): IGeneratedUiComponentRule {
  return {
    filterFunction: (_props: IGeneratedUiFilterProps, type: IGeneratedUiFieldType): boolean => {
...
const DefaultGeneratedUiViewComponents: IGeneratedUiComponentRule[] = [
  {
    filterFunction: (_props, type): boolean => {
      return (
        type.typeKind === EGeneratedUiTypeKind.ValueCollection &&
        !!type.typeParams &&
  ...
  {
    filterFunction: (_props, type): boolean => {
      return type.typeKind === EGeneratedUiTypeKind.Nullable
    },
    vueComponent: import('./fields/views/GeneratedUiViewNullableField.vue'),
  },
  ...
  filterTypeKind(
    EGeneratedUiTypeKind.ConfigLibraryItem,
    import('./fields/views/GeneratedUiViewConfigLibraryKeyField.vue')
  ),
  {
    filterFunction: (_props, type): boolean => {
      return (
...
const DefaultGeneratedUiFormComponents: IGeneratedUiComponentRule[] = [
  {
    filterFunction: (_props, type): boolean => {
      return type.typeKind === EGeneratedUiTypeKind.Primitive && numberTypes.includes(type.typeName)
    },
  ...
  },
  {
    ...
    vueComponent: import('./fields/forms/GeneratedUiFormNullableField.vue'),
  },
  ...
  filterTypeName(
    'Metaplay.Core.Config.GameConfigBuildSource',
    import('./fields/forms/GeneratedUiFormGameConfigBuildSourceField.vue')
  ),
  filterTypeName(
    'Metaplay.Core.Config.GoogleSheetBuildSource',
    import('./fields/forms/GeneratedUiFormGoogleSheetBuildSourceField.vue')
  ),
  ...
  filterTypeKind(
    EGeneratedUiTypeKind.ConfigLibraryItem,
    import('./fields/forms/GeneratedUiFormConfigLibraryKeyField.vue')
  ),
  {
    filterFunction: (_props, type): boolean => {
