...
import type { LocalizationContent, LocalizationTable, MinimalLocalizationInfo } from '../localizationServerTypes'
 ...
 */
export function getAllLocalizationsSubscriptionOptions(): SubscriptionOptions<MinimalLocalizationInfo[]> {
  return {
    permission: 'api.localization.view',
    pollingPolicy: getPollingPolicyTimer(5000),
 ...
 */
export function getSingleLocalizationSubscriptionOptions(
  localizationId: string
): SubscriptionOptions<LocalizationContent> {
  return {
    permission: 'api.localization.view',
 ...
 * @param localizationId The ID of the localization to fetch.
 */
export function getSingleLocalizationTableSubscriptionOptions(
  localizationId: string
): SubscriptionOptions<LocalizationTable> {
  return {
    permission: 'api.localization.view',
    pollingPolicy: getPollingPolicyOnceOnly(),
