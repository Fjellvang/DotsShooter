...
div
  ...
  div(class="tw-relative")
    textarea(
      ...
      :class="['tw-w-full tw-rounded-md tw-shadow-sm tw-border-0 tw-py-1.5 tw-h-20 tw-min-h-20 tw-text-neutral-900 tw-ring-1 tw-ring-inset placeholder:tw-text-neutral-400 focus:tw-ring-2 focus:tw-ring-inset focus:tw-ring-blue-600 sm:tw-text-sm sm:tw-leading-6 disabled:tw-cursor-not-allowed disabled:tw-bg-neutral-50 disabled:tw-text-neutral-500 disabled:ring-neutral-200', variantClasses]"
    ...
    //- Icon.
    div(class="tw-items-top tw-pointer-events-none tw-absolute tw-inset-y-0 tw-right-0 tw-flex tw-pr-3 tw-pt-2")
      ...
      <svg v-else-if="variant === 'loading'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="tw-w-5 tw-h-5 tw-fill-blue-500 tw-animate-spin" aria-hidden="true">
...
const onInput = lodashDebounce((event: Event) => {
