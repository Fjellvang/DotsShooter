 ...
 */
function getElementStyle(element: HTMLElement): HTMLStyle {
  return {
 ...
 */
function prepareElement(element: HTMLElement, initialStyle: HTMLStyle): string {
 ...
 */
function getEnterKeyframes(height: string, initialStyle: HTMLStyle): Keyframe[] {
  return [
    {
      height: closed,
      opacity: 0,
