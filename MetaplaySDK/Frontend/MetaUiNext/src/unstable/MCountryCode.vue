...
<template lang="pug">
span {{ isoCodeToCountryName(props.isoCode) }} {{ isoCodeToCountryFlag(props.isoCode) }}
</template>
 ...
 */
function isoCodeToCountryName(isoCode: string): string {
 ...
 */
function isoCodeToCountryFlag(isoCode: string): string {
