 ...
 * @example TBD
 */
export function getCacheRetentionPolicyTimed(timeoutInMs: number): CacheRetentionPolicyTimed {
 ...
 */
export function getCacheRetentionPolicyKeepForever(): CacheRetentionPolicyKeepForever {
 ...
 */
export function getCacheRetentionPolicyDeleteImmediately(): CacheRetentionPolicyDeleteImmediately {
...
export abstract class CacheRetentionPolicy {
   ...
   */
  register(invalidateCallback: InvalidateCallback): void {
