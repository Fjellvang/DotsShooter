...
namespace Metaplay.Core.League
{
    ...
    {
        public override ClientSlot ClientSlot { get;}
        ...
        public LeagueClient(ClientSlot clientSlot) : base()
        {
        ...
        protected override DivisionClientContext<TDivisionModel> CreateActiveModelContext(EntityInitialState state, ISharedGameConfig gameConfig)
        {
            ...
            DivisionEntityClientData clientData = (DivisionEntityClientData)state.ClientData;

            model.RefreshScores();
            DivisionClientContext<TDivisionModel> newContext = new DivisionClientContext<TDivisionModel>(DefaultInitArgs(model, state), clientData.ParticipantId, ClientSlot);
            newContext.SetClientListeners(_applyClientListeners);
