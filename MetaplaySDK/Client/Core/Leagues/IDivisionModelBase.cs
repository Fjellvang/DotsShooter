...
namespace Metaplay.Core.League
{
    ...
    {
        MetaDictionary<int, EntityId> ParticipantIndexToEntityId { get; }
    ...
    public interface IDivisionModel : IMultiplayerModel
    {
        ...
        /// <summary>
        /// The desired number of participants for this division set during the creation of the division.
        /// The actual number of participants may be different.
        /// </summary>
