...
namespace Metaplay.Core.League.Messages
{
    ...
    /// <summary>
    /// Implementation for <see cref="EntityClientData"/> for division. This type may be extended
    /// by inheriting it.
    /// </summary>
    ...
    public class DivisionEntityClientData : EntityClientData
    {
        ...
        public DivisionEntityClientData(ClientSlot clientSlot, EntityId participantId) : base(clientSlot)
        {
