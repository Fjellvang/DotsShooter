...
namespace Metaplay.Core.League
{
    ...
    {
        public ClientSlot LeagueSlot         { get; private set; }
        public EntityId   HistoricDivisionId { get; private set; }

        public PlayerClaimHistoricalPlayerDivisionRewards(ClientSlot leagueSlot, EntityId historicDivisionId)
        {
            LeagueSlot         = leagueSlot;
        ...
        {
            if (!player.PlayerSubClientStates.TryGetValue(LeagueSlot, out PlayerSubClientStateBase subClientState))
    ...
    public class PlayerSetCurrentDivision : PlayerUnsynchronizedServerActionCore<IPlayerModelBase>
    {
        ...
        public PlayerSetCurrentDivision(ClientSlot leagueSlot, EntityId newCurrentDivision, int participantIndex)
        {
            LeagueSlot         = leagueSlot;
    ...
    public class PlayerAddHistoricalDivisionEntry : PlayerSynchronizedServerActionCore<IPlayerModelBase>
    {
        ...
        public PlayerAddHistoricalDivisionEntry(ClientSlot leagueSlot, IDivisionHistoryEntry newHistoryEntry, bool removeCurrentDivision)
        {
            LeagueSlot            = leagueSlot;
