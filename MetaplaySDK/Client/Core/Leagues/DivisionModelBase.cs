...
namespace Metaplay.Core.League
{
        ...
        where TDivisionScore : IDivisionScore
    {
        ...
        [MetaMember(309)] public MetaDictionary<int, TParticipantState> Participants       { get; set; } = new MetaDictionary<int, TParticipantState>();
        ...
        [MetaMember(312)] public int DesiredParticipantCount { get; set; }

        [MetaMember(310), ServerOnly] public IDivisionServerModel ServerModel { get; set; }
        [Obsolete("Use Participants instead.")]
        [MetaMember(304)] public MetaDictionary<EntityId, TParticipantState> LegacyParticipants { get; set; }
