...
namespace Metaplay.Core.League
{
        ...
        where TDivisionModel : class, IDivisionModel, IMultiplayerModel<TDivisionModel>
    {
        ...
        public int GetParticipantIndex()
        {
            ...
            if (!playerModel.PlayerSubClientStates.TryGetValue(_clientSlot, out PlayerSubClientStateBase playerDivisionState))
        ...
        public DivisionClientContext(ClientMultiplayerEntityContextInitArgs initArgs, EntityId participantId, ClientSlot clientSlot)
            : base(initArgs)
        {
