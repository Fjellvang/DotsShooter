...
namespace Metaplay.Core.Player
{
    ...
    public interface IPlayerModelClientListenerCore
    {
        ...
        void GotLiveOpsEventUpdate          (PlayerLiveOpsEventModel model) { }
    }
    ...
    public static class PlayerModelConstants
    {
        ...
        public const int    PlayerSearchTableVersion                = 2;        // Version of the data layout in the PlayerNameSearch table
    }
    ...
    public class PlayerExperimentsState
    {
        ...
        /// </summary>
        [MetaMember(1)] public MetaDictionary<PlayerExperimentId, ExperimentAssignment> ExperimentGroupAssignment = new MetaDictionary<PlayerExperimentId, ExperimentAssignment>();
    }
    ...
    public interface IPlayerModelBase : IModel<IPlayerModelBase>, IMetaIntegrationConstructible<IPlayerModelBase>
    {
        ...
        long                                                    CurrentTick                 { get; }   // Current tick, since TimeAtFirstTick. Advanced at rate of TicksPerSecond.
        ...
        MetaDictionary<string, InAppPurchaseEvent>                       PendingInAppPurchases           { get; }
        MetaDictionary<InAppProductId, PendingDynamicPurchaseContent>    PendingDynamicPurchaseContents  { get; }
        MetaDictionary<InAppProductId, PendingNonDynamicPurchaseContext> PendingNonDynamicPurchaseContexts { get; }
        ...
        MetaDictionary<string, PlayerDeviceEntry>            DeviceHistory               { get; }
        MetaDictionary<AuthenticationKey, PlayerAuthEntryBase> AttachedAuthMethods       { get; }
        ...
        /// <summary>
        /// Admin-controlled override behaviour for the <see cref="EntityDebugConfig"/> used in player sessions. This is
        /// mainly useful in production for debugging error cases related to a given player.
        /// </summary>
        ...
        MetaDictionary<ClientSlot, PlayerSubClientStateBase> PlayerSubClientStates       { get; }
        ...
        /// </summary>
        void DebugForceSetModelTime(MetaTime timeAtFirstTick, long currentTick);
    ...
    public interface IPlayerGuildState
    {
        ...
        /// </summary>
        MetaDictionary<int, GuildMemberGuildOpLogEntry>      PendingGuildOps             { get; set; }
    ...
    public class PlayerGuildStateCore : IPlayerGuildState
    {
        ...
        public MetaDictionary<int, GuildMemberGuildOpLogEntry>                   PendingGuildOps             { get; set; }
