...
namespace Metaplay.Core.Player
{
    ...
    public class PlayerEventLogEntry : EntityEventLogEntry<PlayerEventBase, PlayerEventDeserializationFailureSubstitute>
    {
        ...
        public PlayerEventLogEntry(BaseParams baseParams, MetaTime modelTime, int payloadSchemaVersion, PlayerEventBase payload, AnalyticsContextBase context, MetaDictionary<int, string> labelsAsInts)
            : base(baseParams, modelTime, payloadSchemaVersion, payload, context, labelsAsInts)
        {
        }
    }
