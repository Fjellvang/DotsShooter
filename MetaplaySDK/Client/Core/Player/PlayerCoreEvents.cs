...
namespace Metaplay.Core.Player
{
    ...
    {
        [MetaMember(1)] public AbstractTypeDeserializationFailureInfo<AnalyticsEventBase> FailureInfo { get; private set; }

        public override string EventDescription => FailureInfo?.Description ?? "Failure info not initialized.";

        public void Initialize(MetaMemberDeserializationFailureParams failureParams)
        {
            FailureInfo = new AbstractTypeDeserializationFailureInfo<AnalyticsEventBase>(failureParams);
        }
    }
    ...
    [AnalyticsEvent(AnalyticsEventCodesCore.PlayerActorCrashed, displayName: "Crashed", docString: AnalyticsEventDocsCore.PlayerActorCrashed)]
    public class PlayerEventActorCrashed : PlayerEventBase
    {
        [MetaMember(1)] public string ErrorType             { get; private set; }
        [MetaMember(2)] public string ErrorMessage          { get; private set; }
        [MetaMember(3)] public string StackTrace            { get; private set; }
        [MetaMember(4)] public string IncidentId            { get; private set; }
        [MetaMember(5)] public string IncidentFingerprint   { get; private set; }

        public override string EventDescription => $"PlayerActor crashed with error: {ErrorType}: {ErrorMessage}";
    ...
    [AnalyticsEvent(AnalyticsEventCodesCore.PlayerLiveOpsEventAdded, displayName: "Joined LiveOps Event", docString: AnalyticsEventDocsCore.PlayerLiveOpsEventAdded)]
    public class PlayerEventLiveOpsEventAdded : PlayerEventBase
    {
        ...
        [MetaMember(3)] public int EditVersion { get; private set; }
        [MetaMember(4)] public MetaDuration UtcOffset { get; private set; }
        [MetaMember(5)] public MetaScheduleTimeMode TimeMode { get; private set; }
        [MetaMember(6)] public MetaTime? StartTime { get; private set; }
        [MetaMember(7)] public MetaTime? EndTime { get; private set; }
        [FirebaseAnalyticsIgnore] // unsupported aggregate type
        [MetaMember(8)] public List<string> FastForwardedPhases { get; private set; }
        [MetaMember(9)] public string Phase { get; private set; }

        public override string EventDescription => $"The player joined event '{DisplayName}'";
        ...
        public PlayerEventLiveOpsEventAdded(MetaGuid eventId, string displayName, int editVersion, MetaDuration utcOffset, MetaScheduleTimeMode timeMode, LiveOpsEventScheduleInfo scheduleForPlayerMaybe, List<LiveOpsEventPhase> fastForwardedPhases, LiveOpsEventPhase phase)
        {
            ...
            UtcOffset = utcOffset;
            TimeMode = timeMode;
            StartTime = scheduleForPlayerMaybe?.GetEnabledStartTime();
            EndTime = scheduleForPlayerMaybe?.GetEnabledEndTime();
            FastForwardedPhases = fastForwardedPhases?.Select(p => p?.ToString()).ToList();
            Phase = phase?.ToString();
        }
    }

    [AnalyticsEvent(AnalyticsEventCodesCore.PlayerLiveOpsEventPhaseChanged, displayName: "LiveOps Event Phase Advanced", docString: AnalyticsEventDocsCore.PlayerLiveOpsEventPhaseChanged)]
    public class PlayerEventLiveOpsEventPhaseChanged : PlayerEventBase
    {
        [MetaMember(1)] public MetaGuid EventId { get; private set; }
        [MetaMember(2)] public string DisplayName { get; private set; }
        [FirebaseAnalyticsIgnore] // unsupported aggregate type
        [MetaMember(3)] public List<string> FastForwardedPhases { get; private set; }
        [MetaMember(4)] public string Phase { get; private set; }

        public override string EventDescription => FastForwardedPhases.Count == 0
                                                   ? $"Event '{DisplayName}' advanced to phase {Phase}"
                                                   : $"Event '{DisplayName}' advanced to phase {Phase} (fast-forwarding over phases {string.Join(", ", FastForwardedPhases)})";
    ...
    [AnalyticsEvent(AnalyticsEventCodesCore.PlayerLiveOpsEventAudienceMembershipChanged, displayName: "LiveOps Event Audience Membership Changed", docString: AnalyticsEventDocsCore.PlayerLiveOpsEventAudienceMembershipChanged)]
    public class PlayerEventLiveOpsEventAudienceMembershipChanged : PlayerEventBase
    {
        [MetaMember(1)] public MetaGuid EventId { get; private set; }
        [MetaMember(2)] public string DisplayName { get; private set; }
        [MetaMember(3)] public bool PlayerIsInTargetAudience { get; private set; }

        public override string EventDescription => PlayerIsInTargetAudience
                                                   ? $"The player re-entered the target audience again of event '{DisplayName}'"
                                                   : $"The player left the target audience of event '{DisplayName}'";
    ...
    [AnalyticsEvent(AnalyticsEventCodesCore.PlayerLiveOpsEventParamsChanged, displayName: "LiveOps Event Parameters Changed", docString: AnalyticsEventDocsCore.PlayerLiveOpsEventParamsChanged)]
    public class PlayerEventLiveOpsEventParamsChanged : PlayerEventBase
    {
        ...
        public override string EventDescription => $"Parameters of event '{DisplayName}' were changed via the LiveOps Dashboard";
