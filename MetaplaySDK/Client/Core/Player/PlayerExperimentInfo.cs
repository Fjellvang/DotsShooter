...
namespace Metaplay.Core.Player
{
    ...
    public class PlayerExperimentInfo : IGameConfigData<PlayerExperimentId>, IGameConfigPostLoad
    {
        ...
        void IGameConfigPostLoad.PostLoad()
        {
            ...
            if (isSourceConfig)
            {
                ...
                Variants =
                    ...
                    .ToMetaDictionary(variant => variant.Id);
        ...
        [MetaMember(6)] public MetaDictionary<ExperimentVariantId, Variant>     Variants                    { get; private set; }
        ...
        internal PlayerExperimentInfo(PlayerExperimentId experimentId, List<Variant> variants)
        {
            ExperimentId = experimentId;
            Variants     = variants.ToMetaDictionary(x => x.Id, x => x);
        }
