...
namespace Metaplay.Core.Analytics
{
    public static class AnalyticsEventDocsCore
    {
        ...
        // Player events
        public const string PlayerEventDeserializationFailureSubstitute = "This is a substitute event that is shown if the original serialized event could not be deserialized. This can happen if event data format is changed in an incompatible way.";
        ...
        public const string PlayerActorCrashed                          = "The PlayerActor has crashed.";

        // Guild events
        public const string GuildEventDeserializationFailureSubstitute  = "This is a substitute event that is shown if the original serialized event could not be deserialized. This can happen if event data format is changed in an incompatible way.";
        ...
        // LiveOps Event events
        public const string PlayerLiveOpsEventAdded                         = "The player joined a LiveOps Event. It is possible to join an event while it's already underway.";
        public const string PlayerLiveOpsEventPhaseChanged                  = "A LiveOps Event has advanced to a new phase (preview, active, review, ...). An event with player-local scheduling can be in different phases for different players.";
        public const string PlayerLiveOpsEventAudienceMembershipChanged     = "A player entered or left the segmentation-based target audience of a LiveOps Event while the event was already active. Note that leaving the target audience does not automatically disable the event; the audience membership changes are simply communicated to game code.";
        public const string PlayerLiveOpsEventParamsChanged                 = "The parameters of a LiveOps Event were changed via the LiveOps Dashboard.";
    }
}
