...
namespace Metaplay.Core.Analytics
{
    public static class AnalyticsEventCodesCore
    {
        ...
        public const int    PlayerActorCrashed                          = 1019;
        ...
        public const int PlayerLiveOpsEventAdded                        = 1400;
        public const int PlayerLiveOpsEventPhaseChanged                 = 1401;
        public const int PlayerLiveOpsEventAudienceMembershipChanged    = 1402;
        public const int PlayerLiveOpsEventParamsChanged                = 1403;
    }
