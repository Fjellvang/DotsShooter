...
namespace Metaplay.Core.Network
{
    ...
    public interface ISessionCredentialService
    {
        ...
        /// <summary>
        /// Called when the connection is closed, i.e. the connection transitions to an Error state (or NoConnection state).
        /// This can be used to release any resources acquired in <see cref="GetCurrentLoginMethodAsync"/>.
        /// </summary>
        /// <remarks> Called on Unity thread on Unity client. </remarks>
