...
namespace Metaplay.Core.Network
{
    ...
    public static class WireProtocol
    {
        ...
        /// <summary>
        /// The common, generic game magic.
        /// <para>
        /// This value as the handshake magic means the validation shouldn't be done based
        /// on this magic value but instead with a project-name check in handshake.
        /// </para>
        /// </summary>
        public const string CommonGameMagic                     = "MNPx";
        ...
        public static ProtocolStatus ParseProtocolHeader(byte[] buffer, int offset, string expectedGameMagic)
        {
            ...
            bool isValidCustomMagic = buffer[offset+0] == expectedGameMagic[0] && buffer[offset+1] == expectedGameMagic[1] && buffer[offset+2] == expectedGameMagic[2] && buffer[offset+3] == expectedGameMagic[3];
            bool isValidCommonMagic = buffer[offset+0] == CommonGameMagic[0] && buffer[offset+1] == CommonGameMagic[1] && buffer[offset+2] == CommonGameMagic[2] && buffer[offset+3] == CommonGameMagic[3];
            if (!isValidCustomMagic && !isValidCommonMagic)
