...
namespace Metaplay.Core.Activables
{
        ...
        where TInfo : IMetaActivableInfo<TId>
    {
        ...
        /// </remarks>
        [MetaMember(ActivableSetUtil.ActivableStatesMemberTagId)] protected MetaDictionary<TId, TActivableState> _activableStates = new MetaDictionary<TId, TActivableState>();
        ...
        /// </remarks>
        [MetaMember(ActivableSetUtil.ErroneousActivableStatesMemberTagId)] protected MetaDictionary<TId, TActivableState> _erroneousActivableStates = new MetaDictionary<TId, TActivableState>();
    ...
    {
        [MetaMember(ActivableSetUtil.ActivableStatesMemberTagId)]           public MetaDictionary<TId, TActivableState> ActivableStates          { get; set; }
        [MetaMember(ActivableSetUtil.ErroneousActivableStatesMemberTagId)]  public MetaDictionary<TId, TActivableState> ErroneousActivableStates { get; set; }
    }
}
