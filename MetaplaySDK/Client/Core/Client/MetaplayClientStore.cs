...
namespace Metaplay.Core.Client
{
    public class MetaplayClientStore : IDisposable
    {
        ...
        readonly MetaDictionary<ClientSlot, IMetaplaySubClient>  _clients = new MetaDictionary<ClientSlot, IMetaplaySubClient>();
        ...
        {
            // Update is obsolete to avoid anyone else calling it.
            #pragma warning disable CS0618 // Type or member is obsolete
            _playerContextGetter()?.EarlyUpdate();
        ...
        public void UpdateLogic(MetaTime time)
        {
            // Update is obsolete to avoid anyone else calling it.
            #pragma warning disable CS0618 // Type or member is obsolete
            _playerContextGetter()?.Update(time);
            #pragma warning restore CS0618 // Type or member is obsolete
    ...
    public interface IEntityClientContext
    {
        ...
        /// <summary>
        /// Called before <see cref="Update"/> is called for any entity client, or entity client context.
        /// </summary>
        void EarlyUpdate();
    ...
    public interface IMetaplaySubClientServices
    {
        ...
        TransportQosMonitor TransportQosMonitor { get; }

        /// <summary>
        /// Fetches optionally specialized GameConfig for the player.
        /// </summary>
        Task<ISharedGameConfig> GetConfigAsync(SessionProtocol.InitialPlayerState playerState);

        /// <summary>
        /// Fetches optionally specialized GameConfig for the entity.
        /// </summary>
        Task<ISharedGameConfig> GetConfigAsync(EntitySerializedState entityState);
