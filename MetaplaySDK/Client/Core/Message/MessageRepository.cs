...
namespace Metaplay.Core.Message
{
    ...
    {
        public static MetaMessageRepository Instance => MetaplayServices.Get<MetaMessageRepository>();
        ...
        {
            // Iterate all registered (and enabled) MetaMessages.
            foreach (Type msgType in MetaSerializerTypeRegistry.GetConcreteDerivedTypes<MetaMessage>())
            {
        ...
        static void CheckMembersRecursive(MetaMessageSpec msgSpec, Type type, HashSet<Type> visited)
        {
            ...
            {
                // Only concrete objects have members
