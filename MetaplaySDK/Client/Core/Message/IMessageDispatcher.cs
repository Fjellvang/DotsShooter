...
namespace Metaplay.Core.Message
{
    ...
    public interface IMessageDispatcher
    {
        ...
        /// <summary>
        /// <inheritdoc cref="AddListener{T}(MessageHandler{T})"/>
        /// </summary>
        /// <param name="label">
        /// Mark listener with a label. Label can be used in <see cref="RemoveListenersWithLabel(object)"/>. Null means no label is set.
        /// </param>
        void AddListener<T>(MessageHandler<T> handlerFunc, object label) where T : MetaMessage;
        ...
        /// <summary>
        /// Removes all listeners that have <paramref name="label"/> Equal to the label set in <see cref="AddListener{T}(MessageHandler{T}, object)"/>.
        /// </summary>
        void RemoveListenersWithLabel(object label);
