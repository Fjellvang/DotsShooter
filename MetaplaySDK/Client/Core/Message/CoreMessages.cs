...
namespace Metaplay.Core.Message
{
    ...
    public class UpdateLocalizationVersions : MetaMessage
    {
        ...
        public UpdateLocalizationVersions(MetaDictionary<LanguageId, ContentHash> localizationVersions)
        {
    ...
    public abstract class SessionForceTerminateReason
    {
        ...
        /// <summary> Session was terminated due to a new version of the game config being published. </summary>
        [MetaSerializableDerived(11)] public class GameConfigUpdated        : SessionForceTerminateReason { }
        /// <summary> Session was terminated due to the player model being force updated to a higher logic version, likely as a result of an incompatible server action</summary>
        [MetaSerializableDerived(12)] public class LogicVersionUpdated      : SessionForceTerminateReason { }
    }
