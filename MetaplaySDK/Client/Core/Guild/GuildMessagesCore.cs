...
namespace Metaplay.Core.Guild.Messages.Core
{
    ...
    public class GuildTimelineUpdateMessage : MetaMessage
    {
        ...
        [MetaMember(3)] public long                             StartTick       { get; private set; } // Tick of the first Operation
        ...
        public GuildTimelineUpdateMessage(MetaSerialized<List<Operation>> operations, long startTick, int startOperation, uint finalChecksum, int guildChannelId)
        {
