...
namespace Metaplay.Core.Guild
{
    ...
    public class GuildEventLogEntry : EntityEventLogEntry<GuildEventBase, GuildEventDeserializationFailureSubstitute>
    {
        ...
        public GuildEventLogEntry(BaseParams baseParams, MetaTime modelTime, int payloadSchemaVersion, GuildEventBase payload, AnalyticsContextBase context, MetaDictionary<int, string> labelsAsInts)
