...
namespace Metaplay.Core.Guild.Actions
{
    ...
    public class GuildMemberEditRole : GuildClientActionBase
    {
        ...
        GuildMemberEditRole() { }
        public GuildMemberEditRole(EntityId targetPlayerId, GuildMemberRole targetNewRole, MetaDictionary<EntityId, GuildMemberRole> expectedChanges)
        {
            TargetPlayerId = targetPlayerId;
        ...
        public override MetaActionResult InvokeExecute(IGuildModelBase guild, bool commit)
        {
            ...
            MetaDictionary<EntityId, GuildMemberRole> actualChanges = guild.ComputeRoleChangesForRoleEvent(GuildMemberRoleEvent.MemberEdit, TargetPlayerId, TargetNewRole);
