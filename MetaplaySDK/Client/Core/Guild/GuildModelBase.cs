...
namespace Metaplay.Core.Guild
{
    ...
    /// <summary>
    /// Constants related to GuildModels
    /// </summary>
    public static class GuildModelConstants
    {
        public const int GuildSearchTableVersion = 2; // Version of the data layout of the GuildNameSearches table
    }
    ...
    public class GuildPendingMemberKickState
    {
        ...
        [MetaMember(3)] public MetaDictionary<int, GuildMemberPlayerOpLogEntry>  PendingPlayerOps;
        [MetaMember(4)] public int                                                  MemberInstanceId;

        public GuildPendingMemberKickState() { }
        public GuildPendingMemberKickState(MetaTime issuedAt, IGuildMemberKickReason reasonOrNull, MetaDictionary<int, GuildMemberPlayerOpLogEntry> pendingPlayerOps, int memberInstanceId)
        {
            IssuedAt = issuedAt;
    ...
    public interface IGuildModelBase : IMultiplayerModel<IGuildModelBase>
    {
        ...
        MetaDictionary<EntityId, GuildPendingMemberKickState>    PendingKicks            { get; set; }
        ...
        /// </para>
        /// </summary>
        MetaDictionary<EntityId, GuildMemberRole>    ComputeRoleChangesForRoleEvent    (GuildMemberRoleEvent roleEvent, EntityId subjectMemberId, GuildMemberRole subjectRole);
    ...
    public static class IGuildModelBaseExtensions
    {
        ...
        {
            MetaDictionary<EntityId, GuildMemberRole> newRoles = guild.ComputeRoleChangesForRoleEvent(GuildMemberRoleEvent.MemberAdd, playerId, default);
        ...
        public static void RemoveMemberAndUpdateRoles(this IGuildModelBase guild, EntityId playerId)
        {
            ...
            // Apply role changes to others
            MetaDictionary<EntityId, GuildMemberRole> newRoles = guild.ComputeRoleChangesForRoleEvent(GuildMemberRoleEvent.MemberRemove, playerId, removedMember.Role);
            guild.ApplyMemberRoleChanges(newRoles);
        }
        ...
        /// </summary>
        public static void ApplyMemberRoleChanges(this IGuildModelBase guild, MetaDictionary<EntityId, GuildMemberRole> newRoles)
        {
    ...
    public abstract class GuildMemberBase
    {
        ...
        public MetaDictionary<int, GuildMemberPlayerOpLogEntry>  PendingPlayerOps;
        ...
        public MetaDictionary<int, GuildInviteState>             Invites = new MetaDictionary<int, GuildInviteState>();
        ...
        where TGuildMember : GuildMemberBase
    {
        ...
        /// </summary>
        [MetaMember(2), Transient] public long                                      CurrentTick             { get; private set; }
        ...
        [MetaMember(8)] public MetaDictionary<EntityId, TGuildMember>            Members                 { get; set; } = new MetaDictionary<EntityId, TGuildMember>();

        [MetaMember(9), ServerOnly]
        public MetaDictionary<EntityId, GuildPendingMemberKickState>             PendingKicks            { get; set; } = new MetaDictionary<EntityId, GuildPendingMemberKickState>();
        ...
        [MetaMember(14), ServerOnly] public int                                     SearchVersion           { get; set; } = 0; // Version of the data layout of the GuildNameSearches table that this guild has been saved with
        ...
        public virtual async Task RemapEntityIdsAsync(IModelEntityIdRemapper remapper)
        {
            ...
            MetaDictionary<EntityId, TGuildMember> newMembers = new MetaDictionary<EntityId, TGuildMember>();
            foreach ((EntityId playerId, TGuildMember member) in Members)
                newMembers[await remapper.RemapEntityIdAsync(playerId)] = member;
            Members = newMembers;

            MetaDictionary<EntityId, GuildPendingMemberKickState> newKicks = new MetaDictionary<EntityId, GuildPendingMemberKickState>();
        ...
        public abstract MetaDictionary<EntityId, GuildMemberRole> ComputeRoleChangesForRoleEvent(GuildMemberRoleEvent roleEvent, EntityId subjectMemberId, GuildMemberRole subjectRole);
    ...
    {
        [MetaMember(1)]
        public MetaDictionary<int, GuildInviteState> Invites { get; private set; }
