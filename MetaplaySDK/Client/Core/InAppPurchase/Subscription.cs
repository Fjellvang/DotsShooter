...
namespace Metaplay.Core.InAppPurchase
{
    ...
    {
        [MetaMember(1)] public MetaDictionary<InAppProductId, SubscriptionModel> Subscriptions { get; private set; } = new MetaDictionary<InAppProductId, SubscriptionModel>();
    ...
    public class SubscriptionModel
    {
        ...
        /// </remarks>
        [MetaMember(1)] public MetaDictionary<string, SubscriptionInstanceModel> SubscriptionInstances { get; private set; } = new MetaDictionary<string, SubscriptionInstanceModel>();
