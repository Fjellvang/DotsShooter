...
namespace Metaplay.Core.Debugging
{
    ...
    /// <summary>
    /// Client requests server for a incident upload url.
    /// </summary>
    [MetaMessage(MessageCodesCore.PlayerIncidentUploadUrlRequest, MessageDirection.ClientToServer), MessageRoutingRuleOwnedPlayer]
    public class PlayerIncidentUploadUrlRequest : MetaMessage
    {
        ...
        public PlayerIncidentUploadUrlRequest(int queryId, string incidentId, int contentLength)
        {
            QueryId = queryId;
            IncidentId = incidentId;
    ...
    /// Client requests server for a incident upload url.
    /// </summary>
    [MetaMessage(MessageCodesCore.PlayerIncidentUploadUrlResponse, MessageDirection.ServerToClient)]
    public class PlayerIncidentUploadUrlResponse : MetaMessage
    {
        public int      QueryId         { get; private set; }
        public bool     AlreadyUploaded { get; private set; }

        /// <summary>
        /// null if server refuses.
        /// </summary>
        [Sensitive]
        public string   Url             { get; private set; }

        PlayerIncidentUploadUrlResponse() { }
        public PlayerIncidentUploadUrlResponse(int queryId, bool alreadyUploaded, string url)
        {
            QueryId = queryId;
    ...
    /// <summary>
    /// Client informs server a new incident report has been uploaded to the URL server supplied.
    /// </summary>
    [MetaMessage(MessageCodesCore.PlayerUploadedIncidentReportToUrl, MessageDirection.ClientToServer), MessageRoutingRuleOwnedPlayer]
    public class PlayerUploadedIncidentReportToUrl : MetaMessage
    {
    }
}
