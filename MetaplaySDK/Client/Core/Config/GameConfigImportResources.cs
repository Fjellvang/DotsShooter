...
namespace Metaplay.Core.Config
{
    ...
    /// for the purpose of being available in user-defined overrides of the <see cref="GameConfigBase.PopulateCustomConfigData"/>
    /// method, where they can be used for certain kinds of deduplication of custom-typed config members.
    /// </para>
    /// </summary>
    public class GameConfigImportResources
    {
        ...
        public readonly MetaDictionary<ExperimentVariantPair, GameConfigPatchEnvelope> Patches;
        ...
        /// </summary>
        public readonly MetaDictionary<string, IGameConfigLibraryDeduplicationStorage> LibraryDeduplicationStorages;
        ...
        /// See comment on <see cref="GameConfigImportResources"/>.
        /// </summary>
        public MetaDictionary<ExperimentVariantPair, IGameConfig> DeduplicationSingleVariantSpecializations;

        public int TotalSinglePatchDirectDuplication { get; private set; } = 0;
        public int TotalSinglePatchIndirectDuplication { get; private set; } = 0;
        ...
        GameConfigImportResources(
            ...
            MetaDictionary<ExperimentVariantPair, GameConfigPatchEnvelope> patches,
            GameConfigRuntimeStorageMode configRuntimeStorageMode,
            MetaDictionary<string, IGameConfigLibraryDeduplicationStorage> libraryDeduplicationStorages,
            GameConfigTopLevelDeduplicationStorage topLevelDeduplicationStorage,
            IGameConfig deduplicationBaseline,
            MetaDictionary<ExperimentVariantPair, IGameConfig> deduplicationSingleVariantSpecializations)
        {
            ...
            switch (storageMode)
            {
                case GameConfigRuntimeStorageMode.Deduplicating:
                    importResources = new GameConfigImportResources(
                        ...
                        patches,
                        storageMode,
                        libraryDeduplicationStorages: new MetaDictionary<string, IGameConfigLibraryDeduplicationStorage>(),
                        topLevelDeduplicationStorage: new GameConfigTopLevelDeduplicationStorage(),
                        deduplicationBaseline: null,
                        deduplicationSingleVariantSpecializations: new MetaDictionary<ExperimentVariantPair, IGameConfig>());
                    break;
            ...
            GameConfigRuntimeStorageMode storageMode)
        {
            return Create(
                gameConfigType,
                archive,
                patches: new MetaDictionary<ExperimentVariantPair, GameConfigPatchEnvelope>(),
                storageMode);
        }
        ...
        public void InitializeAllDeduplicationSingleVariantSpecializations(CancellationToken ct = default)
        {
            ...
            if (LibraryDeduplicationStorages != null)
            {
                foreach (IGameConfigLibraryDeduplicationStorage storage in LibraryDeduplicationStorages.Values)
                {
                    TotalSinglePatchDirectDuplication += storage.NumSinglePatchDirectlyDuplicatedItems;
                    TotalSinglePatchIndirectDuplication += storage.NumSinglePatchIndirectlyDuplicatedItems;
                }
            }
        }
    }
