...
namespace Metaplay.Core.Config
{
    ...
    {
        [MetaMember(1)] public MetaDictionary<GameConfigLogLevel, int> BuildMessagesCount          { get; private set; }
        [MetaMember(2)] public MetaDictionary<GameConfigLogLevel, int> ValidationMessagesCount     { get; private set; }
        ...
        GameConfigBuildSummary(
            MetaDictionary<GameConfigLogLevel, int> buildMessagesCount,
            MetaDictionary<GameConfigLogLevel, int> validationMessagesCount,
        ...
        {
            MetaDictionary<GameConfigLogLevel, int> buildLogLogLevelToCountMapping          = new MetaDictionary<GameConfigLogLevel, int>();
            MetaDictionary<GameConfigLogLevel, int> validationResultsLogLevelToCountMapping = new MetaDictionary<GameConfigLogLevel, int>();
    ...
    public class GameConfigBuildReport
    {
        ...
        GameConfigValidationMessage[] MergeValidationMessages(IEnumerable<GameConfigValidationResult> validationResults)
        {
            ...
            MetaDictionary<int, GameConfigValidationMessage> mergedLogs = new MetaDictionary<int, GameConfigValidationMessage>();
