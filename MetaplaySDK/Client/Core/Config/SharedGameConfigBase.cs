...
namespace Metaplay.Core.Config
{
    public class SharedGameConfigBase : GameConfigBase, ISharedGameConfig
    {
        ...
        public MetaDictionary<OfferPlacementId, List<MetaOfferGroupInfoBase>> MetaOfferGroupsPerPlacementInMostImportantFirstOrder { get; private set; }
        public MetaDictionary<MetaOfferId, List<MetaOfferGroupInfoBase>>      MetaOfferContainingGroups                            { get; private set; }
        ...
        void InitializeMetaOfferDerivedData()
        {
            ...
            MetaOfferContainingGroups = new MetaDictionary<MetaOfferId, List<MetaOfferGroupInfoBase>>();
