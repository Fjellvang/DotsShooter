...
namespace Metaplay.Core.Serialization
{
    ...
    public static class DynamicTraversal
    {
        ...
        {
            public static Resources Create(MetaSerializerTypeInfo types)
            {
                TaggedSerializerRoslynGenerator generator = new TaggedSerializerRoslynGenerator(types);
                MetaDictionary<Type, TaggedSerializerRoslynGenerator.ITypeInfo> typeInfos = generator.CreateTypeInfos();
                Dictionary<Type, TaggedSerializerRoslynGenerator.IMembersInfo> membersInfos = generator.CreateMembersInfos().ToDictionary(m => m.Type);
                generator.GetMetaRefContainingTypes(typeInfos.Values, out OrderedSet<Type> metaRefContainingTypes, out OrderedSet<Type> metaRefByMembersContainingTypes);
        ...
        public interface IVisitor
        {
            ...
            void VisitMetaConfigId(Type type, object obj);
        ...
        public abstract class Visitor : IVisitor
        {
            ...
            public virtual void VisitMetaConfigId(Type type, object obj) { }
