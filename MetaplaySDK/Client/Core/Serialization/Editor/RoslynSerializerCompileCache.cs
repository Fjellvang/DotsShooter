    ...
    public static class RoslynSerializerCompileCache
    {
            ...
            MetaSerializerTypeInfo types)
        {
            ...
            using (ProfilerScope.Create("RoslynSerializerCompileCache.GenerateSource"))
            {
                ...
                generatedSource = generator.GenerateSerializerCode(useMemberAccessTrampolines, generateRuntimeTypeInfo);
        ...
        public static Assembly GetOrCompileAssembly(string outputDir, string dllFileName, string errorDir, bool useMemberAccessTrampolines, bool generateRuntimeTypeInfo, MetaSerializerTypeInfo typeInfo)
        {
            EnsureDllUpToDate(
                outputDir,
                dllFileName,
