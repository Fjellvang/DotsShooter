...
namespace Metaplay.Core.Serialization
{
    ...
    public static class MetaRefAnalysisUtil
    {
        ...
        public class AnalysisContext
        {
            ...
            public MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> ItemReverseReferences;
            ...
            public AnalysisContext(
                ...
                MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> itemReverseReferences,
        ...
        {
            MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> reverseReferences = CollectItemReverseReferences(traversalResources, gameConfig);
        ...
        public class AnalysisResult
        {
            ...
            public MetaDictionary<ItemTypeReference, int> TypeLevelReferenceInfluences;

            public AnalysisResult(OrderedSet<ConfigItemId> reachableItems, MetaDictionary<ItemTypeReference, int> typeLevelReferenceInfluences)
            {
        ...
        public static MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> CollectItemReverseReferences(DynamicTraversal.Resources traversalResources, IGameConfig config)
        {
            MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> references = CollectItemReferences(traversalResources, config);
            MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> reverseReferences = ComputeReverseReferences(references);
        ...
        static MetaDictionary<object, List<ItemMetaRefEntry>> CollectMetaRefsWithPaths<TInfo>(DynamicTraversal.Resources traversalResources, IEnumerable<KeyValuePair<object, object>> items)
            where TInfo : class, IGameConfigData, new()
        {
            MetaDictionary<object, List<ItemMetaRefEntry>> itemMetaRefs = new MetaDictionary<object, List<ItemMetaRefEntry>>();
        ...
        static MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> CollectItemReferences(DynamicTraversal.Resources traversalResources, IGameConfig config)
        {
            MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> referencesPerItem = new MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>>();
            ...
            foreach (IGameConfigLibraryEntry library in GetLibraries(config))
            {
                ...
                MetaDictionary<object, List<ItemMetaRefEntry>> itemsMetaRefs = (MetaDictionary<object, List<ItemMetaRefEntry>>)collectMethod.Invoke(null, new object[] { traversalResources, items });
        ...
        static MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> ComputeReverseReferences(MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> references)
        {
            MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>> reverseReferences = new MetaDictionary<ConfigItemId, OrderedSet<(ConfigItemId, string)>>();
        ...
        struct ReachabilityResult<TNode, TEdgeLabel>
        {
            ...
            public MetaDictionary<TEdgeLabel, int> EdgeInfluences;

            public ReachabilityResult(OrderedSet<TNode> reachableNodes, MetaDictionary<TEdgeLabel, int> edgeInfluences)
            {
        ...
        static ReachabilityResult<TNode, TEdgeLabel> ResolveReachability<TNode, TEdgeLabel>(IEnumerable<TNode> startNodes, TryGetNodeNeighborsFunc<TNode, TEdgeLabel> tryGetNodeNeighbors)
        {
            ...
            MetaDictionary<TEdgeLabel, int> edgeInfluences = new MetaDictionary<TEdgeLabel, int>();
