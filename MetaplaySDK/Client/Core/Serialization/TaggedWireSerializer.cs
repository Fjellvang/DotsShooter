    ...
    public static class TaggedWireSerializer
    {
        ...
        public static void ExpectWireType(ref MetaSerializationContext context, IOReader reader, Type type, WireDataType encounteredWireType, WireDataType expectedWireType)
        {
            if (encounteredWireType != expectedWireType)
            {
                ...
                if (context.TypeInfo.TryGetSerializableType(type, out MetaSerializableType typeSpec)
        ...
        public static WireDataType GetWireType(Type type, MetaSerializerTypeRegistry typeRegistry)
        {
            ...
            else if (typeRegistry.TryGetSerializableType(type, out MetaSerializableType typeSpec) && typeSpec.WireType != WireDataType.Invalid)
