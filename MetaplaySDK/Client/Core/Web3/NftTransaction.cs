...
namespace Metaplay.Core.Web3
{
    ...
    public abstract class PlayerNftTransaction
    {
        ...
        /// </param>
        public abstract MetaActionResult Execute(IPlayerModelBase player, MetaDictionary<NftKey, MetaNft> nfts, bool commit, ref ContextBase context);
        /// <summary>
    ...
    {
        public PlayerNftTransaction Transaction;
        public MetaDictionary<NftKey, MetaNft> Nfts;

        PlayerExecuteNftTransaction() { }
        public PlayerExecuteNftTransaction(PlayerNftTransaction transaction, MetaDictionary<NftKey, MetaNft> nfts)
        {
            Transaction = transaction;
            Nfts = nfts;
        }
