...
namespace Metaplay.Core.Web3
{
    ...
    public class PlayerNftSubModel
    {
        ...
        /// </summary>
        [MetaMember(1)] public MetaDictionary<NftKey, MetaNft> OwnedNfts { get; set; } = new MetaDictionary<NftKey, MetaNft>();
    ...
    {
        [MetaMember(1)] public MetaDictionary<NftKey, MetaNft>   Nfts        { get; set; }
