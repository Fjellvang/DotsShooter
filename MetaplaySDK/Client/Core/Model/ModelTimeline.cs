...
namespace Metaplay.Core.Model
{
        ...
        where TOp: ITimelineOp
    {
        ...
        public MetaDictionary<JournalPosition, TStep>    _stagedSteps;
        ...
        MetaDictionary<JournalPosition, Snapshot> _snapshots;
        ...
        public Timeline(JournalChecksumHelper checksumHelper)
        {
            ...
            _stagedSteps = new MetaDictionary<JournalPosition, TStep>();

            _snapshots = new MetaDictionary<JournalPosition, Snapshot>();
        }
