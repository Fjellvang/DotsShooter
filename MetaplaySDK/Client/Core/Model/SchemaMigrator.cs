...
namespace Metaplay.Core.Model
{
    ...
    public class SchemaMigrator
    {
        ...
        public static SchemaMigrator CreateForType(Type migratableType)
        {
            ...
            {
                bool hasRegisterMigrationsFunctionAttribute = methodInfo.HasCustomAttribute<RegisterMigrationsFunctionAttribute>();
                bool hasMigrationFromVersionAttribute = methodInfo.HasCustomAttribute<MigrationFromVersionAttribute>();

                // Early exit if irrelevant method
                if (!hasMigrationFromVersionAttribute && !hasRegisterMigrationsFunctionAttribute)
                    continue;
                ...
                if (hasRegisterMigrationsFunctionAttribute)
                {
