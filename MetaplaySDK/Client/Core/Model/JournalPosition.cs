...
namespace Metaplay.Core.Model
{
    ...
    public struct JournalPosition : IComparable<JournalPosition>, IEquatable<JournalPosition>
    {
        ...
        private JournalPosition(long tick, int operation, int step)
        {
            if (tick < 0)
        ...
        public static JournalPosition FromTickOperationStep(long tick, int operation, int step)
        {
        ...
        /// </para>
        /// </summary>
        public static JournalPosition AfterTick(long tick)
        {
        ...
        /// </summary>
        public static JournalPosition BeforeTick(long tick)
        {
        ...
        /// </para>
        /// </summary>
        public static JournalPosition AfterAction(long tick, int action)
        {
        ...
        /// </summary>
        public static JournalPosition BeforeAction(long tick, int action)
        {
        ...
        public static bool operator ==(JournalPosition v1, JournalPosition v2) { return v1.CompareTo(v2) == 0; }
        public static bool operator !=(JournalPosition v1, JournalPosition v2) { return v1.CompareTo(v2) != 0; }
        public static bool operator <(JournalPosition v1, JournalPosition v2) { return v1.CompareTo(v2) < 0; }
        public static bool operator <=(JournalPosition v1, JournalPosition v2) { return v1.CompareTo(v2) <= 0; }
        public static bool operator >(JournalPosition v1, JournalPosition v2) { return v1.CompareTo(v2) > 0; }
        ...
        public override int GetHashCode() => Util.CombineHashCode(Tick.GetHashCode(), Operation, Step);
        ...
        public int CompareTo(JournalPosition other)
        {
            ...
            c = Operation.CompareTo(other.Operation);
            if (c != 0)
                return c;
