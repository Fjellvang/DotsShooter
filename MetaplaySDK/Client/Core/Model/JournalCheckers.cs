...
namespace Metaplay.Core.Model.JournalCheckers
{
        ...
        where TModel : class, IModel<TModel>
    {
        ...
        protected virtual void BeforeTick(long tick) { }

        /// <summary>
        /// Called just after a Tick() operation is applied.
        /// </summary>
        protected virtual void AfterTick(long tick, MetaActionResult result) { }
        ...
        void ModelJournal<TModel>.Leader.IListener.BeforeTick(long tick)
        {
            InvalidateCachedChecksum();
            if (IsPausedOrDisabled)
                return;
        ...
        void ModelJournal<TModel>.Leader.IListener.AfterTick(long tick, MetaActionResult result, uint checksumAfter, IOBuffer checksumSerializationBuffer)
        {
            InvalidateCachedChecksum();
            if (IsPausedOrDisabled)
                return;
        ...
        void ModelJournal<TModel>.Follower.IListener.BeforeTick(long tick)
        {
            InvalidateCachedChecksum();
            if (IsPausedOrDisabled)
                return;
        ...
        void ModelJournal<TModel>.Follower.IListener.AfterTick(long tick, MetaActionResult result)
        {
            InvalidateCachedChecksum();
            if (IsPausedOrDisabled)
                return;
        ...
        where TModel : class, IModel<TModel>
    {
        ...
        void CheckCloning(IOBuffer checksumSerializationBuffer, string opName)
        {
            ...
            TModel clonedState = (TModel)JournalUtil.Deserialize<IModel>(checksumSerializationBuffer, MetaSerializationFlags.IncludeAll, StagedModel.GetDataResolver(), StagedModel.LogicVersion);
        ...
        protected override void AfterTick(long tick, MetaActionResult result)
        {
        ...
        where TModel : class, IModel<TModel>
    {
        ...
        protected override void BeforeTick(long tick)
        {
