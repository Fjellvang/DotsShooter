...
namespace Metaplay.Core
{
    ...
    public class RandomPCG : IEquatable<RandomPCG>
    {
        ...
        /// <summary>
        /// Get a random non-negative 64-bit integer in range [0, maxExclusive[.
        /// </summary>
        /// <param name="maxExclusive">Exclusive maximum value, must be positive</param>
        /// <returns>Random 64-bit integer in range [0, maxExclusive[</returns>
