...
namespace Metaplay.Core
{
    ...
    public enum AuthenticationPlatform
    {
        ...
        /// <summary>
        /// Your white-label Company Account using CompanyId.
        /// </summary>
        CompanyAccount = 13,
    ...
    /// <summary>
    /// Claim for Steam sign-in.
    /// </summary>
    [MetaSerializableDerived(12)]
    public class SocialAuthenticationClaimSteam : SocialAuthenticationClaimBase
    {
        public override AuthenticationPlatform Platform => AuthenticationPlatform.Steam;

        [MetaMember(1)] public byte[] Ticket { get; private set; }
    ...
    public class SocialAuthenticationClaimImmutableX : SocialAuthenticationClaimBase
    {
        ...
        public DateTime ChallengeTimestamp => _challengeTimestamp.ToDateTime();
        ...
        // \todo If auth Claims are not persisted anywhere, then this could be changed.
        [MetaMember(4)] MetaTime        _challengeTimestamp;
        ...
        public SocialAuthenticationClaimImmutableX(string claimedImmutableXAccount, string claimedEthereumAccount, EntityId challengePlayerId, DateTime challengeTimestamp, string challengeSignature)
        {
            ...
            _challengeTimestamp = MetaTime.FromDateTime(challengeTimestamp);
    ...
    /// <summary>
    /// Social authentication claim for company account.
    /// </summary>
    [MetaSerializableDerived(10)]
    public class SocialAuthenticationClaimCompanyId : SocialAuthenticationClaimBase
    {
        public override AuthenticationPlatform Platform => AuthenticationPlatform.CompanyAccount;

        [MetaMember(1)] public string AuthToken { get; private set; }
