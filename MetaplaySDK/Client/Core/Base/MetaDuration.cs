...
namespace Metaplay.Core
{
    ...
    {
        public static MetaDuration Zero    => new MetaDuration(0);
        public static MetaDuration Second  => FromSeconds(1);
        public static MetaDuration Minute  => FromMinutes(1);
        public static MetaDuration Hour    => FromHours(1);
        public static MetaDuration Day     => FromDays(1);
    ...
    public static class TimeSpanExtensionsForMetaDuration
    {
        /// <summary>
        /// Equivalent to calling <see cref="MetaDuration.FromTimeSpan"/> with <paramref name="timeSpan"/>.
        /// Provided as an extension method for convenience, especially with nullable <see cref="TimeSpan"/>s.
        /// </summary>
        public static MetaDuration ToMetaDuration(this TimeSpan timeSpan) => MetaDuration.FromTimeSpan(timeSpan);
    }
}
