...
namespace Metaplay.Core
{
    ...
    {
        /// <summary>
        /// Simple method for formatting text to console that works in Unity and in
        /// standalone C# apps (eg, server).
        /// </summary>
        /// <param name="format">Format string for message</param>
        /// <param name="args">Arguments for message</param>
        public static void WriteLine(string format, params object[] args)
        {
            string message = $"{LogTemplateFormatter.ToFlatString(format, args)}";
