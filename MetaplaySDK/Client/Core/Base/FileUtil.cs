...
namespace Metaplay.Core
{
    public static partial class FileUtil
    {
        ...
        ///
        /// <para>
        /// The write is not atomic and if application is interrupted during the write, it may results in no file written, empty file written (truncating old file), a partial write (truncated new file), or a successful complete write.
        /// </para>
        /// </summary>
