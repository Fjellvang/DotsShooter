...
namespace Metaplay.Core
{
    ...
    public class MetaVersionRange
    {
        ...
        [IgnoreDataMember]
        public IEnumerable<int> Enumerate => Enumerable.Range(MinVersion, MaxVersion - MinVersion + 1);

        public bool Contains(int version) => version >= MinVersion && version <= MaxVersion;
