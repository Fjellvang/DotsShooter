...
namespace Metaplay.Core.Json
{
    ...
    public static class JsonSerialization
    {
        public struct Options
        {
            ...
            /// <summary>
            /// Allows including read only properties with the MetaMember attribute even if <see cref="ExcludeReadOnlyProperties"/> is true
            /// </summary>
            public bool                     IncludeReadOnlyMetaMembers;
            public IGameConfigDataResolver  GameConfigDataResolver;
            public bool                     ExcludeGdprExportMembers;
            public bool                     ExcludeEventLogExcludedMembers;
            ...
            public Options(JsonSerializationMode mode, Type traverseGameConfigDataType, bool excludeReadOnlyProperties, IGameConfigDataResolver gameConfigDataResolver,
                bool excludeGdprExportMembers, bool excludeEventLogExcludedMembers, bool includeReadOnlyMetaMembers, TypeNameHandling typeNameHandling, NamingStrategy namingStrategy)
            {
                Mode                            = mode;
                ...
                ExcludeEventLogExcludedMembers  = excludeEventLogExcludedMembers;
                TypeNameHandling                = typeNameHandling;
                NamingStrategy                  = namingStrategy;
                IncludeReadOnlyMetaMembers      = includeReadOnlyMetaMembers;
            }
            ...
            public static readonly Options DefaultOptions = new Options(
                ...
                excludeEventLogExcludedMembers: false,
                includeReadOnlyMetaMembers:     false,
