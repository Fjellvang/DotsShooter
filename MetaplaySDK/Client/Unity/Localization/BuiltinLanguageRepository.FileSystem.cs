...
namespace Metaplay.Unity.Localization
{
    public static partial class BuiltinLanguageRepository
    {
        ...
        static MetaDictionary<LanguageId, ContentHash> s_builtinLanguages;
        ...
        public static partial MetaDictionary<LanguageId, ContentHash> GetBuiltinLanguages()
        {
            if (!MetaplayCore.Options.FeatureFlags.EnableLocalizations)
        ...
        static MetaDictionary<LanguageId, ContentHash> InternalGetBuiltinLanguages()
        {
            MetaDictionary<LanguageId, ContentHash> builtinLanguages = new MetaDictionary<LanguageId, ContentHash>();
        ...
        public static partial LocalizationLanguage GetAppStartLocalization()
        {
            ...
            MetaDictionary<LanguageId, ContentHash> builtinLanguages = GetBuiltinLanguages();
