        ...
        public void Update()
        {
            if (_openEnqueued && !_isConnected)
            {
                ...
                _incomingMessages.Insert(0, new Handshake.ClientHello(
                        buildVersion: MetaplaySDK.BuildVersion.Version,
                        buildNumber: MetaplaySDK.BuildVersion.BuildNumber,
                        clientVersion: MetaplayCore.Options.ClientVersion,
                        fullProtocolHash: MetaSerializerTypeRegistry.Instance.FullProtocolHash,
