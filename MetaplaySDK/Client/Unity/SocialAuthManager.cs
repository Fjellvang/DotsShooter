...
namespace Metaplay.Unity
{
    ...
    public class SocialAuthManager
    {
        ...
        Mode _mode;
        MetaDictionary<AuthenticationPlatform, SocialAuthenticationClaimBase> _bufferedClaims;
        bool _connected;

        internal MetaDictionary<AuthenticationPlatform, SocialAuthenticationClaimBase> BufferedClaims => _bufferedClaims;
        ...
        internal static SocialAuthManager CreateRealManager(IMetaplayClientSocialAuthenticationDelegate clientDelegate, MetaDictionary<AuthenticationPlatform, SocialAuthenticationClaimBase> bufferedClaims)
        {
            SocialAuthManager manager = new SocialAuthManager();
            manager._mode = Mode.Running;
            manager._socialAuthenticationDelegate = clientDelegate;
            manager._bufferedClaims = bufferedClaims ?? new MetaDictionary<AuthenticationPlatform, SocialAuthenticationClaimBase>();
        ...
        internal static SocialAuthManager CreateBufferingManager()
        {
            ...
            manager._bufferedClaims = new MetaDictionary<AuthenticationPlatform, SocialAuthenticationClaimBase>();
            return manager;
        }
        ...
        {
            _bufferedClaims = _bufferedClaims ?? new MetaDictionary<AuthenticationPlatform, SocialAuthenticationClaimBase>();
            _connected = false;
        }
        ...
        void OnSocialAuthenticateResult(SocialAuthenticateResult result)
        {
            ...
            ISharedGameConfig   gameConfig          = ((IPlayerModelBase)MetaplaySDK.SessionContext.PlayerContext.Model).GameConfig;
