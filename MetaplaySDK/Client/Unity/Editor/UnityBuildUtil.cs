...
namespace Metaplay.Unity
{
    public static class UnityBuildUtil
    {
        ...
        public static string ResolveMetaplayClientPath(Action<string> debugLog = null)
        {
            ...
            if (!pathToMetaplay.StartsWith("file:../"))
                throw new InvalidOperationException($"Expecting a relative path to Metaplay SDK (should start with 'file:../'), got '{pathToMetaplay}.' +" +
                    "The Metaplay SDK package must be extracted to a folder within your Unity project and installed as a local package from that location.");
        ...
        /// </summary>
        public static void RunShell(string workingDirectory, string command, MetaDictionary<string, string> environment = null)
        {
        ...
        /// prints the stdout and stderr and throws InvalidOperationException.
        /// </summary>
        public static void RunProcess(string workingDirectory, string executablePath, string[] args, MetaDictionary<string, string> environment = null, string commandDisplayName = null)
        {
        ...
        static void DoRunShell(string workingDirectory, string command, MetaDictionary<string, string> environment = null)
        {
#if UNITY_EDITOR_WIN
