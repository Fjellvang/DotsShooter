    ...
    public class ObjectValueProxy : ValueProxyBase
    {
            ...
            ModelInspectorArgs args)
        {
            ...
            foreach (PropertyInfo propInfo in propertyInfos)
            {
                ...
                if (propInfo.HasCustomAttribute<IgnoreDataMemberAttribute>())
                    continue;
            ...
            foreach (FieldInfo fieldInfo in fieldInfos)
            {
                ...
                if (fieldInfo.HasCustomAttribute<CompilerGeneratedAttribute>())
                    continue;

                // Skip ignored members
                if (fieldInfo.HasCustomAttribute<IgnoreDataMemberAttribute>())
                    continue;
