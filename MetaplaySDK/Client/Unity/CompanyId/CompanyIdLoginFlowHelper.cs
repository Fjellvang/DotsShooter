...
{
    /// <summary>
    /// Describes a failure in CompanyID login attempt.
    /// </summary>
    public class CompanyIdLoginFlowException : Exception
    {
        /// <summary>
        /// Human-readable identifier describing at which phase of the flow the error occurred.
        /// </summary>
        public string Phase;

        public CompanyIdLoginFlowException(string phase, string message) : base(message)
        {
            Phase = phase;
        }

        public CompanyIdLoginFlowException(string phase, string message, Exception innerException) : base(message, innerException)
        {
            Phase = phase;
        }
    }
    ...
    static partial class CompanyIdLoginFlowHelper
    {
        ...
        public static Task<GameLoginAccessToken> LoginAsync(string companyIdBaseUrl, string companyIdEnvironment)
        {
            ...
            #else
            return Task.FromException<GameLoginAccessToken>(new CompanyIdLoginFlowException(phase: "Init", message: "unsupported platform"));
            #endif
        }
    }
}
