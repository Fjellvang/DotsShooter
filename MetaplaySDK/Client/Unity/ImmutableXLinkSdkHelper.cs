...
namespace Metaplay.Unity
{
    ...
    public static class ImmutableXLinkSdkHelper
    {
        ...
        #pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        {
            ...
            MetaplaySDK.SocialAuthentication.StartValidation(new SocialAuthenticationClaimImmutableX(wallet.ImxAddress, wallet.EthAddress, challenge.PlayerId, challenge.Timestamp.UtcDateTime, signature.Signature));
            #else
