...
namespace Metaplay.Unity
{
    ...
    public static class MetaplayConfigManager
    {
        public static void OnSessionStarted()
        {
            ...
            CleanConfigCacheDirectoryOnBackgroundAsync("SharedGameConfig", retainedVersions: new OrderedSet<ContentHash>(MetaplaySDK.Connection.SessionStartResources.GameConfigBaselineVersions));
            CleanConfigCacheDirectoryOnBackgroundAsync("SharedGameConfigPatches", retainedVersions: new OrderedSet<ContentHash>(MetaplaySDK.Connection.SessionStartResources.GameConfigPatchVersions));
        }
