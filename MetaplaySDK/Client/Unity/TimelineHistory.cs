...
namespace Metaplay.Unity
{
    public class TimelineEntry
    {
        ...
        public readonly long                    Tick;                               // Tick number
        ...
        public TimelineEntry(Type modelType, string name, long tick, ModelAction action, SegmentedIOBuffer afterState, int logicVersion, IGameConfigDataResolver resolver)
        {
            ModelType       = modelType;
            Name            = name;
            Tick            = tick;
    ...
    public class TimelineHistory : ITimelineHistory
    {
        ...
        public void AddEntry<TModel>(string name, long tick, ModelAction action, TModel afterState) where TModel : class, IModel
        {
            // If not enabled, skip
            if (!IsEnabled)
                return;
