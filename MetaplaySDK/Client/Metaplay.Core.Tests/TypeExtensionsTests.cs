...
namespace Metaplay.Core.Tests
{
    ...
    public class TypeExtensionsTests
    {
        ...
        [TestCase(typeof(NestingClass.NestedClass), "Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass", TestName = "ToNamespaceQualifiedTypeString(NestingClass.NestedClass)")] // naming bug, see below
        [TestCase(typeof(NestingClass.NestedClass[]), "Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass[]", TestName = "ToNamespaceQualifiedTypeString(NestingClass.NestedClass[])")]
        [TestCase(typeof(NestingClass.NestedClassG<,>), "Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<,>", TestName = "ToNamespaceQualifiedTypeString(NestingClass.NestedClassG<,>)")]
        [TestCase(typeof(NestingClass.NestedClassG<int, float[]>), "Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<System.Int32,System.Single[]>", TestName = "ToNamespaceQualifiedTypeString(NestingClass.NestedClassG<int, float[]>)")]
        [TestCase(typeof(NestingClass.NestedClassG<int, float[]>[]), "Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<System.Int32,System.Single[]>[]", TestName = "ToNamespaceQualifiedTypeString(NestingClass.NestedClassG<int, float[]>[])")]
        [TestCase(typeof(NestingGClass<>.NestedClassInG), "Metaplay.Core.Tests.TypeExtensionsTests.NestingGClass<>.NestedClassInG", TestName = "ToNamespaceQualifiedTypeString(NestingClass.NestingGClass<>.NestedClassInG)")]
        [TestCase(typeof(NestingGClass<Exception>.NestedClassInG), "Metaplay.Core.Tests.TypeExtensionsTests.NestingGClass<System.Exception>.NestedClassInG", TestName = "ToNamespaceQualifiedTypeString(NestingGClass<Exception>.NestedClassInG)")]
        [TestCase(typeof(NestingGClass<Exception>.NestedGClassInG<long>), "Metaplay.Core.Tests.TypeExtensionsTests.NestingGClass<System.Exception>.NestedGClassInG<System.Int64>", TestName = "ToNamespaceQualifiedTypeString(NestingGClass<Exception>.NestedGClassInG<long>)")]
        [TestCase(typeof(NestingGClass<>.NestedGClassInG<>), "Metaplay.Core.Tests.TypeExtensionsTests.NestingGClass<>.NestedGClassInG<>", TestName = "ToNamespaceQualifiedTypeString(NestingGClass<>.NestedGClassInG<>)")]
        [TestCase(typeof(NestingG2Class<,>.NestedG2Class<,>), "Metaplay.Core.Tests.TypeExtensionsTests.NestingG2Class<,>.NestedG2Class<,>", TestName = "ToNamespaceQualifiedTypeString(NestingG2Class<,>.NestedG2Class<,>)")]
        [TestCase(typeof(NestingG2Class<int,string>.NestedG2Class<long,float>), "Metaplay.Core.Tests.TypeExtensionsTests.NestingG2Class<System.Int32,System.String>.NestedG2Class<System.Int64,System.Single>", TestName = "ToNamespaceQualifiedTypeString(NestingG2Class<int,string>.NestedG2Class<long,float>)")]
        [TestCase(typeof(NestingG2Class<int,NestingClass.NestedClassG<NestingClass.NestedClass[], NestingGClass<int[]>>>.NestedG2Class<int,float>), "Metaplay.Core.Tests.TypeExtensionsTests.NestingG2Class<System.Int32,Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass[],Metaplay.Core.Tests.TypeExtensionsTests.NestingGClass<System.Int32[]>>>.NestedG2Class<System.Int32,System.Single>", TestName = "ToNamespaceQualifiedTypeString(NestingG2Class<int,NestingClass.NestedClassG<NestingClass.NestedClass[], NestingGClass<int[]>>>.NestedG2Class<int,float>)")]
        [TestCase(typeof(int[]), "System.Int32[]")]
        ...
        [TestCase(false, typeof(int), typeof(float))]
        [TestCase(false, typeof(List<float>), typeof(IDictionary))]
        [TestCase(false, typeof(List<float>), typeof(Dictionary<string, string>))]
        [TestCase(false, typeof(List<float>), typeof(IList<int>))]
        [TestCase(false, typeof(List<float>), typeof(List<int>))]
        [TestCase(false, typeof(ValueTuple<float, int>), typeof(ValueTuple<>), TestName = "IsGenericTypeOf(vtuple´1 with float and int)")] // Nunit test naming gets confused. Tuples get formatted as "ValueTuple`N[...." and as (T1, T2)
        [TestCase(true, typeof(int), typeof(int?))]
        [TestCase(true, typeof(int), typeof(int))]
        [TestCase(true, typeof(List<float>), typeof(List<float>))]
        [TestCase(true, typeof(List<float>), typeof(List<>))]
        [TestCase(true, typeof(List<float>), typeof(IList<>))]
        [TestCase(true, typeof(IList<float>), typeof(IList<>))]
        [TestCase(true, typeof(IList<>), typeof(IList<>))]
        [TestCase(true, typeof(List<float>), typeof(IList))]
        [TestCase(true, typeof(List<List<float>>), typeof(List<>))]
        [TestCase(true, typeof(List<List<float>>), typeof(List<>))]
        [TestCase(true, typeof(List<List<float>>), typeof(IList<>))]
        [TestCase(true, typeof(List<List<float>>), typeof(IList))]
        [TestCase(true, typeof(ValueTuple<float>), typeof(ValueTuple<>))]
        [TestCase(true, typeof(ValueTuple<float>), typeof(ITuple))]
        [TestCase(true, typeof(ValueTuple<float, int>), typeof(ValueTuple<,>), TestName = "IsGenericTypeOf(vtuple´2 with float and int)")]    // see above
        [TestCase(true, typeof(IInterfaceTestClass), typeof(IInterfaceTestClassBase))]
        [TestCase(true, typeof(ClassWithParentWithGenericInterface), typeof(ClassWithGenericInterface))]
        [TestCase(true, typeof(ClassWithParentWithGenericInterface), typeof(IGenericInterface<int>))]
        [TestCase(true, typeof(System.InvalidOperationException), typeof(System.Exception))]
        [TestCase(true, typeof(float[]), typeof(Array))]
        public void Implements(bool expected, Type type, Type typeOf)
        {
            if (expected)
                Assert.IsTrue(TypeExtensions.Implements(type, typeOf));
            else
                Assert.IsFalse(TypeExtensions.Implements(type, typeOf));
        }
        ...
        [TestCase(true, typeof(MetaDictionary<int, string>), typeof(IEnumerable))]
        ...
        [TestCase(typeof(Dictionary<int, string>), typeof(MetaDictionary<,>))]
        [TestCase(typeof(Dictionary<float, double>), typeof(MetaDictionary<,>))]
        [TestCase(typeof(ClassWithParentIntStringDictionary), typeof(MetaDictionary<,>))]
        [TestCase(typeof(ClassWithParentDictionary<int, string>), typeof(MetaDictionary<,>))]
        [TestCase(typeof(ClassWithParentWithParentIntStringDictionary), typeof(MetaDictionary<,>))]
...
#pragma warning disable CS0649, CS0169
        ...
        {
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.Field", typeof(NestingClass).GetField("Field").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.Method", typeof(NestingClass).GetMethod("Method").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.Property", typeof(NestingClass).GetProperty("Property").ToMemberWithNamespaceQualifiedTypeString());

            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass.Field", typeof(NestingClass.NestedClass).GetField("Field").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass.Method", typeof(NestingClass.NestedClass).GetMethod("Method").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass.Property", typeof(NestingClass.NestedClass).GetProperty("Property").ToMemberWithNamespaceQualifiedTypeString());

            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<System.Object,System.Object>.Field",typeof(NestingClass.NestedClassG<object, object>).GetField("Field").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<System.Object,System.Object>.Method", typeof(NestingClass.NestedClassG<object, object>).GetMethod("Method").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<System.Object,System.Object>.Property", typeof(NestingClass.NestedClassG<object, object>).GetProperty("Property").ToMemberWithNamespaceQualifiedTypeString());

            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<,>.Field", typeof(NestingClass.NestedClassG<,>).GetField("Field").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<,>.Method", typeof(NestingClass.NestedClassG<,>).GetMethod("Method").ToMemberWithNamespaceQualifiedTypeString());
            Assert.AreEqual("Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<,>.Property", typeof(NestingClass.NestedClassG<,>).GetProperty("Property").ToMemberWithNamespaceQualifiedTypeString());
        }

        [Test]
        public void ToMemberWithGlobalNamespaceQualifiedTypeString()
        {
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.Field", typeof(NestingClass).GetField("Field").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.Method", typeof(NestingClass).GetMethod("Method").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.Property", typeof(NestingClass).GetProperty("Property").ToMemberWithGlobalNamespaceQualifiedTypeString());

            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass.Field", typeof(NestingClass.NestedClass).GetField("Field").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass.Method", typeof(NestingClass.NestedClass).GetMethod("Method").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClass.Property", typeof(NestingClass.NestedClass).GetProperty("Property").ToMemberWithGlobalNamespaceQualifiedTypeString());

            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<global::System.Object,global::System.Object>.Field",typeof(NestingClass.NestedClassG<object, object>).GetField("Field").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<global::System.Object,global::System.Object>.Method", typeof(NestingClass.NestedClassG<object, object>).GetMethod("Method").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<global::System.Object,global::System.Object>.Property", typeof(NestingClass.NestedClassG<object, object>).GetProperty("Property").ToMemberWithGlobalNamespaceQualifiedTypeString());

            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<,>.Field", typeof(NestingClass.NestedClassG<,>).GetField("Field").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<,>.Method", typeof(NestingClass.NestedClassG<,>).GetMethod("Method").ToMemberWithGlobalNamespaceQualifiedTypeString());
            Assert.AreEqual("global::Metaplay.Core.Tests.TypeExtensionsTests.NestingClass.NestedClassG<,>.Property", typeof(NestingClass.NestedClassG<,>).GetProperty("Property").ToMemberWithGlobalNamespaceQualifiedTypeString());
        }
...
#pragma warning restore CS0649, CS0169
        ...
        public void IsDictionary()
        {
            ...
            Assert.IsTrue(typeof(MetaDictionary<int, string>).IsDictionary());
        ...
        public void GetDictionaryKeyAndValueTypes()
        {
            ...
            Assert.AreEqual((typeof(int), typeof(string)), typeof(MetaDictionary<int, string>).GetDictionaryKeyAndValueTypes());
        }

        enum TestEnumType { Zero=0 }
...
#if !UNITY_EDITOR // C# 10.0 not supported by Unity
...
#pragma warning restore MP_STI_00
        ...
        class TestAttributeInheritedAttribute : Attribute
        {
        }
        class TestAttributeInheritedAttributeSubTypeAttribute : TestAttributeInheritedAttribute
        {
        }

        [AttributeUsage(AttributeTargets.Class, Inherited = false)]
        class TestAttributeNonInheritedAttribute : Attribute
        {
        }
        [AttributeUsage(AttributeTargets.Class)]
        class TestAttributeUnused : Attribute
        {
        }

        [TestAttributeInherited]
        [TestAttributeNonInherited]
        class AttributeTestAttributeOnType { }
        class AttributeTestAttributeOnTypeSubclass : AttributeTestAttributeOnType { }

        [TestAttributeInheritedAttributeSubType]
        class AttributeTestInheritedAttributeOnType { }
        class AttributeTestInheritedAttributeOnTypeSubclass : AttributeTestInheritedAttributeOnType { }

        [Test]
        public void TestHasCustomAttributeForType()
        {
            // On type
            Assert.IsTrue(typeof(AttributeTestAttributeOnType).HasCustomAttribute<TestAttributeInheritedAttribute>());
            Assert.IsTrue(typeof(AttributeTestAttributeOnType).HasCustomAttribute<TestAttributeNonInheritedAttribute>());
            Assert.IsTrue(!typeof(AttributeTestAttributeOnType).HasCustomAttribute<TestAttributeUnused>());

            Assert.IsTrue(typeof(AttributeTestAttributeOnType).HasCustomAttribute(typeof(TestAttributeInheritedAttribute)));
            Assert.IsTrue(typeof(AttributeTestAttributeOnType).HasCustomAttribute(typeof(TestAttributeNonInheritedAttribute)));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnType).HasCustomAttribute(typeof(TestAttributeUnused)));

            // On subtype
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeInheritedAttribute>(inherit: false));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeNonInheritedAttribute>(inherit: false));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeUnused>(inherit: false));

            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeInheritedAttribute), inherit: false));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeNonInheritedAttribute), inherit: false));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeUnused), inherit: false));

            // On subtype with inherit = true
            // Even with inherit = true, the non-inheritable attributes are not visible
            Assert.IsTrue(typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeInheritedAttribute>(inherit: true));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeNonInheritedAttribute>(inherit: true));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeUnused>(inherit: true));

            Assert.IsTrue(typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeInheritedAttribute), inherit: true));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeNonInheritedAttribute), inherit: true));
            Assert.IsTrue(!typeof(AttributeTestAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeUnused), inherit: true));

            // Inherited attributes, directly
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute<TestAttributeInheritedAttributeSubTypeAttribute>());
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute(typeof(TestAttributeInheritedAttributeSubTypeAttribute)));
            // For clarity: `inherit: false` is unrelated to the _attribute_'s inheritance (only the target's inheritance)
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute<TestAttributeInheritedAttributeSubTypeAttribute>(inherit: false));
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute(typeof(TestAttributeInheritedAttributeSubTypeAttribute), inherit: false));

            // Inherited attributes, via base type
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute<TestAttributeInheritedAttribute>());
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute(typeof(TestAttributeInheritedAttribute)));
            // For clarity: `inherit: false` is unrelated to the _attribute_'s inheritance (only the target's inheritance)
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute<TestAttributeInheritedAttribute>(inherit: false));
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnType).HasCustomAttribute(typeof(TestAttributeInheritedAttribute), inherit: false));

            // Inherited attributes, on subtype, directly
            Assert.IsTrue(!typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeInheritedAttributeSubTypeAttribute>(inherit: false));
            Assert.IsTrue(!typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeInheritedAttributeSubTypeAttribute), inherit: false));

            // Inherited attributes, on subtype, via base type
            Assert.IsTrue(!typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeInheritedAttribute>(inherit: false));
            Assert.IsTrue(!typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeInheritedAttribute), inherit: false));

            // Inherited attributes, on subtype, directly, with inherit = true
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeInheritedAttributeSubTypeAttribute>(inherit: true));
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeInheritedAttributeSubTypeAttribute), inherit: true));

            // Inherited attributes, on subtype, via base type, with inherit = true
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute<TestAttributeInheritedAttribute>(inherit: true));
            Assert.IsTrue(typeof(AttributeTestInheritedAttributeOnTypeSubclass).HasCustomAttribute(typeof(TestAttributeInheritedAttribute), inherit: true));
        }

        [AttributeUsage(AttributeTargets.Method)]
        class TestAttributeForMethodAttribute : Attribute
        {
        }
        class TestSubAttributeForMethodAttribute : TestAttributeForMethodAttribute
        {
        }

        [AttributeUsage(AttributeTargets.Method, Inherited = false)]
        class TestAttributeForMethodUnInheritableAttribute : Attribute
        {
        }
        class TestSubAttributeForMethodUnInheritableAttribute : TestAttributeForMethodUnInheritableAttribute
        {
        }

        class HasCustomAttributeForMethodTestTypeBase
        {
            [TestSubAttributeForMethod]
            public virtual void MethodWithAttributeOnBase() { }

            [TestAttributeForMethodUnInheritable]
            public virtual void MethodWithUninheritableAttributeOnBase() { }

            [TestSubAttributeForMethodUnInheritable]
            public virtual void MethodWithUninheritableAttributeSubOnBase() { }
        }
        class HasCustomAttributeForMethodTestType : HasCustomAttributeForMethodTestTypeBase
        {
            [TestAttributeForMethod]
            public static void MethodWithAttribute() { }

            [TestSubAttributeForMethod]
            public static void MethodWithSubAttribute() { }

            public override void MethodWithAttributeOnBase() { }

            [TestAttributeForMethodUnInheritable]
            public static void MethodWithUninheritableAttribute() { }

            [TestSubAttributeForMethodUnInheritable]
            public static void MethodWithUninheritableAttributeSub() { }

            public override void MethodWithUninheritableAttributeOnBase() { }

            public override void MethodWithUninheritableAttributeSubOnBase() { }
        }

        [Test]
        public void TestHasCustomAttributeForMethod()
        {
            MethodInfo method1 = typeof(HasCustomAttributeForMethodTestType).GetMethod("MethodWithAttribute");
            MethodInfo method2 = typeof(HasCustomAttributeForMethodTestType).GetMethod("MethodWithSubAttribute");
            MethodInfo method3 = typeof(HasCustomAttributeForMethodTestType).GetMethod("MethodWithAttributeOnBase");

            // Inherit = true, Inheritable attribute
            Assert.IsTrue(method1.HasCustomAttribute<TestAttributeForMethodAttribute>(inherit: true));
            Assert.IsTrue(method1.HasCustomAttribute(typeof(TestAttributeForMethodAttribute), inherit: true));

            Assert.IsTrue(method2.HasCustomAttribute<TestSubAttributeForMethodAttribute>(inherit: true));
            Assert.IsTrue(method2.HasCustomAttribute(typeof(TestSubAttributeForMethodAttribute), inherit: true));
            Assert.IsTrue(method2.HasCustomAttribute<TestAttributeForMethodAttribute>(inherit: true));
            Assert.IsTrue(method2.HasCustomAttribute(typeof(TestAttributeForMethodAttribute), inherit: true));

            Assert.IsTrue(method3.HasCustomAttribute<TestSubAttributeForMethodAttribute>(inherit: true));
            Assert.IsTrue(method3.HasCustomAttribute(typeof(TestSubAttributeForMethodAttribute), inherit: true));
            Assert.IsTrue(method3.HasCustomAttribute<TestAttributeForMethodAttribute>(inherit: true));
            Assert.IsTrue(method3.HasCustomAttribute(typeof(TestAttributeForMethodAttribute), inherit: true));

            // Inherit = false, Inheritable attribute
            Assert.IsTrue(method1.HasCustomAttribute<TestAttributeForMethodAttribute>(inherit: false));
            Assert.IsTrue(method1.HasCustomAttribute(typeof(TestAttributeForMethodAttribute), inherit: false));

            Assert.IsTrue(!method3.HasCustomAttribute<TestSubAttributeForMethodAttribute>(inherit: false));
            Assert.IsTrue(!method3.HasCustomAttribute(typeof(TestSubAttributeForMethodAttribute), inherit: false));
            Assert.IsTrue(!method3.HasCustomAttribute<TestAttributeForMethodAttribute>(inherit: false));
            Assert.IsTrue(!method3.HasCustomAttribute(typeof(TestAttributeForMethodAttribute), inherit: false));

            MethodInfo method4 = typeof(HasCustomAttributeForMethodTestType).GetMethod("MethodWithUninheritableAttribute");
            MethodInfo method5 = typeof(HasCustomAttributeForMethodTestType).GetMethod("MethodWithUninheritableAttributeSub");
            MethodInfo method6 = typeof(HasCustomAttributeForMethodTestType).GetMethod("MethodWithUninheritableAttributeOnBase");
            MethodInfo method7 = typeof(HasCustomAttributeForMethodTestType).GetMethod("MethodWithUninheritableAttributeSubOnBase");

            // Inherit = true, Un-inheritable attribute
            Assert.IsTrue(method4.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: true)); // method has the attribute
            Assert.IsTrue(method5.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: true)); // method has an attribute that derives the attribute
            Assert.IsTrue(!method6.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: true)); // method base has the attribute, but it's uninheritable

            // Special case, Unity and Dotnet disagree. On debug, we expect consistency check to detect this inconsistent case and throw
            #if DEBUG
            try
            {
                // method base has an attribute that derives the attribute, and the attribute is inheritable (the base attribute is not)
                _ = method7.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: true);
                Assert.Fail("Expected exception");
            }
            catch (InvalidOperationException ex)
            {
                Assert.IsTrue(ex.ToString().Contains("Inherited CustomAttributes on overriden methods", StringComparison.Ordinal));
            }
            #endif

            // Inherit = false, Un-inheritable attribute
            Assert.IsTrue(method4.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: false)); // method has the attribute
            Assert.IsTrue(method5.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: false)); // method has an attribute that derives the attribute
            Assert.IsTrue(!method6.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: false));
            Assert.IsTrue(!method7.HasCustomAttribute<TestAttributeForMethodUnInheritableAttribute>(inherit: false));
        }

        [AttributeUsage(AttributeTargets.Field | AttributeTargets.Property)]
        class TestAttributeForMemberAttribute : Attribute
        {
        }
        class TestSubAttributeForMemberAttribute : TestAttributeForMemberAttribute
        {
        }

        [AttributeUsage(AttributeTargets.Field | AttributeTargets.Property, Inherited = false)]
        class TestNonInheritedAttributeForMemberAttribute : Attribute
        {
        }

        abstract class HasCustomAttributeForMemberTestTypeBase
        {
            [TestSubAttributeForMember]
            [TestNonInheritedAttributeForMember]
            public abstract int PropertyV { get; }
        }
        class HasCustomAttributeForMemberTestType : HasCustomAttributeForMemberTestTypeBase
        {
            #pragma warning disable CS0649 // field is never assigned to
            [TestAttributeForMember]
            public int Field1;
            [TestAttributeForMember]
            ...
            public override int PropertyV => 1;
            #pragma warning restore CS0649
        }

        [Test]
        public void TestHasCustomAttributeForMember()
        {
            FieldInfo field1 = typeof(HasCustomAttributeForMemberTestType).GetField("Field1");
            FieldInfo field2 = typeof(HasCustomAttributeForMemberTestType).GetField("Field2");
            PropertyInfo property1 = typeof(HasCustomAttributeForMemberTestType).GetProperty("Property1");
            PropertyInfo property2 = typeof(HasCustomAttributeForMemberTestType).GetProperty("Property2");
            PropertyInfo propertyV = typeof(HasCustomAttributeForMemberTestType).GetProperty("PropertyV");

            Assert.IsTrue(field1.HasCustomAttribute<TestAttributeForMemberAttribute>());
            Assert.IsTrue(field1.HasCustomAttribute(typeof(TestAttributeForMemberAttribute)));

            Assert.IsTrue(field2.HasCustomAttribute<TestSubAttributeForMemberAttribute>());
            Assert.IsTrue(field2.HasCustomAttribute(typeof(TestSubAttributeForMemberAttribute)));
            Assert.IsTrue(field2.HasCustomAttribute<TestAttributeForMemberAttribute>());
            Assert.IsTrue(field2.HasCustomAttribute(typeof(TestAttributeForMemberAttribute)));

            Assert.IsTrue(property1.HasCustomAttribute<TestAttributeForMemberAttribute>());
            Assert.IsTrue(property1.HasCustomAttribute(typeof(TestAttributeForMemberAttribute)));

            Assert.IsTrue(property2.HasCustomAttribute<TestSubAttributeForMemberAttribute>());
            Assert.IsTrue(property2.HasCustomAttribute(typeof(TestSubAttributeForMemberAttribute)));
            Assert.IsTrue(property2.HasCustomAttribute<TestAttributeForMemberAttribute>());
            Assert.IsTrue(property2.HasCustomAttribute(typeof(TestAttributeForMemberAttribute)));

            Assert.IsTrue(propertyV.HasCustomAttribute<TestSubAttributeForMemberAttribute>());
            Assert.IsTrue(propertyV.HasCustomAttribute(typeof(TestSubAttributeForMemberAttribute)));
            Assert.IsTrue(propertyV.HasCustomAttribute<TestAttributeForMemberAttribute>());
            Assert.IsTrue(propertyV.HasCustomAttribute(typeof(TestAttributeForMemberAttribute)));

            Assert.IsTrue(!propertyV.HasCustomAttribute<TestSubAttributeForMemberAttribute>(inherit: false));
            Assert.IsTrue(!propertyV.HasCustomAttribute(typeof(TestSubAttributeForMemberAttribute), inherit: false));
            Assert.IsTrue(!propertyV.HasCustomAttribute<TestAttributeForMemberAttribute>(inherit: false));
            Assert.IsTrue(!propertyV.HasCustomAttribute(typeof(TestAttributeForMemberAttribute), inherit: false));

            Assert.IsTrue(!propertyV.HasCustomAttribute<TestNonInheritedAttributeForMemberAttribute>());
            Assert.IsTrue(!propertyV.HasCustomAttribute(typeof(TestNonInheritedAttributeForMemberAttribute)));
        }
    }
}
