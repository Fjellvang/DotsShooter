...
namespace Metaplay.Core.Tests
{
    class UtilTests
    {
        ...
        [Test]
        public void TestParseExceptionDetailsFromString()
        {
            // Case: Simple case, where we should see correct behavior
            string testString = "System.InvalidOperationException: Test error\r\n   at Metaplay.Server.AdminApi.Controllers.TestingController.TestError() in TestingController.cs:line 60\r\n   at Foo.Bar.FooBarMethod()";

            Util.ExceptionDetails exceptionDetails = Util.ParseExceptionDetailsFromString(testString);

            Assert.AreEqual("System.InvalidOperationException", exceptionDetails.Type);
            Assert.AreEqual("Test error", exceptionDetails.Message);
            Assert.AreEqual("at Metaplay.Server.AdminApi.Controllers.TestingController.TestError() in TestingController.cs:line 60\r\n   at Foo.Bar.FooBarMethod()", exceptionDetails.StackTrace);

        }

        [Test]
        public void TestParseExceptionDetailsFromStringError()
        {
            // Case: Exception without the word "Exception"
            string testString = "FooError: FooBar\r\n   at Foo.Bar()";

            Util.ExceptionDetails exceptionDetails2 = Util.ParseExceptionDetailsFromString(testString);

            Assert.AreEqual("FooError", exceptionDetails2.Type);
            Assert.AreEqual("FooBar", exceptionDetails2.Message);
            Assert.AreEqual("at Foo.Bar()", exceptionDetails2.StackTrace);
        }

        [Test]
        public void TestParseExceptionDetailsFromStringComplexString()
        {
            // Case: Complex string with exception inside it: unexpected results
            string testString = "Unhandled Exception: System.AggregateException: One or more errors occurred. ---> System.IndexOutOfRangeException: Index was outside the bounds of the array.\r\n    at Example.<Main>b__0()\r\n    at System.Threading.Tasks.Task.Execute()\r\n    --- End of inner exception stack trace ---\r\n    at System.AggregateException.Handle(Func`2 predicate)\r\n    at Example.Main(String[] args)";

            Util.ExceptionDetails exceptionDetailsAggregateException = Util.ParseExceptionDetailsFromString(testString);

            Assert.AreEqual("Unhandled", exceptionDetailsAggregateException.Type);
            Assert.AreEqual("Exception: System.AggregateException: One or more errors occurred. ---> System.IndexOutOfRangeException: Index was outside the bounds of the array.", exceptionDetailsAggregateException.Message);
            Assert.AreEqual("at Example.<Main>b__0()\r\n    at System.Threading.Tasks.Task.Execute()\r\n    --- End of inner exception stack trace ---\r\n    at System.AggregateException.Handle(Func`2 predicate)\r\n    at Example.Main(String[] args)", exceptionDetailsAggregateException.StackTrace);
        }

        [Test]
        public void TestParseExceptionDetailsFromStringNonException()
        {
            // Case: string does not look like an exception, ie. has no stacktrace, therefore util returns null
            string testStringNotAnException = "Error: An error occurred.";

            Util.ExceptionDetails exceptionDetailsNotAnException = Util.ParseExceptionDetailsFromString(testStringNotAnException);

            Assert.IsNull(exceptionDetailsNotAnException);
        }

        [Test]
        public void TestParseExceptionDetailsFromStringAggregateException()
        {
            string testStringAggregateException = "System.AggregateException: One or more errors occurred. ---> System.IndexOutOfRangeException: Index was outside the bounds of the array.\r\n    at Example.<Main>b__0()\r\n    at System.Threading.Tasks.Task.Execute()\r\n    --- End of inner exception stack trace ---\r\n    at System.AggregateException.Handle(Func`2 predicate)\r\n    at Example.Main(String[] args)";

            Util.ExceptionDetails exceptionDetailsAggregateException = Util.ParseExceptionDetailsFromString(testStringAggregateException);

            Assert.AreEqual("System.AggregateException", exceptionDetailsAggregateException.Type);
            Assert.AreEqual("One or more errors occurred. ---> System.IndexOutOfRangeException: Index was outside the bounds of the array.", exceptionDetailsAggregateException.Message);
            Assert.AreEqual("at Example.<Main>b__0()\r\n    at System.Threading.Tasks.Task.Execute()\r\n    --- End of inner exception stack trace ---\r\n    at System.AggregateException.Handle(Func`2 predicate)\r\n    at Example.Main(String[] args)", exceptionDetailsAggregateException.StackTrace);
        }

        [Test]
        public void TestParseExceptionDetailsFromStringInnerException()
        {
            string testStringInnerException = "System.NullReferenceException: Null ref message\r\n---> System.InvalidOperationException: Invalid operation occurred\r\n    at TestError() in TestingController.cs:line 64\r\n--- End of inner exception stack trace ---\r\nat TestError() in TestingController.cs:line 68";
            
            Util.ExceptionDetails exceptionDetailsInnerException = Util.ParseExceptionDetailsFromString(testStringInnerException);

            Assert.AreEqual("System.NullReferenceException", exceptionDetailsInnerException.Type);
            Assert.AreEqual("Null ref message\r\n---> System.InvalidOperationException: Invalid operation occurred", exceptionDetailsInnerException.Message);
            Assert.AreEqual("at TestError() in TestingController.cs:line 64\r\n--- End of inner exception stack trace ---\r\nat TestError() in TestingController.cs:line 68", exceptionDetailsInnerException.StackTrace);
        }

        [Test]
        public void TestParseExceptionDetailsFromStringGenericType()
        {
            string testStringGenericTypeException = "GenericTypeException`1[TypeArgument]: Exception message\r\n   at TestError() in TestingController.cs:line 60\r\n   at Foo.Bar.FooBarMethod()";

            Util.ExceptionDetails exceptionDetails = Util.ParseExceptionDetailsFromString(testStringGenericTypeException);

            Assert.AreEqual("GenericTypeException`1[TypeArgument]", exceptionDetails.Type);
            Assert.AreEqual("Exception message", exceptionDetails.Message);
            Assert.AreEqual("at TestError() in TestingController.cs:line 60\r\n   at Foo.Bar.FooBarMethod()", exceptionDetails.StackTrace);
        }
    }
}
