...
namespace Metaplay.Core.Tests
{
    ...
    public class TaskExtensionsTests
    {
        ...
        class DisposableObject : IDisposable
        {
            ...
            TaskCompletionSource<int> _disposed = new TaskCompletionSource<int>();
...
#pragma warning disable VSTHRD002 // Avoid problematic synchronous waits
        ...
        public void ValueTaskGetCompletedResult()
        {
            ...
            {
                _ = (new ValueTask<int>(Task.FromException<int>(new FooException()))).Result;
            });
            Assert.Throws(typeof(FooException), () =>
            {
                _ = (new ValueTask<int>(Task.FromException<int>((new FooException())))).GetCompletedResult();
            });
            ...
            {
                _ = (new ValueTask<int>(Task.FromCanceled<int>(cts.Token))).Result;
            });
            Assert.Throws(typeof(TaskCanceledException), () =>
            {
                _ = (new ValueTask<int>(Task.FromCanceled<int>(cts.Token))).GetCompletedResult();
            });
