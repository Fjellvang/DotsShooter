...
namespace Metaplay.Core.Tests
{
    ...
    public class ConfigPatchingTests
    {
        ...
        public class TestConfigKeyValue : GameConfigKeyValue<TestConfigKeyValue>
        {
            ...
            [MetaMember(2)] public string StringMember;
            [MetaMember(3)] public int IntMember;

            public TestConfigKeyValue() { }
            public TestConfigKeyValue(string reference, string stringMember = null, int intMember = 0)
            {
                Reference = reference == null ? null : MetaRef<TestConfigInfo>.FromKey(TestConfigId.FromString(reference));
        ...
        #region TestConfigKeyValueWithConstructor

        [MetaSerializable]
        public class TestConfigKeyValueWithConstructor : GameConfigKeyValue<TestConfigKeyValueWithConstructor>
        {
            [MetaMember(1)] public MetaRef<TestConfigInfo> Reference { get; }
            [MetaMember(2)] public string StringMember { get; }
            [MetaMember(3)] public int IntMember { get; }

            public TestConfigKeyValueWithConstructor()
            {
                throw new Exception("not expected to be used, this has MetaDeserializationConstructor");
            }

            [MetaDeserializationConstructor]
            TestConfigKeyValueWithConstructor(MetaRef<TestConfigInfo> reference, string stringMember, int intMember)
            {
                Reference = reference;
                StringMember = stringMember;
                IntMember = intMember;
            ...
            public TestConfigKeyValueWithConstructor(string reference, string stringMember, int intMember)
            {
                Reference = reference == null ? null : MetaRef<TestConfigInfo>.FromKey(TestConfigId.FromString(reference));
                StringMember = stringMember;
                IntMember = intMember;
        ...
        public class TestSharedGameConfig : SharedGameConfigBase
        {
            ...
            [GameConfigEntry("TestKeyValueWithConstructor")]
            public TestConfigKeyValueWithConstructor TestKeyValueWithConstructor { get; set; }
        }
        ...
        // \todo This is missing TestConfigKeyValueWithConstructor as that is only used in some simpler tests at the moment.
        ...
        struct ConfigKeyValueCopy
        {
            ...
            public ConfigKeyValueCopy(TestConfigKeyValue keyValue, IMetaRef metaRef, IGameConfigData referredItem, string stringMember, int intMember)
            {
                KeyValue = keyValue;
                MetaRef = metaRef;
                ReferredItem = referredItem;
        ...
        struct ConfigCopy
        {
            ...
            public static void AssertAreEqual(ConfigCopy configBefore, ConfigCopy configAfter)
            {
                ...
                foreach ((ConfigItemCopy before, ConfigItemCopy after) in configBefore.Items.Zip(configAfter.Items, (before, after) => (before, after)))
                {
...

                {
                    ...
                    Assert.AreSame(before.StringMember,     after.StringMember);
                    Assert.AreEqual(before.IntMember,       after.IntMember);
                }
            }
        }
        ...
        ConfigKeyValueCopy GatherConfigKeyValueCopy(TestSharedGameConfig config)
        {
            ...
            return new ConfigKeyValueCopy(keyValue, keyValue.Reference, keyValue.Reference?.MaybeRef, keyValue.StringMember, keyValue.IntMember);
        }
        ...
        class BaselineSpec
        {
            ...
            public TestConfigKeyValue KeyValue;
            public TestConfigKeyValueWithConstructor KeyValueWithConstructor;

            public BaselineSpec(IEnumerable<IGameConfigData> items, TestConfigKeyValue keyValue = null, TestConfigKeyValueWithConstructor keyValueWithConstructor = null)
            {
                Items = items;
                KeyValue = keyValue ?? new TestConfigKeyValue();
                KeyValueWithConstructor = keyValueWithConstructor ?? new TestConfigKeyValueWithConstructor(reference: default, stringMember: default, intMember: default);
            }
        }
        ...
        class PatchSpec
        {
            ...
            public MetaDictionary<string, object> KeyValueMemberReplacementsByName;
            public MetaDictionary<string, object> KeyValueWithConstructorMemberReplacementsByName;
            ...
            public PatchSpec(
                ...
                MetaDictionary<string, object> keyValueMemberReplacementsByName = null,
                MetaDictionary<string, object> keyValueWithConstructorMemberReplacementsByName = null,
                bool isEnabled = true)
            {
                PatchId = default; // populated later, in ConfigSpec's constructor
                Replacements = replacements;
                Additions = additions ?? Enumerable.Empty<IGameConfigData>();
                KeyValueMemberReplacementsByName = keyValueMemberReplacementsByName ?? new MetaDictionary<string, object>();
                KeyValueWithConstructorMemberReplacementsByName = keyValueWithConstructorMemberReplacementsByName ?? new MetaDictionary<string, object>();
                IsEnabled = isEnabled;
            }
            ...
            public GameConfigStructurePatch<TestConfigKeyValueWithConstructor> CreateKeyValueWithConstructorPatchOrNullIfEmpty()
            {
                if (KeyValueWithConstructorMemberReplacementsByName.Count == 0)
                    return null;

                return new GameConfigStructurePatch<TestConfigKeyValueWithConstructor>(replacedMembersByName: KeyValueWithConstructorMemberReplacementsByName);
            }
        }
        ...
        {
            MetaDictionary<TKey, TKey> aliases = aliasSpecs.OfType<AliasSpec<TKey>>().ToMetaDictionary(spec => spec.Alias, spec => spec.RealKey);
            if (!aliases.Any())
                return null;
        ...
        byte[] ExportBaselineKeyValueWithConstructor(ConfigSpec spec)
        {
            return MetaSerialization.SerializeTagged(spec.Baseline.KeyValueWithConstructor, MetaSerializationFlags.IncludeAll, logicVersion: null);
        }
        ...
        ConfigArchive ExportBaseline(ConfigSpec spec)
        {
            ...
            entries.Add(ConfigArchiveEntry.FromBlob("TestKeyValueWithConstructor.mpc", ExportBaselineKeyValueWithConstructor(spec)));

            return ConfigArchive.CreateFromBuild(createdAt: MetaTime.Epoch, entries);
        }
        ...
        GameConfigPatchEnvelope ExportPatch(PatchSpec patchSpec)
        {
            Dictionary<string, GameConfigEntryPatch> entryPatches = new Dictionary<string, GameConfigEntryPatch>(
                new List<KeyValuePair<string, GameConfigEntryPatch>>
                {
                    ...
                    new("TestKeyValueWithConstructor", patchSpec.CreateKeyValueWithConstructorPatchOrNullIfEmpty()),
                }
        ...
        MetaDictionary<ExperimentVariantPair, GameConfigPatchEnvelope> ExportPatches(ConfigSpec spec)
        {
            return spec.Patches.ToMetaDictionary(
                patch => patch.PatchId,
                ExportPatch);
        }
        ...
        TestSharedGameConfig PatchConfig(ConfigSpec spec)
        {
            ...
            MetaDictionary<ExperimentVariantPair, GameConfigPatchEnvelope> patches = ExportPatches(spec);
            ...
            if (_configRuntimeStorageMode == GameConfigRuntimeStorageMode.Deduplicating)
            {
                ...
                void AssertUnderlyingConfigAreUnchanged()
                {
                    ...
                    foreach ((TestSharedGameConfig config, ConfigCopy originalCopy) in configs.Zip(originalConfigCopies, (config, originalCopy) => (config, originalCopy)))
                    {
            ...
            where TInfo : class, IGameConfigData<TKey>, new()
        {
            ...
            List<((TKey key, TInfo value), (TKey Key, TInfo Value) keyValue, (TKey Key, TInfo Value) keyValue2)> zipped = new List<((TKey key, TInfo value), (TKey Key, TInfo Value) keyValue, (TKey Key, TInfo Value) keyValue2)>();
            for (int ndx = 0; ndx < keys.Count; ++ndx)
                zipped.Add(((keys[ndx], values[ndx]), keyValues[ndx], keyValues2[ndx]));

            foreach (((TKey key, TInfo value), (TKey Key, TInfo Value) keyValue, (TKey Key, TInfo Value) keyValue2) in zipped)
            {
                ...
                patches: new PatchSpec[]
                {
                    new PatchSpec(
                        ...
                        keyValueMemberReplacementsByName:
                            new MetaDictionary<string, object>
                            {
                                {
        ...
        [Test]
        public void TestKeyValueBasic0()
        {
            TestSharedGameConfig config = PatchConfig(new ConfigSpec(
                baseline: new BaselineSpec(
                    items: new TestConfigInfo[] { },
                    keyValue: new TestConfigKeyValue(reference: null, stringMember: "test baseline string", intMember: 100)),
                patches: new PatchSpec[]
                {
                    new PatchSpec(
                        replacements: new TestConfigInfo[]{ },
                        keyValueMemberReplacementsByName:
                            ...
                            {
                                {
                                    nameof(TestConfigKeyValue.StringMember),
                                    "test patched string"
                                },
                            }),
                }));
            ...
            Assert.AreEqual(null, keyValue.Reference);
            Assert.AreEqual("test patched string", keyValue.StringMember);
            Assert.AreEqual(100, keyValue.IntMember);
        }

        [Test]
        public void TestKeyValueBasic1()
        {
            TestSharedGameConfig config = PatchConfig(new ConfigSpec(
                baseline: new BaselineSpec(
                    items: new TestConfigInfo[] { },
                ...
                patches: new PatchSpec[]
                {
                    new PatchSpec(
                        ...
                        keyValueMemberReplacementsByName:
                            ...
                            {
                                {
                                    nameof(TestConfigKeyValue.IntMember),
                                    123
                                },
                            }),
                }));
            ...
            Assert.AreEqual(null, keyValue.Reference);
            Assert.AreEqual("test baseline string", keyValue.StringMember);
            Assert.AreEqual(123, keyValue.IntMember);
        }

        [Test]
        public void TestKeyValueBasic2()
        {
            TestSharedGameConfig config = PatchConfig(new ConfigSpec(
                baseline: new BaselineSpec(
                    items: new TestConfigInfo[] { },
        ...
        [TestCase(Ignore = "Building GameConfig KeyValues is currently not supported")]
        public void TestKeyValueWithConstructorBasic0()
        {
            TestSharedGameConfig config = PatchConfig(new ConfigSpec(
                baseline: new BaselineSpec(
                    items: new TestConfigInfo[] { },
                    keyValueWithConstructor: new TestConfigKeyValueWithConstructor(reference: null, stringMember: "test baseline string", intMember: 100)),
                patches: new PatchSpec[]
                {
                    new PatchSpec(
                        replacements: new TestConfigInfo[]{ },
                        keyValueWithConstructorMemberReplacementsByName:
                            new MetaDictionary<string, object>
                            {
                                {
                                    nameof(TestConfigKeyValueWithConstructor.StringMember),
                                    "test patched string"
                                },
                            }),
                }));

            TestConfigKeyValueWithConstructor keyValueWithConstructor = config.TestKeyValueWithConstructor;

            Assert.AreEqual(null, keyValueWithConstructor.Reference);
            Assert.AreEqual("test patched string", keyValueWithConstructor.StringMember);
            Assert.AreEqual(100, keyValueWithConstructor.IntMember);
        }

        [TestCase(Ignore = "Building GameConfig KeyValues is currently not supported")]
        public void TestKeyValueWithConstructorBasic1()
        {
            TestSharedGameConfig config = PatchConfig(new ConfigSpec(
                baseline: new BaselineSpec(
                    items: new TestConfigInfo[] { },
                ...
                patches: new PatchSpec[]
                {
                    new PatchSpec(
                        ...
                        keyValueWithConstructorMemberReplacementsByName:
                            ...
                            {
                                {
                                    nameof(TestConfigKeyValueWithConstructor.IntMember),
                                    123
                                },
                            }),
                }));
            ...
            Assert.AreEqual(null, keyValueWithConstructor.Reference);
            Assert.AreEqual("test baseline string", keyValueWithConstructor.StringMember);
            Assert.AreEqual(123, keyValueWithConstructor.IntMember);
        }

        [TestCase(Ignore = "Building GameConfig KeyValues is currently not supported")]
        public void TestKeyValueWithConstructorBasic2()
        {
            TestSharedGameConfig config = PatchConfig(new ConfigSpec(
                baseline: new BaselineSpec(
                    items: new TestConfigInfo[] { },
        ...
        void RandomTestCaseImpl(ulong randomSeed, int maxNumItems, int maxNumPatches, int maxNumAppendedItems, bool allowDisabledPatches)
        {
            ...
            for (int patchNdx = 0; patchNdx < numPatches; patchNdx++)
            {
                ...
                MetaDictionary<string, object> keyValueMemberReplacements = new MetaDictionary<string, object>();
                if (rnd.NextBool())
                {
            ...
            foreach ((TestConfigInfo expected, TestConfigInfo item) in expectedConfig.TestItems.Values.Zip(resultConfig.TestItems.Values, (expected, result) => (expected, result)))
            {
            ...
            foreach ((TestXConfigInfo expected, TestXConfigInfo item) in expectedConfig.TestXItems.Values.Zip(resultConfig.TestXItems.Values, (expected, result) => (expected, result)))
            {
                Assert.AreEqual(expected.Id, item.Id);
                Assert.AreEqual(expected.Value, item.Value);
            ...
            foreach ((TestYConfigInfo expected, TestYConfigInfo item) in expectedConfig.TestYItems.Values.Zip(resultConfig.TestYItems.Values, (expected, result) => (expected, result)))
            {
                Assert.AreEqual(expected.Id, item.Id);
                Assert.AreEqual(expected.Value, item.Value);
            ...
            foreach ((TestZConfigInfo expected, TestZConfigInfo item) in expectedConfig.TestZItems.Values.Zip(resultConfig.TestZItems.Values, (expected, result) => (expected, result)))
            {
                Assert.AreEqual(expected.Id, item.Id);
                Assert.AreEqual(expected.Value, item.Value);
            }
            ...
            foreach ((TestDerivedConfigInfo expected, TestDerivedConfigInfo item) in expectedConfig.TestDerivedItems.Values.Zip(resultConfig.TestDerivedItems.Values, (expected, result) => (expected, result)))
            {
                Assert.AreEqual(expected.Id, item.Id);
                Assert.AreEqual(expected.Value, item.Value);
        ...
        {
            public MetaDictionary<TestConfigId, TestConfigInfo> TestItems { get; set; } = new MetaDictionary<TestConfigId, TestConfigInfo>();
            public MetaDictionary<TestXConfigId, TestXConfigInfo> TestXItems { get; set; } = new MetaDictionary<TestXConfigId, TestXConfigInfo>();
            public MetaDictionary<TestYConfigId, TestYConfigInfo> TestYItems { get; set; } = new MetaDictionary<TestYConfigId, TestYConfigInfo>();
            public MetaDictionary<TestZConfigId, TestZConfigInfo> TestZItems { get; set; } = new MetaDictionary<TestZConfigId, TestZConfigInfo>();
            public MetaDictionary<TestConfigId, TestDerivedConfigInfo> TestDerivedItems { get; set; } = new MetaDictionary<TestConfigId, TestDerivedConfigInfo>();
        ...
        static void PutItemClones<TKey, TInfo>(MetaDictionary<TKey, TInfo> dst, IEnumerable<IGameConfigData> allItems)
            where TInfo : class, IGameConfigData<TKey>, new()
        {
