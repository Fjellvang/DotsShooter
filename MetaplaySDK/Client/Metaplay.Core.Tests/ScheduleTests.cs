        ...
        public static void RandomTest()
        {
            ...
            for (int testNdx = 0; testNdx < 200; testNdx++)
            {
                ...
                switch (rnd.NextInt(5))
                {
                    ...
                    case 1:     numRepeats = rnd.NextInt((int)System.Math.Min(maxRepeats+1, 2));   break;
                    default:    numRepeats = rnd.NextInt((int)System.Math.Min(maxRepeats+1, 20)); break;
                }
                ...
                int numReferences = numRepeats ?? (int)System.Math.Min(maxRepeats, 20);
